<?php
/**
 * File: show_productedit_img.php
 * Description: عرض صور المنتج للتعديل مع إمكانية الحذف
...
// جلب صور المنتج
$sql = "SELECT pd_image FROM products WHERE pd_id = ? LIMIT 1";
...
<head>
    ...
    function delproimg(imgname, id, cnt) {
        if (confirm("هل أنت متأكد من حذف هذه الصورة؟")) {
            $.post("ajax-file/updateproductimg.php", {
                id: id,
                imgname: imgname
            }, function(data) {
                $("#imgrow" + cnt).remove();
            ...
            <div style="height:450px;">
                <form style="margin:0px;" name="test" action="" onsubmit="return false">
                    <div>
                                                            ...
                                                            <span id="grp1" style="text-align:center; position:static;">
                                                                <div id="textboxa">
                                                                    <?php if ($image_count > 0 && !empty($images[0])): ?>
                                                                        ...
                                                                        ?>
                                                                        <div style="float:left; height:100px; width:107px; padding:1px; position:relative;" id="imgrow<?php echo $counter; ?>">
                                                                            <span>
                                                                            ...
                                                                            <a style="cursor:pointer;">
                                                                                <img src="<?php echo $image_path; ?>" height="100" width="105px;" class="product-image" alt="Product Image">
                                                                            </a>
                                                                        </div>
                                                                        <?php 
                                                                        $counter++;
                        ...
                        <a class="ajax" href="popup-imagegallery_edit.php" style="text-decoration:none;">
