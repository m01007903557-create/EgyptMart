...
<!-- ========================================================== -->
<!-- ✅ Popup مبسط لعروض البيع -->
<!-- ========================================================== -->
<script>
// ============================================================
// ✅ الدالة الرئيسية - تفتح Popup طلب سعر واتساب
// ============================================================
...
// ============================================================
// ✅ النافذة 1: هل تريد الحصول على أفضل سعر؟
// ============================================================
function showStep1() {
    var modalHTML = `
    <div id="waModalStep" style="position:fixed;z-index:99999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.6);direction:rtl;font-family:Tahoma,Arial,sans-serif;display:flex;align-items:center;justify-content:center;">
        <div style="background:#fff;width:90%;max-width:400px;padding:35px;border-radius:15px;box-shadow:0 10px 40px rgba(0,0,0,0.3);text-align:center;position:relative;">
            ...
            <!-- ✅ السؤال -->
            <h3 style="margin:0 0 10px;color:#075e54;font-size:20px;line-height:1.5;">
                🤔 هل تريد الحصول على أفضل سعر لهذا العرض؟
            </h3>
            
            <p style="color:#666;font-size:14px;margin-bottom:25px;">
                العرض: <strong style="color:#25D366;">${currentOfferTitle}</strong>
            </p>
            
            <!-- ✅ الأزرار -->
            <div style="display:flex;gap:12px;justify-content:center;">
                <button onclick="step1Answer(true)" 
                        style="flex:1;background:#25D366;color:#fff;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.3s;">
                    ✅ نعم
                </button>
                <button onclick="step1Answer(false)" 
                        style="flex:1;background:#e0e0e0;color:#333;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.3s;">
                    ❌ لا
                </button>
            </div>
...
// ============================================================
// ✅ النافذة 2: هل تريد محادثة المورد؟
// ============================================================
function showStep2() {
    var modalHTML = `
    <div id="waModalStep" style="position:fixed;z-index:99999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.6);direction:rtl;font-family:Tahoma,Arial,sans-serif;display:flex;align-items:center;justify-content:center;">
        <div style="background:#fff;width:90%;max-width:400px;padding:35px;border-radius:15px;box-shadow:0 10px 40px rgba(0,0,0,0.3);text-align:center;position:relative;">
            ...
            <!-- ✅ السؤال -->
            <h3 style="margin:0 0 10px;color:#075e54;font-size:20px;line-height:1.5;">
                💬 هل تريد محادثة المورد؟
            </h3>
            
            <p style="color:#666;font-size:14px;margin-bottom:25px;">
                سيتم التواصل معك عبر واتساب ولوحة التحكم
            </p>
            
            <!-- ✅ الأزرار -->
            <div style="display:flex;gap:12px;justify-content:center;">
                <button onclick="step2Answer(true)" 
                        style="flex:1;background:#075e54;color:#fff;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.3s;">
                    ✅ نعم
                </button>
                <button onclick="step2Answer(false)" 
                        style="flex:1;background:#e0e0e0;color:#333;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.3s;">
                    ❌ لا
                </button>
            </div>
...
function showStep3() {
    ...
    <div id="waModalStep" style="position:fixed;z-index:99999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.6);direction:rtl;font-family:Tahoma,Arial,sans-serif;display:flex;align-items:center;justify-content:center;">
        <div style="background:#fff;width:90%;max-width:400px;padding:35px;border-radius:15px;box-shadow:0 10px 40px rgba(0,0,0,0.3);text-align:center;position:relative;">
            ...
            <p style="color:#666;font-size:14px;margin-bottom:25px;line-height:1.8;">
                📱 سيتواصل معك المورد عبر <strong>واتساب</strong> وفي <strong>لوحة التحكم</strong> خلال فترة قصيرة
            </p>
            
            <!-- ✅ زر الإرسال -->
            <button onclick="submitOfferRequest()" 
                    style="width:100%;background:#25D366;color:#fff;border:none;padding:14px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.3s;">
                📤 إرسال الطلب
            </button>
...
console.log('✅ WhatsApp RFQ - Sale Offer (نوافذ متتالية) جاهز');
</script>
...
function showStep1() {
    ...
    <div id="waModalStep" style="position:fixed;z-index:999999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.7);direction:rtl;font-family:Tahoma,Arial,sans-serif;display:flex;align-items:center;justify-content:center;">
        <div style="background:#fff;width:90%;max-width:400px;padding:35px;border-radius:15px;box-shadow:0 10px 40px rgba(0,0,0,0.3);text-align:center;position:relative;">
            ...
            <div style="display:flex;gap:12px;justify-content:center;">
                <button onclick="step1Answer(true)" 
                        style="flex:1;background:#25D366;color:#fff;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;">
                    ✅ نعم
                </button>
                <button onclick="step1Answer(false)" 
                        style="flex:1;background:#e0e0e0;color:#333;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;">
                    ❌ لا
                </button>
            </div>
...
function showStep2() {
    ...
    <div id="waModalStep" style="position:fixed;z-index:999999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.7);direction:rtl;font-family:Tahoma,Arial,sans-serif;display:flex;align-items:center;justify-content:center;">
        <div style="background:#fff;width:90%;max-width:400px;padding:35px;border-radius:15px;box-shadow:0 10px 40px rgba(0,0,0,0.3);text-align:center;position:relative;">
            ...
            <div style="display:flex;gap:12px;justify-content:center;">
                <button onclick="step2Answer(true)" 
                        style="flex:1;background:#075e54;color:#fff;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;">
                    ✅ نعم
                </button>
                <button onclick="step2Answer(false)" 
                        style="flex:1;background:#e0e0e0;color:#333;border:none;padding:12px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;">
...
function showStep3() {
    ...
    <div id="waModalStep" style="position:fixed;z-index:999999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.7);direction:rtl;font-family:Tahoma,Arial,sans-serif;display:flex;align-items:center;justify-content:center;">
        <div style="background:#fff;width:90%;max-width:400px;padding:35px;border-radius:15px;box-shadow:0 10px 40px rgba(0,0,0,0.3);text-align:center;position:relative;">
            ...
            <!-- ✅ زر الإرسال -->
            <button onclick="submitOfferRequest()" 
                    style="width:100%;background:#25D366;color:#fff;border:none;padding:14px 25px;border-radius:8px;cursor:pointer;font-size:16px;font-weight:bold;">
                📤 إرسال الطلب
            </button>
