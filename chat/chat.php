<?php
/**
 * chat/chat.php - صفحة محادثة (مع التصحيح الأساسي فقط)
 */
...
// ============================================================
// جلب الرسائل - ✅ التصحيح هنا: نأخذ sender_id و sender_type
// ============================================================
$messages = [];
$msg_sql = "SELECT sender_id, sender_type, message, 
    ...
    <div class="chat-messages" id="messages">
        ...
        <?php else: ?>
            <?php foreach ($messages as $msg): 
                // ✅ المفتاح: استخدم sender_id وليس sender_type
...
// ============================================================
// عرض الرسائل - ✅ التصحيح هنا: استخدم sender_id فقط
// ============================================================
function displayMessages(messages) {
    ...
    for (var i = 0; i < messages.length; i++) {
        ...
        // ✅ المفتاح: استخدم sender_id فقط، وليس sender_type
...
function sendMessage() {
    ...
    .then(function(data) {
        if (data.success) {
            ...
            addNewMessage(msg, currentUserId, 'buyer', time);
