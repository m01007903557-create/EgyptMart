<?php
/**
 * chat/chat.php - صفحة محادثة (النسخة النهائية - بدون واتساب)
 */
...
// ============================================================
// جلب الرسائل - ✅ التصحيح: استخدم sender_id
// ============================================================
$messages = [];
...
<div class="container">
    ...
    <!-- ============================================ -->
    <!-- نافذة المحادثة - ✅ استخدم sender_id فقط -->
    <!-- ============================================ -->
...
// ============================================================
// عرض الرسائل - ✅ استخدم sender_id فقط
// ============================================================
