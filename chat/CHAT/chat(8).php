...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .offer-ticket .details .label { color: #777; font-weight: 400; }
        .offer-ticket .details .value { font-weight: 600; color: #333; }
        .offer-ticket .price-value { color: #28a745; font-size: 15px; font-weight: 700; }
       ...
       /* ============================================ */
/* نافذة المحادثة - تنسيق ثنائي الجوانب محسّن */
/* ============================================ */
.chat-box {
    height: 420px;
    overflow-y: auto;
...
.supplier .time { color: #777; }
        ...
        @media (max-width: 700px) {
            body { padding: 10px; }
            .rfq-ticket { font-size: 12px; padding: 10px 14px; gap: 3px 10px; }
            .chat-box { height: 350px; padding: 10px 12px; }
            .message { max-width: 85%; padding: 8px 14px; font-size: 14px; }
            .offer-ticket { padding: 8px 12px; margin: 4px 10px; flex-direction: column; align-items: stretch; gap: 4px; }
            .offer-ticket .details { gap: 4px 12px; font-size: 12px; }
            .input-area { padding: 10px 12px; }
            .input-area input { min-width: 80px; padding: 8px 14px; font-size: 13px; }
            .input-area button { padding: 8px 16px; font-size: 13px; }
            .emoji-popup { width: 240px; }
            .emoji-popup span { font-size: 26px; }
        }
        
        @media (max-width: 420px) {
            .rfq-ticket { font-size: 11px; padding: 8px 10px; gap: 2px 6px; }
            .chat-box { height: 280px; padding: 8px; }
            .message { max-width: 90%; padding: 6px 12px; font-size: 13px; }
            .offer-ticket { font-size: 12px; padding: 6px 10px; }
