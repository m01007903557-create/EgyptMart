...
// تم تعديله ليعمل مثل chat-wrapper.php
// ============================================================
...
// ============================================================
// الحصول على كود الشات من الرابط (نفس الطريقة القديمة)
// ============================================================
$chat_code = isset($_GET['chat_code']) ? mysqli_real_escape_string($con, trim($_GET['chat_code'])) : '';
