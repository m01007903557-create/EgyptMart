<?php
/**
 * chat/chat.php - صفحة محادثة بنظام WhatsApp UI
 */
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ============================================ */
        /* تذكرة عرض السعر (WhatsApp Style) */
        /* ============================================ */
        .offer-ticket {
            background: #dcf8c6;
            border-radius: 12px;
        ...
        .offer-ticket .price-value { color: #075e54; font-size: 14px; font-weight: 700; }
        ...
        /* ============================================ */
        /* رسالة المورد (تظهر على اليسار - مثل WhatsApp) */
        /* ============================================ */
        .message.supplier {
        ...
        /* ============================================ */
        /* رسالة المشتري (تظهر على اليمين - مثل WhatsApp) */
        /* ============================================ */
        .message.buyer {
            align-self: flex-end;
            max-width: 80%;
        ...
        .buyer .sender-name { color: #075e54; }
        .supplier .sender-name { color: #555; }
        ...
        @media (max-width: 600px) {
            .chat-header { font-size: 11px; padding: 8px 12px; gap: 3px 8px; }
        ...
        @media (max-width: 400px) {
            .chat-header { font-size: 10px; padding: 6px 8px; gap: 2px 6px; }
            .chat-messages { padding: 6px; }
            .message { max-width: 90%; padding: 5px 10px; font-size: 12px; }
            .offer-ticket { font-size: 11px; padding: 4px 8px; }
