...
// ============================================================
// تحميل الرسائل - Two-Sided Chat
// كل رسالة يتم تحديد اتجاهها بناءً على sender_id
// ============================================================
// ============================================================
...
function appendMessages(messages, box) {
    ...
    for (var i = 0; i < messages.length; i++) {
        ...
        var senderName = isOutgoing ? 'أنت' : (msg.sender_type === 'supplier' ? supplierName : buyerName);
        var time = msg.time || '';
