...
$_SESSION['last_page']="manage-buy-requirement.php";
...
$(document).ready(function(){
	$('body').on('click', '.ajax', function() {
	  $.colorbox({href:$(this).attr('href'),width:"72%"});
	  return false;
	});	
});
</script>
...
{
	$.post("ajax-file/openRequirement.php",{page:page},    function(data){ $('#res').html(data); });
}
function closedRequirement(page)
{
	$.post("ajax-file/closedRequirement.php",{page:page},    function(data){ $('#res').html(data); });
}
function detailRequirement(id)
{
	$.post("ajax-file/detailRequirement.php",{id:id},    function(data){ 
...
{
	$.post("ajax-file/editRequirement.php",{id:id},    function(data){ 
		$('#detail_req').html(data);
		/*$('#req_listing').css("display","none");
		$('#detail_req').css("display","block");*/
	});
...
<div class="inner_wrap">
		...
		<li><h3 style="font-size: 16px;font-weight: bold; text-align:center; color:#000; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;"title=" Buyer Tools "> أدوات المشترى  </h3></li>

		<li class="np npnew"><a href="post-buy-req.php"title="Post a Buy Requirement ">»&nbsp; أنشر طلب شراء  </a></li>
		<li class="np npnew"><a class="leftindi txtcol" href="manage-buy-requirement.php"title=" Manage Buy Requirements ">»&nbsp; إدارة طلبات الشراء </a></li>
		<li class="np npnew"><a href="manage-selloffer-alert.php"title="Manage Sell Offer Alerts ">»&nbsp; إدارة عروض البيع </a></li>
			<li style="border-bottom: medium none; text-align:center; margin-top: 40px;"title=" You may also like to "><h2> روابط هامة لأعمالك </h2></li>
			<li class="np npnew"><a href="buyleads.php"title=" View Latest Buy Leads ">شاهد أحدث طلبات الشراء </a></li>
			<li class="np npnew"><a href="manage-purchased-buyleads.php"title=" View Purchased Buy Leads">طلبات الشراء المشتراه  </a></li>
			<li class="np npnew"><a href="manage-buylead-alert.php"title=" Manage Buy Lead Alerts ">إدارة طلبات شراء مشتراه</a></li>
		</ul>
		</div>
...
.tabTextColor{color:#fff;}
	...
	<form style="margin:0px;" action="" name="form1">
        ...
        <table align="CENTER" border="0" cellpadding="0" cellspacing="0">
          <tbody><tr>
            <td valign="TOP" width="100%">
		<div class="wd1 mf18 mc5 mta2 mpb10"><div class="mf11 bc mbl mbn"></div> إدارة طلبات الشراء </div>
		...
		?>
        	<a class="f1 ap2 tabTextColor" onclick="showOpenReq(1);" style="cursor:pointer;" id="opnReq_tab"title=" Open Requirements ">طلبات شراء منشورة   (<?php echo $row_opn->cnt; ?>)</a>
            <a class="f1 npo m5" onclick="showClosedReq(1);" style="cursor:pointer;" id="clsReq_tab"title=" Closed Requirements "> طلبات شراء منتهية  (<?php echo $row_cls->cnt; ?>)</a>
			<div id="post-new" style="float: right;margin:5px 0" class="postNewReq"><a href="post-buy-req.php" class="bo_m2 active" title=" Post a New Buy Requirement "> إنشر طلب شاء جديدة  </a></div>
			<div class="c3"></div>
		</div>
