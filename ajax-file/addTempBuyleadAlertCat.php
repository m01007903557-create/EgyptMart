<?php
/**
 * File: ajax/addTempBuyleadAlertCat.php

 * Description: إضافة تصنيف مؤقت لتنبيهات الشراء
...
try {
    ...
    $check_sql = "SELECT tbac_id FROM temp_buylead_alert_cat 
    ...
    // إدراج التصنيف
    $insert_sql = "INSERT INTO temp_buylead_alert_cat (tbac_usr_id, tbac_pc_id, tbac_updated_date) 
                   VALUES (?, ?, NOW())";
    ...
    mysqli_rollback($con);
    error_log("Add Temp Buy Alert Error: " . $e->getMessage() . " | User: $user_id, Cat: $category_id");
