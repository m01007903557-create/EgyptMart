<?php
/**
 * File: ajax/sendenquiry-form.php

 * Description: عرض نموذج إرسال الاستفسار لشركة معينة
...
$subject_default = "الإستفسار عن : " . trim(($row_own->name_prefix ?? '') . ' ' . ($row_own->fname ?? '') . ' ' . ($row_own->lname ?? ''));
...
function sendEnquiry() {
    ...
    if(msg_message.value == '' || msg_message.value == null) {
        alert("رجاء وصف إحتياجاتك");
        msg_message.focus();
        valid = false;
    } else if(msg_message.value.length < 50) {
        alert("! من فضلك إوصف متطلباتك بما لايقل عن 50 حرف");
        msg_message.focus();
        valid = false;
    }
...
<div class="ov-base">
    ...
    <form name="dataform" class="mp0-nw" method="post">
        ...
        <fieldset style="height: 125px; border: 1px solid rgb(134, 182, 217); margin-top: 2px; width:178px;">
            <legend style="font-size: 13px;color:#017BBC; text-align: center;"><strong>إوصف طلباتك</strong></legend>
            <div class="f1-nw" style="color:#055985;">
                <ul>
                    <li class="li-1">متطلبات المنتج</li>
                    <li class="li-1">مواصفات المنتج</li>
                    <li class="li-1">أقل كمية</li>
                    <li class="li-1">شروط ومكان التسليم الخ</li>
                </ul>
            </div>
        </fieldset>
        ...
        <div style="padding:5px; float:right">
            ...
            اريد أن يتم إرسال موردين مماثلين الى بريدى عند عدم رد هذا المورد على رسالتى&nbsp;
        </div>
        ...
        <div id="nu_frm">
            <div class="nef4-nw" align="center">
                ...
                <div id="err_result" style="display:none; padding-left:5px; color:#F00; padding-top:16px;" class="g9 bo off">
                    ... حدث خطأ فى الإرسال رجاء محاولة الإرسال مرة أخرى
                </div>
            </div>
        </div>
    </form>
