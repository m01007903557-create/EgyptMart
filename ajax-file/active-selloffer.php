<?php
/**
 * File: ajax/active-selloffer.php

 * Description: تحميل وعرض عروض البيع النشطة (غير المنتهية) مع التصفح (Pagination)
...
// استعلام جلب عروض البيع النشطة
$sql_active = "SELECT so_id, so_service, so_description, so_pic, so_updated_date 
               FROM sale_offer 
               WHERE so_usr_id = ? 
                                            ...
                                            <span class="pagenavigation">
                                                <div class="f1_m2 rf_m2 p9_m2">
                                                    ...
                                                    if ($first_btn && $cur_page > 1) {
                                                        echo '<a href="javascript:showActive(\'1\')"><img id="firstmail" src="images/firsten.gif"></a>';
                                                    } elseif ($first_btn) {
                                                    ...
                                                    if ($previous_btn && $cur_page > 1) {
                                                        $pre = $cur_page - 1;
                                                        echo '<a href="javascript:showActive(\'' . $pre . '\')"><img id="prevmail" src="images/prven.gif"></a>';
                                                    } elseif ($previous_btn) {
                                                    ...
                                                    if ($next_btn && $cur_page < $no_of_paginations) {
                                                        $nex = $cur_page + 1;
                                                        echo '<a href="javascript:showActive(\'' . $nex . '\')"><img id="nextmail" src="images/nxten.gif"></a>';
                                                    } elseif ($next_btn) {
                                                    ...
                                                    if ($last_btn && $cur_page < $no_of_paginations) {
                                                        echo '<a href="javascript:showActive(\'' . $no_of_paginations . '\')"><img id="lastmail" src="images/lastenv.gif"></a>';
                                                    } elseif ($last_btn) {
