...
$sql="insert into purchased_tender
	set
		ptnd_usr_id='".$usr_id."',
		ptnd_tnd_id='".$tnd_id."',
		ptnd_purchase_date=now()";
...
<tbody><tr>
  ...
  <b>'.getWebSiteName().' Customer Support Team</b>
	    ...
	    $subj="Tender Purchase Notification";
	    $headers  = "MIME-Version: 1.0\n";
		$headers .= "Content-type: text/html; charset=iso-8859-1\n";
	 	$headers .= "From: ".$from_name." <".$from_mail.">";	
		mail($to,$subj,$comment,$headers);*/
		include '../email/tender_notification.php';
		$from_mail=get_adminemail();
	    $to=stripslashes($row_usr->email);  
		$from_name = get_page_settings(4);
	    $subj="Tender Purchase Notification";
