                    ...
                    <?php if (mysqli_num_rows($result_prd) > 0): ?>
                        ...
                        <li class="als-item">
                            ...
                            <div class="btns-group">
                                <p class="oval-btn whatsapp-btn">
                                <img src="images/mobile.png" style="width: 18px;height: 18px;margin-right: 5px;">
                                <?php if (!empty($_SESSION['uid_indm'])): 
                                    $pid = isset($product_id) ? $product_id : (isset($row['pd_id']) ? $row['pd_id'] : 0);
                                    $pname = isset($product_name) ? $product_name : (isset($row['pd_title']) ? $row['pd_title'] : 'Product');
                                ?>
                                <a href="javascript:void(0)" onclick="openWaRfq(<?php echo $pid; ?>, '<?php echo addslashes($pname); ?>')" style="color:#25D366; text-decoration:none; font-weight:bold;">
                                    طلب سعر واتساب
                                </a>
                                <?php else: ?>
