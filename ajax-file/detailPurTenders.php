...
<br><br>
<a class="ajax" rel="nofollow" href="sendTenderEnquiry-form.php?id=<?php echo rand(1000,9999).md5($row->tnd_usr_id); ?>"style="font-weight:bold; font-color:red;">إرسل إستفسارك </a>
</div>
