<?php
/**
 * File: ajax/displaySelectedSellCategories.php
 * Description: عرض التصنيفات المحددة لتنبيهات البيع
...
$sql = "SELECT pc.pc_id, pc.pc_name 
        FROM temp_selloffer_alert_cat tsac
        INNER JOIN product_category pc ON tsac.tsac_pc_id = pc.pc_id
        WHERE tsac.tsac_usr_id = ?
        AND pc.pc_status = 1
