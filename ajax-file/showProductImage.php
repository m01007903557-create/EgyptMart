<?php
/**
 * File: ajax/showProductImage.php
 * Description: جلب الصورة الرئيسية للمنتج
...
$sqlImg = "SELECT pd_image FROM products WHERE pd_id = ? LIMIT 1";
...
if ($rowImg && !empty($rowImg->pd_image)) {
    // تقسيم الصور وفصلها
    $images = explode(',', $rowImg->pd_image);
