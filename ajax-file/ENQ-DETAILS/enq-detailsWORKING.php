    ...
    <div class="offers-section">
        ...
        ?>
            <div class="offer-card">
                ...
                <button class="btn btn-success accept-offer" data-offer-id="<?php echo $offer['id']; ?>" data-rfq-id="<?php echo $rfq_id; ?>">
                    قبول العرض
                </button>
                <button class="btn btn-danger reject-offer" data-offer-id="<?php echo $offer['id']; ?>" data-rfq-id="<?php echo $rfq_id; ?>">
                    رفض العرض
                </button>
            </div>
        <?php endwhile; ?>
