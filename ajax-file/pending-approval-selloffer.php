<?php
/**
 * File: ajax/pending-approval-selloffer.php

 * Description: تحميل وعرض عروض البيع المعلقة (في انتظار الموافقة) مع التصفح (Pagination)
...
// استعلام جلب عروض البيع المعلقة
$sql_pending = "SELECT so_id, so_service, so_description, so_pic, so_updated_date 
                FROM sale_offer 
                WHERE so_usr_id = ? 
...
$stmt = mysqli_prepare($con, $sql_pending);
                                            ...
                                            <span class="pagenavigation">
                                                <div class="f1_m2 rf_m2 p9_m2">
                                                    ...
                                                    if ($first_btn && $cur_page > 1) {
                                                        echo '<a href="javascript:showPending(\'1\')"><img id="firstmail" src="images/firsten.gif"></a>';
                                                    } elseif ($first_btn) {
                                                    ...
                                                    if ($previous_btn && $cur_page > 1) {
                                                        $pre = $cur_page - 1;
                                                        echo '<a href="javascript:showPending(\'' . $pre . '\')"><img id="prevmail" src="images/prven.gif"></a>';
                                                    } elseif ($previous_btn) {
                                                    ...
                                                    if ($next_btn && $cur_page < $no_of_paginations) {
                                                        $nex = $cur_page + 1;
                                                        echo '<a href="javascript:showPending(\'' . $nex . '\')"><img id="nextmail" src="images/nxten.gif"></a>';
                                                    } elseif ($next_btn) {
                                                    ...
                                                    if ($last_btn && $cur_page < $no_of_paginations) {
                                                        echo '<a href="javascript:showPending(\'' . $no_of_paginations . '\')"><img id="lastmail" src="images/lastenv.gif"></a>';
                                                    } elseif ($last_btn) {
                        ...
                        <div style="border:1px solid #D5E4E9; width:100px; line-height:100px; margin:10px auto;">
                            <?php if (!empty($so_pic)): ?>
                                ...
                                <img src="<?php echo $image_path; ?>" 
                                     ...
                                     border="0" height="auto" hspace="0" vspace="0" width="100"
