<?php
/**
 * File: ajax/delTempSellofferAlertCat.php

 * Description: حذف تصنيف مؤقت من تنبيهات البيع
...
$sql = "DELETE FROM temp_selloffer_alert_cat 
...
if (mysqli_stmt_execute($stmt)) {
    ...
    error_log("Remove Temp Sell Alert Error: " . mysqli_error($con) . " | User: $user_id, Cat: $category_id");
