<?php
/**
 * File: ajax/editProdlogo.php

 * Description: تحديث صورة شعار المنتج مع إنشاء صورة مصغرة وحذف الصورة القديمة
...
try {
    ...
    $sql_pd = "SELECT pd_imagelogo FROM products WHERE pd_id = ? LIMIT 1";
    ...
    echo "1|Logo image updated successfully";

} catch (RuntimeException $e) {
    error_log("Edit Product Logo Error: " . $e->getMessage() . " | Product ID: $pd_id");
    http_response_code(400);
    echo "0|" . $e->getMessage();
} catch (Exception $e) {
    error_log("Unexpected Edit Product Logo Error: " . $e->getMessage() . " | Product ID: $pd_id");
