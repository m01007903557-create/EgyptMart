...
if (!isset($_POST['search_product_cat'])) {
    ...
    $searchedproducts = $_SESSION['searchedproducts'] ?? array();
...
<head>
    ...
    $.get("ajax-file/showTempProductLogo.php", {usr: usr}, function(data) {
        $("#imglogo_disp").html('<img src="' + data + '" style="width:43px;height:46px;"/>');
    });
}
    ...
    .product-price-row .price-heading {
        grid-column: 1 / -1;
        margin: 0;
    }
    .product-price-row .price-field,
    .product-price-row .price-currency {
        box-sizing: border-box;
    ...
    .product-price-row .price-field span {
        flex: 0 0 auto;
        white-space: nowrap;
    }
    .product-price-row input,
    .product-price-row select {
        box-sizing: border-box;
        flex: 1 1 auto;
        min-width: 0;
        width: 100% !important;
                ...
                <div class="apfc" id="bafrm" style="border: 1px solid #ffffff;">
                    ...
                    <div class="pia f1">
                       ...
                       <div>
                        ...
                        <div class="add_color_page">
                            ...
                            <!-- ✅ زر اختيار صورة المنتج من الجاليري -->
                         <a class="ajax add_color_page_a" href="popup-imagegallery.php" style="text-decoration:none; font-size: 12px;" title="Add Image From The Site Gallery">📷 اختيار صورة <br>  من المعرض</a>
                        ...
                        <div class="add_color_page">
                            ...
                            <!-- ✅ زر اختيار لوجو المنتج من الجاليري -->
                            
                            <!---<a class="ajaxa add_color_page_a" href="popup-imagegallery.php" style="text-decoration:none;" title="Add Logo From The Site Gallery">🏷️ اختيار لوجو من المعرض</a>
                            -->
                            <!---<input type="hidden" name="selected_logo_image" id="selected_logo_image" value="">-->
                    ...
                    <div class="right-side-addproduct">
                        <form action="" method="POST" id="add_new" name="add_new" enctype="multipart/form-data">
                            <div class="fside f1">
                                <div id="updatemessage" style="margin-bottom:5px;"></div>
                                ...
                                <div class="fs1 f1" style="width: 50% !important;" title="أكتب عنوان المنتج باللغة العربية أو الإنجليزية حسب مكان البيع">
                                    ...
                                    <input name="pd_title" id="pd_title" maxlength="60" class="a_f pf1" type="text" value="">
                                    <span></span>
                                </div>
                                <div class="fs2 f1" style="width: 50% !important;" title="Product Item Code">
                                    <p> كود المنتج </p>
                                    <input name="pd_code" id="pd_code" maxlength="60" class="a_f pf1" onblur="check_duplicate_item_code()" type="text" value="">
                                    <span></span>
                                ...
                                <div class="fs2 f1" style="width: 50% !important;" title="Minimum Quantity">
                                    ...
                                    <input name="pd_min_order_qty" id="pd_min_order_qty" maxlength="60" class="a_f pf1" type="text" value="">
                                    <span></span>
                                </div>
                                <div class="fs2 f1" style="width: 50% !important;">
                                    ...
                                    <select size="1" name="pd_unit" id="pd_unit" class="a_f s_u" title=" إختار وحدة قياس المنتج ">
                                        ...
                                        ?>
                                            <option value="<?php echo $unitrow->mu_id; ?>"><?php echo $unitrow->mu_name; ?></option>
                                        <?php } ?>
                                    </select>
                                
                                
                            </div>
<div class="fs1 f1 product-price-row">
    <div class="form-fs1-f1" title="FOB / WholeSale Price">
        <p class="price-heading"><span style="line-height: 12px;"></span> : سعر بيع المنتج</p>
        <div class="from-f1-fs1 price-field" title="From">
            <span>من :</span> 
            <input name="pd_fob_price" id="pd_fob_price" maxlength="60" class="a_f pf1" type="text" value="<?php echo isset($pd_fob_price) ? $pd_fob_price : ''; ?>">
        </div>
        <div class="to-f1-fs2 price-field" title="To">
            <span>الى :</span> 
            <input name="pd_fob_price2" id="pd_fob_price2" maxlength="60" class="a_f pf1" type="text" value="<?php echo isset($pd_fob_price2) ? $pd_fob_price2 : ''; ?>">
        </div>
        <div class="fs2 f1 price-currency">
            <select size="1" name="pd_currency" id="pd_currency" class="a_f s_u">
                ...
                while ($currencyrow = mysqli_fetch_object($currencysql)) {
                    $selected = '';
                    if (user_info($uid, 'country') == $currencyrow->cn_id) {
                        $selected = 'selected="selected"';
                    } elseif (($pd_currency ?? '') == $currencyrow->cn_id) {
                        $selected = 'selected="selected"';
                    }
                ?>
                    <option value="<?php echo $currencyrow->cn_id; ?>" <?php echo $selected; ?>>
        ...
        <span></span>
                                ...
                                <div class="fs1 f1" style="padding-top:4px; width: 50% !important;float: right;" title="Location Preferences">
                                    ...
                                    <div style="vertical-align:middle">
                                        <label style="top:0px;" title="Abroad Only">- للتصدير فقط</label> <input type="radio" id="pd_preferred_buyer_location_1" name="pd_preferred_buyer_location" value="abroad" />
                                    </div>
                                    <div>
                                        <label style="top:0px;" title="Abroad + Domestic">- تصدير و محلى</label> <input type="radio" id="pd_preferred_buyer_location_2" name="pd_preferred_buyer_location" value="any" checked="checked"/>
                                    </div>
                                    <div>
                                        <label style="top:0px;" title="Domestic Only">- محلى فقط</label> <input type="radio" id="pd_preferred_buyer_location_3" name="pd_preferred_buyer_location" value="domestic"/>
                                    </div>
                                    <div>
                                        <label style="top:0px;" title="My City Only">- داخل مدينتى</label> <input type="radio" id="pd_preferred_buyer_location_4" name="pd_preferred_buyer_location" value="my_city"/>
                                    </div>
                                </div>
                                <div class="fs1 f1" style="padding-top:4px; width: 50% !important;float: left;" title="Product Display Status">
                                    <div>
                                        ...
                                        <label>فى المنتجات الهامة</label> <input class="rad" name="pd_hot" value="1" type="radio" checked="checked">
                                        <label>فى المنتجات العادية</label> <input name="pd_hot" value="0" id="pd_hot" type="radio">
                                    </div>
                                </div>
                                ...
                                <div class="c3 fs3" id="editor" style="">
                                    ...
                                    <textarea class="a_f" rows="15" id="pd_desc" name="pd_desc" onKeyUp="mecount();"></textarea>
