...
<div class="product_number">
    ...
    ?>
       <a href="javascript:void(0)" onclick="openWaRfq(<?php echo isset($row_pd_h->pd_id) ? $row_pd_h->pd_id : 0; ?>, '<?php echo isset($row_pd_h->pd_title) ? addslashes($row_pd_h->pd_title) : 'Product'; ?>')" style="color:#25D366; text-decoration:none; font-weight:bold;">
            📱 طلب سعر واتساب
        </a>
    <?php } else { ?>
        <a href="https://egyptmart.shop/sign-in.php#loginform" style="color:#25D366; text-decoration:none; font-weight:bold;">
            📱 سجل دخول لطلب السعر
        </a>
    <?php } ?>
</div>
...
<div class="product_number">
    <?php if (isset($_SESSION['uid_indm']) && $_SESSION['uid_indm'] != '') { ?>
      <a href="javascript:void(0)" onclick="openWaRfq(<?php echo isset($row_pd->pd_id) ? $row_pd->pd_id : 0; ?>, '<?php echo isset($row_pd->pd_title) ? addslashes($row_pd->pd_title) : 'Product'; ?>')" style="color:#25D366; text-decoration:none; font-weight:bold;">
    📱 طلب سعر واتساب
</a>
