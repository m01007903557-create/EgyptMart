...
// /* Applies only on screens 767px and below (phones/small tablets) */
// @media screen and (max-width: 767px) {

//     /* Each product item takes ~47% width so 2 fit per row (with margin/padding gap) */
//     .hot-product .grids_list section.itemr.omParentClass {
//         width: 47% !important;         /* 2-column width, leaves gap between items */
//         float: left !important;         /* items sit side-by-side instead of stacking */
//         clear: none !important;         /* allow items to sit next to each other */
//         box-sizing: border-box !important; /* padding/border included in the 47% width, prevents overflow */
//         padding: 10px 10px !important;  /* inner spacing inside each product box */
//         margin: 10px 10px !important;   /* spacing between product boxes */
//     }

//     /* Forces every odd item (1st, 3rd, 5th...) to start a new row on the left */
//     /* This keeps the 2-column pattern aligned instead of drifting */
//     .hot-product .grids_list section.itemr.omParentClass:nth-child(2n+1) {
//         clear: left !important;
//     }

// }
// /* ===== End Mobile 2-Column Grid ===== */
...
<script>
    jQuery(document).ready(function($) {
        ...
        function initBasket(){ 
            // settings.appendArrows = ".arrows_jssor_1";
            $("#productdiv1").slick(settings);
            // settings.appendArrows = ".arrows_jssor_2";
            $("#productdiv2").slick(settings);
        }

        $('.add-to-cart.omcart.om_cart').on('click', function () {

            if($('#WebcastFix .slick-initialized').length <= 0){
                if($('#WebcastFix').is(':visible')){
                    initBasket();
                }
            } else {  }
        });
...
#wideColumn.cust .grids_list .product_image {
	height: 150px;
}
#wideColumn.cust .grids_list .product_image a {
	line-height: 140px;
}
.price_div {
	text-align: left;
...
<!--<div id="fake"></div>-->
    <ul class="cb productlist-box-tab">
            ...
            <div> 
                ...
                <div class="tabcontents">
                    <div>
                        ...
                        <ul class="bdrt0 ">
                            <li class="grids_list mt-listing">
                               <!-- m -->
                                <div class="product_top_div_first mt-dt">
                                ...
                                <!-- m -->
                                <div class="top_page_list_first m-dt" style="font-weight: normal;">
                                ...
                                <div id="WebcastFix" style="display: none;">
                                    ...
                                    <!-- FIRST ROW -->
                                    <div id="jssor_1" class="jssor-slider selected_list_div shopping-cart">
                                        <form>
                                            <div class="arrows_jssor_1"></div>
                                            <div data-u="slides" id="productdiv1" class="jssor-slides">
                                    ...
                                    <div id="jssor_2" class="jssor-slider selected_list_div shopping-cart">
                                        <form>
                                            <div data-u="slides" id="productdiv2" class="jssor-slides">
                                            ...
                                            <div class="arrows_jssor_2"></div>
                                            <div class="last_button_div">
                                                <a class="oval-btn mail-btn"
                                                style="margin-top:5px;"
                                                onclick="checklogin()"
                                                href="../<?php echo 'company'; ?>/enquiryRequest.php?c=<?php echo $c; ?>">
  ...
  if (window.pageYOffset > sticky) {
    ...
    header.classList.remove("webcast-fixed");
                    ...
                    <div id="view1" style="position: relative;">
                        ...
                        <ul class="hot-product <?=($class=='product_list'?'product_list_parent-mt':'')?>">
                            <li class="ac-bdrb lc-bbw0 <?php echo $class; ?>">
                                ...
                                if (mysqli_num_rows($res_pd_h) > 0) {
                                    ...
                                    while ($row_pd_h = mysqli_fetch_object($res_pd_h)) {
                                        ?>
                                        <section class="itemr omParentClass 1">
                                        ...
                                        <div class="zk"><img src="../upload/myproduct/<?php echo  $logoarr[0]?>" /></div> 
                                                        ...
                                                        <li class="wtmp wtmpie omListWrap">
                                                            <!-- <a href="productzoomimage.php?token=<?php echo rand(1000, 9999) . md5($row_pd_h->pd_id); ?>" class="ajax1" style="cursor:pointer;"><img src="images/zoom.png" style="height: 30px; width:30px; float: right; position: absolute; right: 10px; top: 10px;"/>
                                                                <div class="f2 zoom2 mrgzoom"></div>
                                                            </a> -->
                                                            <img class="zoom_qj" data-zoom="../upload/myproduct/<?=$zoomurl?>" src="images/zoom.png" style="height: 30px; width:30px; float: right; position: absolute; right: 10px; top: 10px;"/>
                                                        </li>
...
<div class="btns-group">
    <div class="product_number w-m-100">
    <?php if (isset($_SESSION['uid_indm']) && $_SESSION['uid_indm'] != '') { 
        $product_id = $row_pd_h->pd_id ?? 0;
        $product_title = $row_pd_h->pd_title ?? 'Product';
    ?>
       <a href="javascript:void(0)" onclick="openWaRfq(<?php echo isset($row_pd_h->pd_id) ? $row_pd_h->pd_id : 0; ?>, '<?php echo isset($row_pd_h->pd_title) ? addslashes($row_pd_h->pd_title) : 'Product'; ?>')" class="w-m-100 oval-btn whatsapp-btn">
            📱 طلب سعر واتساب
        </a>
    <?php } else { ?>
        <a href="https://egyptmart.shop/sign-in.php#loginform" class="w-m-100 oval-btn whatsapp-btn">
            📱 سجل دخول لطلب السعر
        </a>
    <?php } ?>
</div>

                                                    <div class="link pt10px p-d-0 w-m-100">				
                                                        <script>
                                                        $(document).ready(function() {
                                                           var uid_ind='<?php echo $_SESSION['uid_indm']??0; ?>';
                                          ...
                                          $("#btn_ajax" +<?php echo $row_pd_h->pd_id; ?>).colorbox({width: "62%", height: "89%"}); } });
                                                        ...
                                                        <span>
                                                            <?php if (empty($_SESSION['uid_indm'])) { ?>
                                                                                <a href="/sign-in.php#loginform" rel="product-send-inquiry" class="mail-btn oval-btn w-m-100" title="Send Inquiry">تواصـل مع الشـركة
                                                                                        
                                                                                    </a>
                                                                    <?php } else { ?>
                                                            <a href="quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($row->bnsprof_id); ?>&pid=<?php echo $row_pd_h->pd_id; ?>&c=<?php echo $c; ?>&vform=1" id="btn_ajax<?php echo $row_pd_h->pd_id; ?>" rel="product-send-inquiry" class="mail-btn oval-btn w-m-100"title="Send Inquiry">تواصل مع الشـركة </a>
                                                            <?php } ?>
                                                            <img src="<?php echo BASE_URL ?>/company/images/chat_icon.png" width="20"></span>
                                                    </div>
                                                    ...
                                                    $sql_pd = "select * from products where pd_uid='" . $row->usr_id . "' and pd_status='1' and (pd_hot='0' OR pd_hot=' ')  LIMIT " . $limit . " OFFSET " . $start . "";
                                                        ...
                                                        if (mysqli_num_rows($res_pd) > 0) {
                                                            ...
                                                            while ($row_pd = mysqli_fetch_object($res_pd)) {
                                                                ?>
                                    <section class="itemr omParentClass 2">
                                        <div class="shadow items omItems">
                                            <!-- single item -->
                                            <div class="item omItems">
                                                <div class="product_image omImage"> <a href="product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:17px;">
                                                                                <img src="../upload/myproduct/<?php
                                                                                if ($row_pd->pd_image != '') {
                                                    ...
                                                    <li class="wtmp wtmpie omListWrap">
                                                        <!-- <a href="productzoomimage.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" class="ajax1" style="cursor:pointer;"><img src="images/zoom.png" style="height: 30px; width: 30px; float: right; position: absolute; right: 10px; top: 10px;" />
                                                            <div class="f2 zoom2 mrgzoom"></div>
                                                        </a> -->
                                                        <img class="zoom_qj" data-zoom="../upload/myproduct/<?=$zoomurl?>" src="images/zoom.png" style="height: 30px; width: 30px; float: right; position: absolute; right: 10px; top: 10px;" />
                                                    </li>
                                            ...
                                            <div class="product_grid_view">
                                                <div class="product_title product_title_2"> <a href="product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:17px;"><?php echo $row_pd->pd_title; ?></a> </div>
                                                <div class="product_title product_title_2">
                                                    <p>
                                                        <?php echo substr($row_pd->pd_desc, 0, 65) ?> <a href="product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:15px;"><small>المـزيــد</small></a> </p>
                                                </div>
                                                <div class="product_detail">
                                                    <div class="product_left"></div>
                                                    <div class="price_div"> <span><?php echo $row_pd->pd_fob_price; ?></span>
                                                        <?php echo get_product_detail($row_pd->pd_id, 'pd_currency'); ?>
                                                            <div class="unit_div"><span><?php echo $row_pd->pd_min_order_qty; ?> </span>
                                                                <?php echo get_measurement_unit($row_pd->pd_unit); ?><span style="font-size:11px; color: #B5BABE;"> (أقــل كـمـية)</span></div>
                                                    </div>
                                                ...
                                                $Countryphone = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `country` where cn_id = " . $row->country)); ?>
                                                                <div class="btns-group">
                                                                    <div class="product_number w-m-100">
                                                                        <?php if (isset($_SESSION['uid_indm']) && $_SESSION['uid_indm'] != '') { ?> <a href="javascript:void(0)" onclick="openWaRfq(<?php echo isset($row_pd->pd_id) ? $row_pd->pd_id : 0; ?>, '<?php echo isset($row_pd->pd_title) ? addslashes($row_pd->pd_title) : 'Product'; ?>')" class="oval-btn whatsapp-btn w-m-100">
                                                📱 طلب سعر واتساب
                                                </a>
                                                                            <?php } else { ?> <a href="https://egyptmart.shop/sign-in.php#loginform" class="w-m-100 oval-btn whatsapp-btn">
                                                📱 سجل دخول لطلب السعر
                                                </a>
                                                                    <?php } ?>
                                                        </div>
                                                        <div class="link pt10px p-d-0 w-m-100">
                                                            <script>
                                                            $(document).ready(function() {
                                                                var uid_ind = '<?php echo $_SESSION['
                                                                uid_indm ']??0; ?>';
                                                                $("#btn_ajax" + <?php echo $row_pd->pd_id; ?>).click(function() {
                                                                    if(uid_ind == '') {
                                                                        window.location.href = "https://www.egyptmart.shop/sign-in.php";
                                                                    } else {
                                                                        $("#btn_ajax" + <?php echo $row_pd->pd_id; ?>).colorbox({
                                                                            width: "62%",
                                                                            height: "89%"
                                                                        });
                                                                    }
                                                                ...
                                                                <?php if (empty($_SESSION['uid_indm'])) { ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                                    <a href="quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($row->bnsprof_id); ?>&pid=<?php echo $row_pd->pd_id; ?>&c=<?php echo $c; ?>&vform=1" id="btn_ajax<?php echo $row_pd->pd_id; ?>" rel="product-send-inquiry" class="mail-btn oval-btn w-m-100"title="Send Inquiry">تواصـل مع الشـركة
                                                                                        
                                                                                    </a> <?php } ?>
                                                                                <img src="<?php echo BASE_URL ?>/company/images/chat_icon.png" width="20">
                                                                            </span> 
                                                        </div>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function() {
        //  $('.product_image.omImage > a > img').each(function () {
            ...
            //         // Sample image edges
            //         for (var x = 0; x < w; x += Math.max(1, Math.floor(w / 30))) {
            //             samples.push(ctx.getImageData(x, 2, 1, 1).data);
            //             samples.push(ctx.getImageData(x, h - 3, 1, 1).data);
            //         }

            //         for (var y = 0; y < h; y += Math.max(1, Math.floor(h / 30))) {
            ...
            //             var r = Math.round(c[0] / 10) * 10;
            //             var g = Math.round(c[1] / 10) * 10;
            //             var b = Math.round(c[2] / 10) * 10;

            //             var key = r + ',' + g + ',' + b;
            //             colors[key] = (colors[key] || 0) + 1;
            //         });

            //         var dominant = Object.keys(colors).sort(function (a, b) {
            //             return colors[b] - colors[a];
            //         })[0];

            //         if (dominant) {
            //             $(img).parent().css('background-color', 'rgb(' + dominant + ')');
            //         }

            //     } catch (e) {
            //         console.log('Could not detect image background:', e);
            //     }
            // }
            ...
            // } else {
            //     $(img).on('load', setDynamicBackground);
            // }
