<?php
// company/fav_quotationRequest.php - نسخة PHP 8.3
...
// جلب بيانات المستخدمين والشركات (للاستخدام في الصفحة)
$userArrayRow_Result = [];
...
<head>
    ...
    function sendEnquiry() {
        ...
        if (!msg_message || msg_message.trim() === '') {
            msg = "! .. من فضلك صف متطلباتك";
            valid = false;
        } else if (msg_message.length < 50) {
            msg = "! .. من فضلك صف متطلباتك بحرف لاتقل عن 50 حرف";
            $('#msg_message').focus();
            valid = false;
        }
...
<body>
    <div class="ov-base">
        ...
        <form name="dataform" class="mp0-nw" method="post" action="">
            ...
            <input type="hidden" id="msg_subject" name="msg_subject" value="إستفسار عن صنف">
            
            <br>
            
            <div style="width: 100%; text-align: center;">
                <!-- السهم الأيسر (المنتج السابق) -->
                <?php if ($run_pre && isset($data1)): ?>
                    <!-- تم تعطيل الأسهم مؤقتاً -->
                <?php endif; ?>
            ...
            <fieldset style="height: 108px; border: 1px solid rgb(134, 182, 217); margin-top: 2px; width: 178px; width: 170px;">
                <legend style="font-size: 13px; color:#017BBC; text-align: center; width:89%; margin-bottom:2px;">
                    <strong>قم بوصف متطلباتك</strong>
                </legend>
                <div class="f1-nw" style="color:#055985;">
                    <ul>
                        <li class="li-1">متطلباتك عن المنتج</li>
            ...
            <div id="nu_frm">
                <div class="nef4-nw" align="center">
                    ...
                    <div id="err_results" style="display:none; padding-left:5px; color:#F00; padding-top:16px;" class="g9 bo off">
                        خطأ فى الإرسال .. رجاء المحاولة لاحقا
                    </div>
                </div>
            </div>
        </form>
