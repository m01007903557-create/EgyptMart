...
if (!isset($con) || !$con) die("Database connection failed");
...
<input value="<?php echo $_GET['keywords'] ?? 'Search Product'; ?>" class="input" name="keywords" id="keywords" onfocus="gotFocus();" onblur="lostFocus()" value="Search Product" style="width:120px; float:left !important"/> 
...
<?php } ?>
	  ...
	  <ul class="company_video_link"><li><span><a href="./video.php?c=<?php echo $c; ?>"title="  Company Video "> فيديو الشركة </a></span></li></ul>
				...
				<section id="header">		
						...
						<?php
if ($file == "profile") {
    // قسم السلايدر الخاص بـ profile.php
    ?>
    <?php var_dump($banner); ?>
    <?php echo "<!-- DEBUG: file=" . $file . ", banner count=" . count($banner) . " -->"; ?>
    ...
    // قسم السلايدر الخاص بباقي الصفحات (products.php, enquiry.php, index.php)
