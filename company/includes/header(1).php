<?php
// company/includes/header.php - نسخة PHP 8.3
                            ...
                            <?php if (is_file("../upload/companylogo/" . $row->bnsprof_complogo)): ?>
                                <li>
                                    <img src="https://egyptmart.shop/upload/companylogo/<?php echo htmlspecialchars($row->bnsprof_complogo); ?>" 
                                         style="max-height:76px; margin-right:10px; padding-top:10px;" />
                                </li>
                        ...
                        <li>
                            ...
                            <div id="profile_sub_menu">
                                <div class="profile_list_value">
                                    ...
                                    <div class="user_name_value">
                                        <p style="line-height:1.5em;text-align:left;font-size:1.4em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;color:#002757;">
                            ...
                            <div class="abcdefgh">
                                <div id="dialog-form" title="Contact Supplier" style="background-color: #fbfbda; overflow: visible;">
                                    ...
                                    <div id="sms_succ_result" style="display:none; padding-left:105px; color:#009700; padding-top:16px;" 
                                         class="g9 bo off">
