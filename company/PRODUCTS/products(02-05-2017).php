...
$flaag = $_GET['flaag'];
if($flaag=='whsuccess'){?>
<div style="text-align: center; color: green; text-align: center">Wholesale Contact, Message Sent Successfully</div>
<?php }
        ...
        <li id="wideColumn">		
            ...
            <div> 
                ...
                <ul class="b fo ac-fl acac-db acac-p10px15px acac-btlr5px acac-btrr5px ac-mr5px large tabs" data-persist="true">
                    ...
                    <li><a href="#view1" id="hide" class="lightbg2 gbiwt bdrr bdr bdrb0 gray" style="outline:none; cursor: pointer;">Hot Products</a></li>

                    <li class="selected"><a href="#view2" id="show" class="lightbg2 gbiwb cd bdr bdrb0 mt1px"  style="outline:none;">Other Products</a></li>
                    <li>
                        <div class="view_list_design" style="padding-left:290px;"><span style="font-size: 13px;">View As</span>&nbsp;&nbsp;
                        ...
                        <ul class="bdrt0 ">
                            <li class="grids_list">
                                <div class="product_top_div_first">
                                    <div class="top_text_first" style="font-weight:100 !important;">
                                        click <span><i class="fa fa-plus"></i></span> to select products and contact the suppiler or give wholesale order. 	
                                    </div>
                                ...
                                <div id="jssor_1" class="selected_list_div shopping-cart" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 809px; height: 150px; overflow: hidden; visibility: hidden;">
                                    <!-- Loading Screen -->
                                    <form>
                                        <div data-u="slides" id="productdiv" style="cursor: default; position: relative; top: 0px; left: 0px; width: 809px; height: 150px; overflow: hidden;">
                                        ...
                                        <div class="last_button_div" style="padding-right: 14px; float:right !important; margin-top: 103px; position:absolute; right:0px;">
                                            <a onclick="checklogin()" href="../<?php echo 'company'; ?>/enquiryRequest.php?c=<?php echo $c; ?>" style="font-size: 23px;"><i class="fa fa-envelope"></i>Wholesale Contact</a>
                                        </div>
                                        <!-- Bullet Navigator -->
                                        ...
                                        <section class="itemr">
                                            <div class="shadow items">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <a href="/<?php echo $row_own->bnsprof_comp_url?>/product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd_h->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:17px;">
                                                        ...
                                                        ?>" alt="<?php echo $row_pd_h->pd_title; ?>" class="cu" style="height:94%;">
                                                        <?php if ($row_pd_h->pd_imagelogo != '') { 
                                                          $logoarr = explode(',',$row_pd_h->pd_imagelogo); ?>
                                        <img src="../upload/myproduct/<?php echo  $logoarr[0]?>" style="position: absolute;bottom:5px; width: 42px;height: 41px;"/> 
                                                        <?php  }  ?>
...
if(uid_ind==''){
window.location.href="http://www.arabyos.com/sign-in.php";
}else{
                                          $("#btn_ajax" +<?php echo $row_pd_h->pd_id; ?>).colorbox({width: "62%", height: "89%"}); } });
                                                        });
                                                        </script>
                                                        <span>
                                                            <a href="quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($row->bnsprof_id); ?>&pid=<?php echo $row_pd_h->pd_id; ?>&c=<?php echo $c; ?>&vform=1" id="btn_ajax<?php echo $row_pd_h->pd_id; ?>" rel="product-send-inquiry" class="inquiry_but">Send Inquiry</a></span>
                        ...
                        <div class="top_page_list_first" style="display: block; position: inherit; float:left; width:100%; padding-top: 30px; text-align: center !important;">
                            <a class="but left" uri-id="<?php echo 'test.php?c=' . $c . '&view=' . $class . '&page=' . $prev; ?>" uri-page="<?php echo $prev;?>" href="javascript:void(0)" style="border-style: solid; border-width: 1px; border-color: black; color:#060; font-size: 17px;">Prev</a>
                            ...
                            <?php endfor; ?>
                             ...
                             <a class="but right" uri-id="<?php echo 'test.php?c=' . $c . '&view=' . $class . '&page=' . $next; ?>" uri-page="<?php echo $next;?>" href="javascript:void(0)" style="border-style: solid; border-width: 1px; border-color: black; color:#060; font-size: 17px;">Next</a>
                                                ...
                                                <div class="item">
                                                    <div class="product_image">
                                                     <a href="product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:17px;">
                                                        ...
                                                        ?>" alt="<?php echo $row_pd->pd_title; ?>" class="cu" style="height:94%;">
                                                
                                                        <?php  if ($row_pd->pd_imagelogo != '') { 
                                                          $logoarr = explode(',',$row_pd->pd_imagelogo); ?>
                                        <img src="../upload/myproduct/<?php echo  $logoarr[0]?>" style="position: absolute;bottom: 10px;left: 0px; width: 56px; height: 55px;"/> 
                                                        <?php  } ?>
                                                        </a>
                                                        <li class="wtmp wtmpie">
                                                            <a href="productzoomimage.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" class="ajax1" style="cursor:pointer;"><img src="images/zoom.png" style="height: 30px; width: 30px; float: right; position: absolute; left: 153px; top: 125px;"/>
                                                                <div class="f2 zoom2 mrgzoom"></div>
                                                            </a>
                                                        </li>
...
window.location.href="http://www.arabyos.com/sign-in.php";
                                                        ...
                                                        <span>
                                                            <a href="quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($row->bnsprof_id); ?>&pid=<?php echo $row_pd->pd_id; ?>&c=<?php echo $c; ?>&vform=1" id="btn_ajax<?php echo $row_pd->pd_id; ?>" rel="product-send-inquiry" class="inquiry_but">Send Inquiry</a></span>
                                                        <span><img src="<?php echo BASE_URL ?>/company/images/chat_icon.png" width="20"></span>
                                                    </div>
                        ...
                        <div class="top_page_list_first" style="display: block; position: inherit; float:left; width:100%; padding-top: 30px; text-align: center !important;">
                            <a class="buts left" uri-id="<?php echo 'tests.php?c=' . $c . '&view=' . $class . '&page=' . $prev; ?>" uri-page="<?php echo $prev;?>" href="javascript:void(0)" style="border-style: solid; border-width: 1px; border-color: black; color:#060; font-size: 17px;">Prev</a>
                            <?php for ($i = 1; $i <= $totalitems; $i++) : ?>
                                <a class="buts" uri-id="<?php echo 'tests.php?c=' . $c . '&view=' . $class . '&page=' . $i; ?>" uri-page="<?php echo $i;?>" href="javascript:void(0)" style="border-style: solid; border-width: 1px; border-color: black; color:#060; font-size: 17px; font-family: serif;"><span style="margin: 2px 5px 4px 5px; font-weight: 200 !important;"><?php print_r($i); ?></span></a>
                            <?php endfor; ?>
                             
                            <a class="buts right" uri-id="<?php echo 'tests.php?c=' . $c . '&view=' . $class . '&page=' . $next; ?>" uri-page="<?php echo $next;?>" href="javascript:void(0)" style="border-style: solid; border-width: 1px; border-color: black; color:#060; font-size: 17px;">Next</a>
                        </div> 
                    </div>
                    </div>
                </div>
...
height:390px;
                ...
                <style>
                    div.shadow:hover {
                        -moz-box-shadow: 0px 0px 0px 1px rgb(122, 117, 117);
                        -webkit-box-shadow: 0px 0px 0px 1px rgb(122, 117, 117);
                        box-shadow: 0px 0px 0px 1px rgb(122, 117, 117);
                    }
                </style>
