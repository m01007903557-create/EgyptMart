<?php
/**
 * File: upload-prd-largeimg.php

 * Description: نافذة رفع الصور الكبيرة للمنتج
...
<head>
    ...
    <title>رفع الصور الكبيرة للمنتج</title>
    ...
    <script>
    function list_photo() {
        $.get("product-largeimg-list.php", {'pid': <?php echo $pid; ?>}, function(data) {
            $('#list_photo').html(data);
        });
    }

    function DelTempImage(pid) {
        if (confirm("Do you really want to remove this image?")) {
            $.get("product-largeimg-del.php", {pid: pid}, function(data) {
                list_photo();
            });
        }
    }
    ...
    $(function() {
        $('#file_upload').uploadifive({
            ...
            'uploadScript': 'product-largeimg-add.php',
    ...
    <form name="iform" style="margin:0px;" action="" method="post" enctype="multipart/form-data">
        <div class="file_button" style="margin:0px;" id="addbut">
            ...
            <div id="buttons" onMouseOver="showImgButt();" onMouseOut="hideImgButt();">
                <img src="images/add-image-new.gif" style="cursor:pointer" width="125" height="125" alt="Add Image">
