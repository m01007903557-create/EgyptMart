...
// ✅ استعلام INSERT مع source_platform = 'saleoffer'
$sql = "INSERT INTO buy_requirement (
    br_pc_id,          /* ✅ هذا العمود مهم */
    br_u_id,
    br_pd_name,
    br_requirement,
    br_posting_date,
...
$wa_url = "https://api.whatsapp.com/send?phone=" . $platform_phone . "&text=" . urlencode($message);
