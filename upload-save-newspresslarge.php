<?php
/**
 * File: upload-save-newspresslarge.php

 * Description: نافذة رفع الصور الكبيرة المؤقتة للأخبار
...
<head>
    ...
    <title>رفع الصور الكبيرة المؤقتة للأخبار</title>
    ...
    <script>
    function list_photo() {
        $.get("upldtmplarge-news-list.php", {'uid': <?php echo $uid; ?>}, function(data) {
    ...
    $(function() {
        $('#file_upload').uploadifive({
            ...
            'uploadScript': 'upldtmplarge-news.php',
