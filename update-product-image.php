<?php
/**
 * File: update-product-image.php

 * Description: نافذة رفع وتحرير صور المنتج
...
<head>
    ...
    <script>
    function list_photo() {
        $.get("product_photo.php", {'pdid': <?php echo $pdid; ?>}, function(data) {
    ...
    function DelTempImage(imid) {
        if (confirm("هل أنت متأكد من حذف هذه الصورة؟")) {
            $.get("del_product_image.php", {imid: imid}, function(data) {
                list_photo();
            });
        }
    }
    ...
    $(function() {
        $('#file_upload').uploadifive({
            ...
            'uploadScript': 'product-image.php',
