...
<div class="mp7">
    ...
    <div class="mp7"><?php echo user_info($uid, 'country_ph_code') . '-' . user_info($uid, 'bnsprof_phcode1') . '-' . user_info($uid, 'bnsprof_ph1'); ?></div>
    
    <div class="mp8"><strong>تليفــون أرضى 2:</strong></div>
    <div class="mp7"><?php echo user_info($uid, 'country_ph_code') . '-' . user_info($uid, 'bnsprof_phcode2') . '-' . user_info($uid, 'bnsprof_ph2'); ?></div>
    ...
    <div class="mp7"><?php echo user_info($uid, 'country_ph_code') . '-' . user_info($uid, 'bnsprof_mobile2'); ?></div>
    
    <div class="mp8"><strong>فاكس:</strong></div>
    <div class="mp7"><?php echo user_info($uid, 'country_ph_code') . '-' . user_info($uid, 'bnsprof_faxcode1') . '-' . user_info($uid, 'bnsprof_fax1'); ?></div>
    
    <div class="mp8"><strong>البريد الألكترونى الأساسى:</strong></div>
    <div class="mp7"><?php echo user_info($uid, 'email'); ?></div>
</div>
     <?php if(user_info($uid,'usr_oauth_reg') == '0'){?>
    ...
    <img src="social_media_images/linkedinLog.png" />&nbsp;&nbsp;&nbsp;
     <?php }?>
 	<div class="mp8"title="Contact person photo ">صورة مسئول الإنصال </div>
	<div class="mp7"><label id="lbl_website">
	<?php if(user_info($uid,'image')!=""){ ?>
		<img src="<?php echo 'data:image/jpg;base64,'.base64_encode( getUserInfo($uid,'profileImage'));?>" width="110" id="profilephoto1" height="130">
	<?php } else{ ?>
	<img src="http://egyptmart.shop/images/uploadd.png" width="110" id="profilephoto1" height="130">	
	<?php } ?>
	</label></div>
    <div class="clb"></div>
