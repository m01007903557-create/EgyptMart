<?php
/**
 * File: read_business_services.php
 * Description: البحث التلقائي عن المنتجات والتصنيفات (AutoComplete)
...
$search_term = trim($_REQUEST['searchkey']);
...
<ul id="country-list" class="countrytwo" style="top:0; left:initial;">
    <?php while ($row = mysqli_fetch_assoc($result)): 
        ...
        $search_url = "https://egyptmart.online/search.php?rctyp=Products&keywords=" . urlencode($pd_title);
    ?>
