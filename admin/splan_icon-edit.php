<?php
/**
 * File: splan_icon-edit.php

 * Version: 1.0.0
 * PHP Version: 8.3
 * 
 * Description: تعديل أيقونات خطط العضوية
 * Edit membership plan icons
 * 
 * Features:
 * - تعديل اسم الخطة
 * - تغيير أيقونة الخطة
...
/**
 * Class MembershipIconEditor
 * 
 * Handles membership plan icon editing operations
 */
class MembershipIconEditor {
    ...
    public function getDetails(): ?object {
        ...
        $sql = "SELECT * FROM smembership_icon_plan WHERE mp_id = ?";
    ...
    public function update(): void {
        ...
        // Update database
        $sql = "UPDATE smembership_icon_plan SET
                mst_name = ?,
                mst_icon = ?,
                mp_updated_date = NOW()
                WHERE mp_id = ?";
...
// Initialize editor
$editor = new MembershipIconEditor($planId);
...
if (isset($_POST['btnUpdate'])) {
    ...
    header("Location: splan_icon-edit.php?fid=" . $planId);
    exit;
}
?>
