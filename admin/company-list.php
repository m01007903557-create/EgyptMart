    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <style>
                ...
                .table th:nth-child(1), .table td:nth-child(1) { width: 20px; text-align: center; }
                ...
                .table th:nth-child(13), .table td:nth-child(13) { width: 70px; text-align: center; }
                .table th:nth-child(14), .table td:nth-child(14) { width: 30px; }
                .table th:nth-child(15), .table td:nth-child(15) { width: 70px; text-align: center; }
