...
$('.send-notification').click(function(e) {
    ...
    // تنظيف رقم الهاتف - إزالة كل شيء ما عدا الأرقام
    ...
    // إذا كان الرقم لا يبدأ بـ 20، أضف 20
    if (!cleanPhone.startsWith('20')) {
        cleanPhone = '20' + cleanPhone;
    }
    
    // بناء الرابط السحري
    let magicLink = 'https://egyptmart.shop/ajax-file/enq-details.php?rfq_id=' + rfqId;
    
    // بناء رسالة واتساب
    let waMsg = '*📦 عرض سعر جديد لطلبك #' + rfqId + '*\n\n';
    waMsg += '🏢 *المورد:* ' + supplierName + '\n';
    waMsg += '💰 *السعر:* ' + price + ' ' + currency + '\n';
    waMsg += '🚚 *مدة التوصيل:* ' + delivery + ' يوم\n\n';
    waMsg += '✨ *للقبول أو الرفض:*\n' + magicLink;
    
    // رابط واتساب
    let whatsappUrl = 'https://wa.me/' + cleanPhone + '?text=' + encodeURIComponent(waMsg);
    
    // فتح واتساب
    window.open(whatsappUrl, '_blank');
    alert('✅ تم فتح واتساب للمشتري');
