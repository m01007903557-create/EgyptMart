...
class editBuyReq
{
	...
	{
		global $con;
		$sql="select * from buy_requirement,product_category,measurement_unit where br_pc_id=pc_id and br_estimate_qty_unit=mu_id and md5(br_id)='".$this->br_id."'";
		...
		if($_FILES["br_pic"]["name"] != '')
		{
			...
			{	
				...
				{*/	
					...
					echo $sql="update buy_requirement
						set
						...
						br_pc_country='".$this->br_pc_country."',
						br_updated_date=now()
					where
						br_id='".$this->br_id."'";						
...
if(isset($_POST['btnUpdate'])){
	...
	$ob->br_pc_country=addslashes(trim($_POST['pc_country']));
...
//			$sql_pc="select * from product_category where pc_parent_id='0'";
    ...
    <div class="form-group">
        ...
        <?php
//		 	$sql_pc="select c.pc_name,s.pc_name from product_category c,product_category s where c.pc_id=s.pc_parent_id and s.pc_id='".$row->so_pc_id."'";
			$sql_spc="select * from product_category where pc_parent_id=(select pc_parent_id from product_category where pc_id='".$row->br_pc_id."')";
    ...
    <div class="form-group">
        ...
        <?php
			...
			?>
            <select id="pc_country" name="pc_country">
