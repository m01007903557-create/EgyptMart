<?php
/**
 * File: admin/advcathome-view.php
 * Version: PHP 8.3
 * Description: عرض وإدارة إعلانات الفئات في لوحة التحكم
 * 
 * تعرض هذه الصفحة قائمة إعلانات الفئات مع إمكانية
...
/**
 * كلاس إدارة قائمة إعلانات الفئات
 */
class sliderviewlist
{
    ...
    public function deleterecord(int $adid): void
    {
        ...
        $chquesql = "SELECT * FROM advertisementcathome WHERE adv_id = " . $adid;
        ...
        if ($chqueres && mysqli_num_rows($chqueres) > 0) {
            ...
            if (!empty($chquerow['adv_img'])) {
                $path = "../upload/advertisementcathome/" . $chquerow['adv_img'];
                if (file_exists($path)) {
                    unlink($path);
                }
            }
        ...
        $sql_del = "DELETE FROM advertisementcathome WHERE adv_id = " . $adid;
    ...
    public function deletelink(int $id): string
    {
        if ($_SERVER['QUERY_STRING'] == "") {
            ...
            $dellink = "advcathome-view.php?" . $_SERVER['QUERY_STRING'] . "&action=del&fid=" . $id;
        }
        return $dellink;
    }
}
...
$al->setsql("SELECT * FROM advertisementcathome ORDER BY adv_updated_date DESC");

$totalitems = $al->totalrecord();
$limit = $al->limit;
$al->start = $p->setstart($page, $limit, $totalitems);
$adjacents = 1;
$targetpage = "advcathome-view.php";
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">View Categories Advertisement</li>
                </ul><!-- .breadcrumb -->
            </div>
                        ...
                        <div class="col-xs-12">
                            <div class="table-header">
                                ...
                                <button type="button" class="btn btn-xs btn-success" onclick="window.location='advcathome-add.php'">
                                    <i class="icon-pencil align-top bigger-120"></i>Add Categories Advertisement
                                </button>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <?php if (!empty($row->adv_img)): ?>
                                                        <img src="../upload/advertisementcathome/<?php echo htmlspecialchars($row->adv_img); ?>" width="200px;" height="150px;" style="border: 1px solid #ddd; padding: 3px;" alt="Advertisement" />
                                                    <?php else: ?>
                                                ...
                                                <td align="center">
                                                    <a href="advcathome-edit.php?aid=<?php echo (int)$row->adv_id; ?>" title="Edit">
...
function changeStatus(stat, id) {
    ...
    $.post("ajax-file/advcathome-change-status.php", {stat: stat, id: id}, function(data) {
        location.reload();
    }).fail(function() {
