<?php
/**
 * File: serviceslider-view.php
 * Version: 2.0.0 (PHP 8.3)
 * Description: عرض وإدارة سلايدر الخدمات
 */
...
/**
 * Class sliderviewlist - إدارة سلايدر الخدمات
 */
class sliderviewlist {
    ...
    public function deleterecord(int $adid): void {
        ...
        if ($row && !empty($row['adv_img'])) {
            $path = "../upload/service_slider/" . $row['adv_img'];
            if (is_file($path)) {
                unlink($path);
            }
        }
    ...
    public function deletelink(int $id): string {
        $dellink = $_SERVER['QUERY_STRING'] == "" 
            ? "?action=del&fid=" . $id
            : "serviceslider-view.php?" . $_SERVER['QUERY_STRING'] . "&action=del&fid=" . $id;
        return $dellink;
    }
}
...
$query = "SELECT * FROM prodservice_slider WHERE adv_type = '2' ORDER BY adv_updated_date DESC LIMIT {$al->start}, {$limit}";
$al->setsql($query);
$recObj = $al->listview();
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="serviceslider-view.php">Manage Service Slider</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-header">
                                ...
                                <button type="button" class="btn btn-xs btn-success" onclick="window.location='serviceslider-add.php'">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_<?php echo $row->adv_id; ?>">
                                            ...
                                            <td style="text-align:center;">
                                                <img src="https://egyptmart.shop/upload/service_slider/<?php echo htmlspecialchars($row->adv_img); ?>" width="200px;" height="150px;">
                                              </td>
                                            <td style="text-align:center">
                                            ...
                                            <td align="center">
                                                <a href="serviceslider-edit.php?aid=<?php echo $row->adv_id; ?>" title="edit">
