...
<div class="sidebar" id="sidebar">
	...
	<li class="treeview">
    <a href="#">
        <i class="fa fa-tag"></i> <span>عروض الأسعار</span>
        <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
    <ul class="treeview-menu">
        <li><a href="offers.php"><i class="fa fa-list"></i> جميع العروض</a></li>
        <li><a href="offers.php?status=pending"><i class="fa fa-clock-o"></i> قيد الانتظار</a></li>
        <li><a href="offers.php?status=notified"><i class="fa fa-check-circle"></i> تم الإشعار</a></li>
    </ul>
</li>
			
			
		<li <?php if($file=="whatsapp_rfq"){ ?> class="active open" <?php } ?>>
    <a href="#" class="dropdown-toggle">
        <i class="fa fa-whatsapp" style="color:#25D366;"></i>
       <i class="icon-shopping-cart"></i>
     <span class="menu-text">WhatsApp RFQ</span>
        <b class="arrow icon-angle-down"></b>
    </a>
    <ul class="submenu">
        <li <?php if($file=="whatsapp_rfq" && !isset($_GET['status'])){ ?> class="active" <?php } ?>>
            <a href="whatsapp_rfq.php">جميع الطلبات</a>
        </li>
        <li <?php if(isset($_GET['status']) && $_GET['status']=='pending'){ ?> class="active" <?php } ?>>
            <a href="whatsapp_rfq.php?status=pending">قيد الانتظار</a>
        </li>
        <li <?php if(isset($_GET['status']) && $_GET['status']=='sent_to_supplier'){ ?> class="active" <?php } ?>>
            <a href="whatsapp_rfq.php?status=sent_to_supplier">تم الإرسال</a>
        </li>
        <li <?php if(isset($_GET['status']) && $_GET['status']=='waiting_response'){ ?> class="active" <?php } ?>>
            <a href="whatsapp_rfq.php?status=waiting_response">انتظار رد</a>
        </li>
        <li <?php if(isset($_GET['status']) && $_GET['status']=='closed'){ ?> class="active" <?php } ?>>
            <a href="whatsapp_rfq.php?status=closed">مغلق</a>
        </li>
    </ul>
</li>
			
			
		<li <?php if($file=="social_requests" || $file=="social_requests_details" || $file=="social_requests_edit"){ ?> class="active open" <?php } ?>>
    <a href="#" class="dropdown-toggle">
        <i class="icon-share-alt"></i>
        <span class="menu-text">طلبات السوشيال</span>
        <b class="arrow icon-angle-down"></b>
    </a>
    <ul class="submenu">
        <li <?php if($file=="social_requests"){ ?> class="active" <?php } ?>>
            <a href="social_requests.php">
                عرض الطلبات
                <?php
                ...
                if ($new_row['new_count'] > 0):
                ?>
                <span class="badge" style="background:#e74c3c; color:#fff; border-radius:50%; padding:2px 8px; font-size:11px; margin-right:5px;">
                    <?php echo $new_row['new_count']; ?>
                </span>
                <?php endif; ?>
            </a>
        </li>
