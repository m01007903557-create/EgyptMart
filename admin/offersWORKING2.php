...
$('.send-notification').click(function(e) {
    ...
    whatsappMsg += `https://egyptmart.shop/ajax-file/enq-details.php?offer_id=${offerId}&rfq_id=${rfqId}&type=inbox\n\n`;
    ...
    console.log('cleanPhone النهائي:', cleanPhone);
console.log('طول الرقم:', cleanPhone.length);
    ...
    }).catch(err => console.log('تحديث الحالة فشل:', err));
    ...
    alert('✅ تم فتح واتساب لإرسال العرض للمشتري');
});
