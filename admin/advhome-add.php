<?php
/**
 * File: admin/advhome-add.php
 * Version: PHP 8.3
 * Description: إضافة إعلان جديد للصفحة الرئيسية
 * 
 * تسمح هذه الصفحة للمشرف بإضافة إعلان للصفحة الرئيسية مع تحديد
 * البلد والموقع وحجم الصورة
 */
...
/**
 * كلاس إضافة إعلان الصفحة الرئيسية
 */
class addAdvertisement
{
     ...
     */
    public function __construct($imgsize, $adv_img, $adv_link, $adv_country, $adv_position)
    {
        global $con;
        $this->con = $con;
