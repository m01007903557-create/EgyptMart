<?php
/**
 * File: splan_icon-add.php
 * Version: 1.0.0
 * PHP Version: 8.3
 * 
 * Description: إضافة أيقونات خطط العضوية الجديدة
 * Add new membership plan icons
 * 
 * Features:
 * - إضافة خطة عضوية جديدة مع أيقونة
 * - رفع الأيقونات
...
/**
 * Class MembershipIconAdder
 * 
 * Handles membership plan icon addition operations
 */
class MembershipIconAdder {
    ...
    private function isDuplicateName(): bool {
        ...
        $sql = "SELECT COUNT(*) as count FROM smembership_icon_plan WHERE mst_name = ?";
    ...
    public function add(): void {
        ...
        $sql = "INSERT INTO smembership_icon_plan SET
                mst_name = ?,
                mst_icon = ?,
                mp_status = 1,
                mp_updated_date = NOW()";
        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="splan_icon-view.php">Manage Membership Icons</a>
                    </li>
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1>
                        Add New Membership Icon
                        <small>
                            <i class="icon-double-angle-right"></i>
                            Create a new plan icon
                        </small>
                    </h1>
                </div>
                        ...
                        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" 
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="splan_icon-view.php" class="btn btn-primary">
