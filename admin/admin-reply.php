<?php
/**
 * File: admin/admin-reply.php
 * Version: PHP 8.3
 * Description: صفحة الرد على استفسارات العضوية في لوحة التحكم
 * 
 * تسمح هذه الصفحة للمشرف بالرد على استفسارات العضوية
...
/**
 * كلاس إدارة الردود على استفسارات العضوية
 */
class MembershipReqDetails
{
    ...
    /**
     * Constructor
     * @param int $mp_req_id معرف الاستفسار
     */
    public function __construct($mp_req_id)
    {
        global $con;
        $this->con = $con;
        $this->mp_req_id = (int)$mp_req_id;
    }
    ...
    public function insertMsg(): void
    {
        ...
        $sql = "INSERT INTO message 
                SET 
                    ...
                    msg_to = '" . mysqli_real_escape_string($this->con, $obj->mp_user_id) . "',
                    ...
                    msg_entity = '" . mysqli_real_escape_string($this->con, $entity) . "',
    ...
    private function processImages(string $content): string
    {
        ...
        foreach ($imageTags as $tag) {
            ...
            if (!empty($filename)) {
                ...
                $new_src = 'https://egyptmart.shop/images/reply/' . $filename;
                $content = str_replace($tag->getAttribute('src'), $new_src, $content);
            }
        }
    ...
    private function sendEmail($obj): void
    {
        ...
        $subject = get_page_settings(4) . " رد أدمن المنصة على متطلبات عضويتك";
        ...
        if ($obj->mp_id == 'Advertisement Request') {
            ...
            foreach ($membership_plans as $plan) {
                $plan_id = (int)$plan;
                if ($plan_id > 0) {
                    $sql = "SELECT * FROM `smembership_icon_plan` WHERE `mp_id` = " . $plan_id;
                    $membership_qry = mysqli_query($this->con, $sql);
        ...
        $enq_details = ' <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Selected Membership Plans: ' . htmlspecialchars($plans) . '</p>
                        ...
                        Company Name: ' . htmlspecialchars($obj->company_name ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Name: ' . htmlspecialchars($obj->name ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Contact Number: ' . htmlspecialchars($obj->mobile ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Email: ' . htmlspecialchars($obj->email ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Country: ' . htmlspecialchars($obj->country ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        City: ' . htmlspecialchars($obj->city ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Address: ' . htmlspecialchars($obj->address ?? '') . '</p>
                        <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Requirements: ' . htmlspecialchars($obj->requirement ?? '') . '</p>';
...
if (isset($_POST['btnReplyBack'])) {
    header("location: membership-requirement.php?fid=" . $fid);
    exit();
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars(ucfirst($row->name ?? '')); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars(ucfirst($row->company_name ?? '')); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars($row->mobile); ?></label>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars($row->country ?? ''); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars($row->city ?? ''); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars($row->address); ?></label>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label style="padding-top:4px;"><?php echo html_entity_decode(htmlspecialchars($row->requirement ?? '')); ?></label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            if ($row->mp_id == 'Advertisement Request') {
                                ...
                                foreach ($membership_plans as $plan) {
                                    ...
                                    if ($plan_id > 0) {
                                        $sql = "SELECT * FROM `smembership_icon_plan` WHERE `mp_id` = " . $plan_id;
                                        $membership_qry = mysqli_query($con, $sql);
                            ...
                            ?>
                            <div class="col-sm-8">
                                <label style="padding-top:4px;"><?php echo htmlspecialchars($plans); ?></label>
                            </div>
                        </div>
                        ...
                        <form class="form-horizontal" name="mem_reply" id="mem_reply" method="post" enctype="multipart/form-data" onsubmit="return filling();">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="reply_subject" id="reply_subject" class="form-control" type="text" 
                                           value="<?php echo isset($_POST['reply_subject']) ? htmlspecialchars($_POST['reply_subject']) : 'Reply from Admin for your ' . $req . ' Requirement'; ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">				
                                    <textarea name="reply_content" id="reply_content"><?php echo htmlspecialchars($reply_content); ?></textarea>
                                </div>
                            </div>
