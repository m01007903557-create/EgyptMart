<?php
/**
 * File: support-category-list.php
 * Version: 1.0.0
 * PHP Version: 8.3
 * 
 * Description: عرض وإدارة تصنيفات الدعم
 * View and manage support categories
 * 
 * Features:
 * - عرض جميع تصنيفات الدعم
 * - إضافة تصنيفات جديدة
 * - تعديل التصنيفات
 * - حذف التصنيفات مع الأسئلة المرتبطة
 * - حذف متعدد
 * - ترقيم الصفحات
 */
...
echo $pagination->renderPagination($currentPage, $totalPages);
                                    if ($totalPages > 1) {
...
echo '<li class="prev"><a href="?page=' . $prevPage . '"><i class="icon-double-angle-left"></i></a></li>';
                                        } else {
