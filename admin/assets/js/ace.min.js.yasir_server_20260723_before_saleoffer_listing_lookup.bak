...
;jQuery(function(a){if(!a('a[href="hero-video.php"]').length){var b=a(".nav.nav-list"),c=a('<li><a href="hero-video.php"><i class="icon-film"></i><span class="menu-text"> Hero Video </span></a></li>'),d=b.find(".menu-text").filter(function(){return a.trim(a(this).text())==="Video Slider Mgmt"}).closest("li");d.length?d.after(c):b.append(c)}});
;(function(){var a;function b(){var c=window.jQuery;if(!c){return}if(c('a[href="hero-video.php"]').length){clearInterval(a);return}var d=c(".nav.nav-list");if(!d.length){return}var e=c('<li><a href="hero-video.php"><i class="icon-film"></i><span class="menu-text"> Hero Video </span></a></li>'),f=d.find(".menu-text").filter(function(){return c.trim(c(this).text())==="Video Slider Mgmt"}).closest("li");f.length?f.after(e):d.append(e);clearInterval(a)}a=setInterval(b,500);b()})();
;(function(){var a;function b(){if(document.querySelector('a[href="hero-video.php"]')){clearInterval(a);return}var c=document.querySelector(".nav.nav-list");if(!c){return}var d=document.createElement("li");d.innerHTML='<a href="hero-video.php"><i class="icon-film"></i><span class="menu-text"> Hero Video </span></a>';var e=[].filter.call(c.querySelectorAll(".menu-text"),function(f){return(f.textContent||"").replace(/\s+/g," ").trim()==="Video Slider Mgmt"})[0];var g=e;while(g&&g.tagName!=="LI"){g=g.parentNode}g&&g.parentNode?g.parentNode.insertBefore(d,g.nextSibling):c.appendChild(d);clearInterval(a)}a=setInterval(b,500);if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",b)}b()})();
