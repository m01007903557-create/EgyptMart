...
<div class="main-container" id="main-container">
    ...
    <?php
    // استخدام مسار الصورة المخزن مباشرة
    $current_image_name = $row['br_pic'] ?? ''; 
    if (!empty($current_image_name)) {
        $image_url = '../upload/buy_requirement/' . htmlspecialchars($current_image_name);
        echo '<div><img src="' . $image_url . '" style="max-width: 200px; max-height: 150px; border: 1px solid #ddd; padding: 5px;" /></div>';
