...
class sliderviewlist{
	...
	function deleterecord($adid){
		...
		$path="https://egyptmart.shop/upload/product_slider/".$chquerow['adv_img'] ;
		unlink($path);
	...
	function deletelink($id){
		if($_SERVER['QUERY_STRING']==""){
			...
			$dellink="productslider-view.php?".$_SERVER['QUERY_STRING']."&action=del&fid=".$id;
		}
		return $dellink;
	}
}
...
$adjacents=1;
$targetpage = "productslider-view.php";
...
<button class="btn btn-xs btn-danger" name="btnDelete" type="submit" onClick="return confirm('Are you sure to delete the record?')" ><i class="icon-trash bigger-120"></i>Delete</button>
 <button type="button" class="btn btn-xs btn-success" onClick="window.location='productslider-add.php' "><i class="icon-pencil align-top bigger-120"></i>Add Slider</button>
 </div>
...
$count=mysqli_num_rows($recObj);
	if($count >0)
	{
        ...
        <tr>
			...
			<td style="text-align:center;"><img src="https://egyptmart.shop/upload/product_slider/<?php echo $row->adv_img; ?>" width="200px;" height="150px;"/></td>
			...
			<?php 
			 ...
			 echo '<br/><br/><strong>Fob price:</strong> '.$currency_symbols[$row->adv_currency].$row->adv_price;
			  echo '<br/><br/><strong>MOQ unit:</strong> '.$row->adv_piece;
			   echo '<br/><br/><strong>Unit type:</strong> '.$row->unit_type;
          ...
          <script>
            ...
            <td align="center">
     <a href="productslider-edit.php?aid=<?php echo $row->adv_id; ?>" title="edit"><img alt="edit" src="images/edit.jpg" border="0"></a>
