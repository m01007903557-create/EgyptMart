...
}		// هذا القوس يغلق الدالة أو الشرط الذي بدأ قبله
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onSubmit="return myvalid();">
    ...
    echo ($msg_from_id > 0) ? getUserInfo($msg_from_id, 'name_prefix') . " " . getUserInfo($msg_from_id, 'fname') . " " . getUserInfo($msg_from_id, 'lname') : 'مرسل غير معروف';
    ?>
</label>
		</div>
	</div>
