                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($row['bnsprof_comp_url'] ?? 'غير محدد'); ?></td>
                                           <td class="center">
                                               
                                               <td class="center">
                                           <td class="center"><?php echo htmlspecialchars(($row['country_name'] ?? 'غير محدد') . ' - ' . ($row['supplier_city'] ?? 'غير محدد')); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php if($row['wa_sent_count'] > 0): ?>
                                                <small class="text-muted">أرسل <?php echo $row['wa_sent_count']; ?> مرة</small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="btn-group btn-group-xs">
                                                    <button class="btn btn-info view-rfq" data-id="<?php echo $row['br_id']; ?>" title="عرض"><i class="fa fa-eye"></i></button>
                                                    <button class="btn btn-success send-supplier" data-id="<?php echo $row['br_id']; ?>" title="إرسال للمورد"><i class="fa fa-paper-plane"></i></button>
                                                    <button class="btn btn-warning similar-suppliers" data-id="<?php echo $row['br_id']; ?>" title="موردين مشابهين"><i class="fa fa-users"></i></button>
                                                    <button class="btn btn-danger" onclick="deleteRfq(<?php echo $row['br_id']; ?>)" title="حذف"><i class="fa fa-trash"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
