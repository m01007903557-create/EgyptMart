            ...
            <div style="width: 600px;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              <div style="height: 50px; width: 100%; float: left; ">
                  <div style="height: 100px; width: 30%; float: left;">
                      <img style="width: 100%;color: #00F;font-size: 22px;font-weight: bold;" alt="EgyptMRAT" src="https://egyptmart.online/images/logo.png"/>
                  </div>
              ...
              <div style="clear:both">
			  			  ...
			  			  <div>
			  <a href="https://egyptmart.online
/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=https://egyptmart.online
/product-sel-cat.php " ><img src="https://egyptmart.online/admin/images/RENEWAL_mail_Notification.png" alt="" height="100%" width="100%"></a>
			  </div>
			   <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
              ...
              <div style="width: 100%; line-height:1.5em;font-size:12px;font-family:Arial,Helvetica,sans-serif;padding:0.5em 0 0.9em 1em">
			  	<p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left"><a href="https://egyptmart.online/company/products.php?c='.$cid.'">https://egyptmart.online/company/products.php?c='.$cid.'</a></p>
			  </div>
			  </div>
			  <div>
			  ...
			  <table>
  <tr>
    <th style="vertical-align: top;"> <img src="https://egyptmart.online/admin/images/sponser.png" alt="" height="" width=""></th>
	<th></th>
...
<p style="text-align:right;"><a href="https://egyptmart.online" style="text-decoration: none;color:blue;">Learn More ></a></p>
                ...
                <br>
                <div style="clear:both">
                    <p style="line-height:1.5em;text-align:center;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em"><a href="https://egyptmart.online/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=https://egyptmart.online/why_egyptmart.php" style="font-size: 16px;font-weight: normal;">Click Here</a> to Unsubscribe  or Tell us your requirements  <a href="https://egyptmart.online/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=https://egyptmart.online/membership_plans.php" style="text-decoration: none;"><strong style="color: #0f00d0;font-size: 19px;font-weight: 600;">NOW!</strong></a></p>
                </div>
                                                        <br>
              ...
              <div style="width:100%;float:left;text-align:center;padding-top: 10px;padding-bottom: 10px;">
                  <a href="https://egyptmart.online/dir.php" style="color:#466da0;text-decoration:none;font-size:18px;font-weight:bold;">Product &amp; Suppliers</a> | <a href="https://egyptmart.online/sale-offers.php" style="color:#466da0;text-decoration:none;font-size:18px;font-weight:bold;">Sale Offers</a> | <a href="https://egyptmart.online/buyleads.php" style="color:#466da0;text-decoration:none;font-size:18px;font-weight:bold;">Buy Requests</a> | <a href="https://egyptmart.online/tenders.php" style="color:#466da0;text-decoration:none;font-size:18px;font-weight:bold;">Tenders</a>
              </div>
