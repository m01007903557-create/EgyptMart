 ...
 * Description: Admin dashboard - ترقية من النسخة الإنجليزية
 */
...
<!-- ===== ثم كود JavaScript الذي يعتمد على jQuery ===== -->
<script type="text/javascript">
    ...
    if (typeof jQuery !== 'undefined') {
        ...
        console.log("jQuery not loaded for DataTable");
    }
</script>
