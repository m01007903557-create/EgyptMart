<?php
/**
 * File: myproduct-buy.php
 * Description: إدارة المنتجات والخدمات التي تشتريها الشركة بانتظام للحصول على تنبيهات عروض البيع
    ...
    try {
        ...
        foreach ($pdby_titles as $title) {
            ...
            if ($cat_row) {
                ...
                // التحقق من وجود التصنيف في تنبيهات البيع
            ...
            // إدراج المنتج
            $insert_sql = "INSERT INTO product_buy (pdby_uid, pdby_title) VALUES (?, ?)";
        ...
        $msg = '<div class="save bnr mt12" id="savemsg"><strong>! تم حفظ المنتجات والخدمات التى تقوم بشرائها بنجاح</strong></div>';
        $_SESSION['msg'] = $msg;
        ...
        mysqli_rollback($con);
        error_log("Product Buy Error: " . $e->getMessage() . " | User ID: $uid");
        $msg = '<div class="error bnr mt12" style="color:red;"><strong>حدث خطأ أثناء الحفظ</strong></div>';
    }
}
...
$sql = "SELECT pdby_id, pdby_title FROM product_buy WHERE pdby_uid = ? ORDER BY pdby_id DESC";
    ...
    <div class="hm1 bbc" id="res-mob1">
        ...
        <div class="inner_wrapper">
            ...
            <div class="w56b f1 p2b p14 blr">
                <div>
                    <h1 style="font-size:22px; font-weight:bold; direction:ltr; text-align:left;">
                ...
                <div id="re_link" class="utab">
                    <span style="font-size:20px;" class="f1" style="direction:ltr; text-align:left;" 
                          title="Add Products / Services you usually Buy & Get Sell Offer Alerts to your mailbox.">
                        To receive the best Sell Offer notifications from different suppliers
                    </span>
                </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="label" valign="top">
                                            * Add product or service items<br>that your company regularly purchases throughout the year
                                        </td>
                                        <td>
                                            ...
                                            <div class="f1 m5" id="hidetbl">
                                                <a class="f_l" onclick="add_more(<?php echo $uid; ?>);" id="ad_more1" style="cursor:pointer;">
                                                    + Add More
                                                </a>
                                            </div>
                                        </td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="118px;">
                                                            ...
                                                            <input name="btnUpdate" value="Save Changes" class="saps mt5" tabindex="31" type="submit">
                                                        </td>
                                                        <td>
