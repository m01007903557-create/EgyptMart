  ...
  jQuery(document).ready(function () {
	...
	console.log('click pull');
      ...
      $("#homeSmartSearchMode").click(function () {
          ...
          $("#home_search_mode").val(isActive ? "scenario" : "standard");
          if (isActive) {
      ...
      function homeScenarioKeywords(text) {
          ...
          var bulk = clean.match(/\bbulk\s+([a-z0-9-]+)/i);
          if (bulk && bulk[1]) return bulk[1];
          clean = clean.replace(/\b(from|with|for|near|in|at|by|best|supplier|suppliers|factory|manufacturer|delivery|fast|quantity|large|small|bulk|buy|need|want|order|purchase|source|looking|here|egypt|saudi|uae|china|india|i|to|a|an|the|of|and|get)\b/gi, " ");
          clean = $.trim(clean.replace(/[^a-z0-9\u0600-\u06FF ]+/gi, " ").replace(/\s+/g, " "));
          var words = clean.split(" ").filter(Boolean).slice(0, 3).join(" ");
          return words || $.trim(text);
      }
      ...
      $("#homeSmartSearchForm").submit(function (event) {
          ...
          $("#homeSmartSearchMode").addClass("loading").prop("disabled", true).text("AI...");
          $.ajax({
              url: "ai-search.php",
              type: "POST",
              dataType: "json",
                ...
                <div id="cont1" class="content_tab"title=" &#1605;&#1587;&#1578;&#1608;&#1585;&#1583; –  &#1571;&#1608; &#1588;&#1585;&#1603;&#1577; &#1588;&#1585;&#1575;&#1569; –  &#1571;&#1608;  &#1578;&#1575;&#1580;&#1585;  -  &#1571;&#1608; &#1576;&#1610;&#1578; &#1588;&#1585;&#1575;&#1569; &#1605;&#1578;&#1582;&#1589;&#1589; ">
                  ...
                  <div class="text-box">
                    ...
                    <div class="text-box-right">
                      ...
                      <form id="homeSmartSearchForm" method="GET" name="searchForm2" action="search.php" onsubmit="return emScenarioSubmit(this,'keywords_r','home_search_mode')">
                        <input type="hidden" id="home_search_type" name="rctyp" value="Products">
                        <input type="hidden" id="home_search_mode" name="search_mode" value="standard">
                        <input size="24" class="m1 bl6" id="keywords_r" name="keywords"
                          type="text"title="- &#1573;&#1576;&#1581;&#1579; &#1608;&#1573;&#1603;&#1578;&#1588;&#1601; –  &#1571;&#1604;&#1575;&#1601; &#1605;&#1606; &#1601;&#1585;&#1589; &#1575;&#1604;&#1576;&#1610;&#1593; ">
                        <button type="button" id="homeSmartSearchMode" class="smart-search-mode home-smart-search-mode" title="Natural language search" onclick="return emScenarioToggle(this,'keywords_r','home_search_mode')">AI mode</button>
        ...
        <div class="allcate">
            ...
            <div class="home-mobile-yahoo-after-rfq">
              ...
              <div class="home-mobile-yahoo-track">
                <?php while ($mobileYahooRow = mysqli_fetch_object($mobileYahooRes)) {
                    $mobileYahooImg = "upload/yahoo_slider/" . $mobileYahooRow->adv_img;
                    $mobileYahooLink = $mobileYahooRow->adv_link;
                ?>
                <a href="<?php echo htmlspecialchars($mobileYahooLink, ENT_QUOTES, 'UTF-8'); ?>" target="_blank">
