<?php
/**
 * File: manage-selloffer-alert.php
 * Description: إدارة تنبيهات عروض البيع - عرض التصنيفات المشترك بها وإضافتها وحذفها
...
// معالجة إضافة تصنيف من خلال الكلمات المفتاحية
if (isset($_GET['keywords']) && !empty($_GET['keywords'])) {
    $keywords = trim($_GET['keywords']);
    $key_cat_id = 0;
    
    // البحث عن التصنيف المرتبط بالمنتج
    $sql_key = "SELECT pc.pc_id 
                FROM products p
                INNER JOIN product_category pc ON pc.pc_id = p.pd_subcat_id
                WHERE p.pd_title = ? 
                AND pc.pc_status = '1' 
    ...
    if (mysqli_num_rows($result_key) > 0) {
        ...
        $check_query = "SELECT sac_id FROM selloffer_alert_category WHERE sac_pc_id = ? AND sac_usr_id = ? LIMIT 1";
        ...
        if (mysqli_num_rows($check_result) == 0) {
            $insert_sql = "INSERT INTO selloffer_alert_category (sac_usr_id, sac_pc_id, sac_updated_date) VALUES (?, ?, NOW())";
...
if (isset($_GET['sub_cat_id']) && !empty($_GET['sub_cat_id']) && is_numeric($_GET['sub_cat_id'])) {
...
$sql = "SELECT pc.*, sac.sac_id 
        FROM product_category pc
        INNER JOIN selloffer_alert_category sac ON pc.pc_id = sac.sac_pc_id
        WHERE sac.sac_usr_id = ?
        ORDER BY pc.pc_order ASC";
...
<head>
    ...
    function addAlertCategory() {
        $.post("ajax-file/addSellofferAlertCat.php", {}, function(data) {
    ...
    function delAlertCat(id) {
        if (confirm("Are you sure to delete this Category?")) {
            $.post("ajax-file/delSellofferAlertCat.php", {id: id}, function(data) {
                window.location.reload();
            });
        }
    }
    ...
    <div class="hm1 bbc" id="res-mob1">
        ...
        <div class="f1 w61n tb lh ml br" id="lnav">
            <ul id="ulid" class="nln1" style="margin:0px; padding:0px;">
                ...
                <li class="np npnew"><a class="leftindi txtcol" href="manage-buy-requirement.php" title="Manage Buy Requirements">»&nbsp;إدارة طلبات الشراء المنشورة</a></li>
                <li class="np npnew"><a href="manage-selloffer-alert.php" title="Manage Sell Offer Alerts">»&nbsp;إدارة عروض البيع المنشورة</a></li>
                <li class="np npnew"><a href="my-selloffer-locationpref.php" title="Location Preferences">»&nbsp;حدد أماكن ورود إشعارات عروض بيع</a></li>
                
                <li style="border-bottom:medium none; margin-top:40px;" title="You may also like to">
                    <h2>روابط هامة لنجاح أعمالك</h2>
                </li>
                <li class="np npnew"><a href="buyleads.php" title="View Latest Buy Leads">»&nbsp;شاهد أحدث طلبات الشراء</a></li>
                <li class="np npnew"><a href="manage-purchased-buyleads.php" title="View Purchased Buy Leads">»&nbsp;شاهد طلبات الشراء الجاهزة المشتراه</a></li>
                <li class="np npnew"><a href="manage-buylead-alert.php" title="Manage Buy Lead Alerts">»&nbsp;إدارة إشعارات طلبات شراء لمنتجاتى</a></li>
            </ul>
        </div>
                                        ...
                                        <tr>
                                            <td style="border-right:0px; padding-right:10px" valign="top" width="100%">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="LEFT" height="38" valign="TOP" width="325">
                                                                ...
                                                                <nobr>
                                                                    <div class="mf18 mc5 mta2 mpr8 mpt10" title="Manage Sell Offer Categories to Get Alerts Via Your Mailbox">
                                                                        سجل أصناف مشتريات لتلقى إشعارات عروض بيع
                                                                    </div>
                                                                </nobr>
                                                            </td>
                                                            <td valign="bottom"></td>
                                                            <td valign="bottom">
                                                                <div class="manage_country mb" style="text-align:left" id="titleee">
                                                                    <a href="browse-cat-for-selloffer-alert.php" id="add_cat" class="ajax" title="Add More Categories">
                                                                        أضف أصناف إشعارات عروض البيع
                                                                    </a>
                                                                </div>
                                                            </td>
                                                            <td valign="bottom">
                                                                <div class="manage_country mb">
                                                                    <a href="my-selloffer-locationpref.php" title="Manage Your Location Preferences">
                                                                        حدد أماكن ورود إشعارات عروض البيع منها
                                                                    </a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div style="font-family:arial; font-size:12px; margin-top:9px; color:#000000; padding-left:5px;">
                                                    <div style="width:218px; float:left;" title="No. of Sell Offer Alerts Subscribed">
                                                        عدد تصنيفات إشعارات عروض البيع الحالية
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="2" align="LEFT">
                                                                <b style="font-size:14px;" title="Your Existing Sell Offer Alert Subscription">
                                                                    أصناف إشعارات عروض البيع الحالية
                                                                </b>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                ...
                                                <table class="select_sp" style="border-top:1px solid #C8DDEC" align="CENTER" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <td class="tdoffer" style="padding-left:5px;" align="LEFT" bgcolor="#F1F9FE" width="80%" title="تصنيفات المنتجات"></td>
                                                            <td class="tdoffer" align="right" bgcolor="#F1F9FE" title="حذف تصنيفات المنتجات">
                                                        ...
                                                        <?php if ($subscription_count > 0): ?>
                                                            ...
                                                            <tr id="map1">
                                                                ...
                                                                <td style="cursor:pointer;" align="CENTER">
                                                                    <a onclick="delAlertCat(<?php echo (int)$sub['sac_id']; ?>)" style="cursor:pointer;">
                                                        ...
                                                        <tr>
                                                            <td colspan="5" height="60">
                                                                <div style="font-family:arial; font-size:16px; color:#FF0000;" align="center">
                                                                    <b>You do not have any Sale Offer Alerts</b>
                                                                </div>
                                                                <div style="font-family:arial; font-size:16px; color:#FF0000;" align="center">
                                                                    <a href="browse-cat-for-selloffer-alert.php" class="ajax">
                                                                        Click here to Add Sale Offer Alerts
                                                                    </a>
                                                                </div>
                                                            </td>
                                                        </tr>
