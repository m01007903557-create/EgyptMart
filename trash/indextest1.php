...
<div class="wrapper">
                ...
                <h3 style="margin-left: 10PX"><a href="dir.php#main_cat"><i class="fa fa-list-ul" style="color:#FF4500 "></i>&nbsp;<span>A</span>ll Categories</a></h3>
                    <div id="block_navigation">
                        ...
                        <ul class="navigation ptag">
                           ...
                           <?php echo $row_dd_mnu->pc_name; ?> <span class="main_links_span"></span></a>
                    ...
                    <div class="list-top">
                        <div class="seniorbox">
                            ...
                            <ul>
                                ...
                                <p><a href="why_ARABYOS.php" style="fright">Learn More <span>&gt; &gt;</span></a></p>
                            </ul>

                            <h3><a href="why_ARABYOS.php">Upgrade Now</a></h3>
                        </div>
                    </div>
                    ...
                    <div class="slider">
                        ...
                        <div class="video_slider">
                            ...
                            <div class="verifiedbox_bottom">
                               <!-- <h4><a href="company-video.php"><span>Upload</span> Company video <span>Free</a></h4>-->

                                <div class="verifiedbox_supplierbox">
                                    <h3>Verified Suppliers</h3>

                                     <p>Selected Supplier from around the world  <span class="fright"><a href="why_ARABYOS.php">Learn More &gt; &gt;</a></span></p>

                                    <div class="clear"></div>
                                    <ul>
                                        <li><a href="why_ARABYOS.php" class="tooltip1"><img src="images/verified01.jpg" alt=""/>
                                        <span><i>SPONSOR Supplier</i>
</span></a></li>
                                        <li><a href="why_ARABYOS.php" class="tooltip1"><img src="images/verified02.jpg" alt=""/>
                                         <span> <i>SENIOR Supplier</i>
</span></a></li>
                                        <li><a href="why_ARABYOS.php" class="tooltip1"><img src="images/verified03.jpg" alt=""/>
	...
	<tr>
		...
		<td>			<ul class="country">
                    ...
                    <div class="countrubox_top2">
                        <div class="countrubox_heading"><h2>View <a href="#"><span>Products &amp; Suppliers</span></a>
                        </h2></div>
	...
	(br_preferred_supplier_location='abroad' and br_u_id not in(select distinct usr_id from user where country=(select cn_id from country where cn_code='" . $location_geo_country . "')))
								...
								<a href="company/products.php?c=<?php echo rand(1000, 9999) . md5($row_bprof->bnsprof_id); ?>&sc=<?php echo rand(10000, 99999) . $row_prd->pd_subcat_id; ?>#<?php echo $row_prd->pd_id; ?>" style="text-decoration:none;color:#000" target="_blank">
                                                                ...
                                                                <div class="matterbox">
                                                                    <div class="icon_pic"><img src="images/slider-icon01.jpg"
                                                                    ...
                                                                    <div class="rightmatter">
                                                                      ...
                                                                      <p>Country:  <span class="nam" > <?php echo get_country_name($row_prd->cn_id);?></span><br></p>
                                                                        ...
                                                                        <p><?php echo $row_prd->cn_currency; ?>&nbsp; <span class="nam" ><?php echo $row_prd->pd_fob_price ?>/</span><?php echo $row_prd->mu_name; ?></p>
                                                                        <div class="clear"></div>
                                                                    </div>
                                                                    <div class="clear"></div>
                                                                </div>
        ...
        if (mysqli_num_rows($res_so) > 0) {
                               ...
                               style="text-decoration:none;color:#000" target="_blank">
                                     ...
                                     title="<?php echo ucwords($row_so->so_service); ?>" class="img-responsive"/>
                                                        ...
                                                        <div class="matterbox">
                                                            <div class="icon_pic">
                                                                <img src="images/slider-icon02.jpg" class="img-responsive" alt=""/>
                                                            </div>
                                                            <div class="rightmatter">
                    ...
                    <div class="demobox">
                        <div class="booking">
                            <a href="why_ARABYOS.php">You Can Advise Here <span>FREE</span> in Primacy Booking</a>
                        </div>
                        <div class="clear"></div>
                        <div class="countrubox_top2">
                            <div class="countrubox_heading">
                             <div class="mainflagbox">
                                    <div class="membershipicon"><a href="#"><img src="images/membership-icon01.png"
                                                                                 alt=""/></a></div>
                            ...
                            <div class="list-rights">
                                <h2><a href="why_ARABYOS.php" target="_blank"><span>Post</span> Premium Ads</a></h2>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="col-md-12">
    ...
    <div class="mainflagbox">
                    ...
                    <div class="demobox">
                        <div class="countrubox_top4">
                            ...
                            <div class="list-rights">
                                <h2><a href="why_ARABYOS.php" target="_blank"><span>Add</span> Your Logo</a></h2>
                            </div>
                            <div class="clear"></div>
                        </div>
                ...
                <div id="rightsection">
                    ...
                    <div class="buyleads">
                       <!-- <div class="leftleads"><h2><a href="search.php?keywords=processor&rctyp=buy_lead">Buy Leads &nbsp;<i class="fa fa-caret-right"></i></a>-->
                         <div class="leftleads"><h2><a href="buyleads.php?keywords=processor&rctyp=buy_lead">Buy Leads &nbsp;<i class="fa fa-caret-right"></i></a>
                        </h2></div>
                        <?php
                        ...
                        $cnt_br1 = mysqli_num_rows($res_br1);
  ...
  <div class="learnmore"><p><a href="buyleads.php?keywords=processor&rctyp=buy_lead" target="_blank">All Live Buy Leads <span>&gt;&gt;</span></a></p></div>
                        </div>
                        <div class="clear"></div>
                    </div>
                        <?php } ?>
                            ...
                            <div class="resp-tabs-container">
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
									...
									?>
										...
										<?php } ?>
										<div class="clear"></div>
                                        <div class="learnmore"><p><a href="#">View all <a href="tenders.php">Tender</a> <!--/ <a
                                    ...
                                    <ul class="tab_img">
                                        <li>
                                            <div class="popular-post-grids">
                                                <div class="popular-post-grid">
                                                    <div class="post-img">
                                                        <a href="#"><img src="images/email-icon.jpg"
                                                                         class="img-responsive" alt=""/></a></div>
                                                    <div class="post-text">
                                                        <a class="pp-title" href="post-buy-req.php"> Send us your Buy
                                                            Requirement</a>

                                                        <p>Receive Responses from pre-verified and qualified
                                                            suppliers.</p>
                                                    </div>
                                                    <div class="clear"></div>
                                                </div>
                                        ...
                                        <li>
                                            <div class="popular-post-grids">
                                                <div class="popular-post-grid">
                                                    <div class="post-img">
                                                        <a href="#"><img src="images/search.jpg" class="img-responsive"
                                                                         alt=""/></a></div>
                                                    <div class="post-text">
                                                        <a class="pp-title" href="search_adv.php"> Search for a product</a>
                                        ...
                                        <li>
                                            <div class="popular-post-grids">
                                                <div class="popular-post-grid">
                                                    <div class="post-img">
                                                        <a href="#"><img src="images/bell.jpg" class="img-responsive"
                                                                         alt=""/></a></div>
                                                    <div class="post-text">
                                                        <a class="pp-title" href="manage-selloffer-alert.php"> subscribe to Trade
                                                            Alerts</a>
                                                ...
                                                <div class="popular-post-grid">
                                                    <div class="post-img">
                                                        <a href="#"><img src="images/email-icon.jpg"
                                                                         class="img-responsive" alt=""/></a></div>
                                                    <div class="post-text">
                                                        <a class="pp-title" href="single.html"> Send us your Buy
                                                            Requirement</a>
                    ...
                    <div class="seniorbox">
                        ...
                        <ul>
                            ...
                            <p style="padding-right:15px;"><a href="why_ARABYOS.php">Learn More <span>&gt; &gt;</span></a></p>
                        </ul>
                        <h3><a href="why_ARABYOS.php">Request All Privileges </a></h3>
                        <!--<h3><a href="#">Request Trust Sign </a></h3>-->
                    </div>
                    <!-- End of seniorbox // -->
                    <?php
                        ...
                        <div class="testimonialbg">
						   ...
						   <?php while($row_testi = mysqli_fetch_object($res_testi)){?>
                            ...
                            <div class="testiwriter">
                                <div class="pic1"><img src="upload/testimonial_img/<?php echo $row_testi->testi_image; ?>" alt=""/></div>
                                <div class="pic-info">
                                    <h5><?php echo $row_testi->testi_name; ?></h5>

                                    <p><a href="#"><?php echo get_country_name($row_testi->testi_cn_id); ?></a></p>
                                </div>
                            </div>
						   <?php }?>
                    ...
                    <div class="juniorbox">
                        ...
                        <p><i style="font-weight:bold"><?php echo stripslashes($row_testi->testi_details); ?></i></br></br>
                            <a href="why_ARABYOS.php" class="fright" style="padding-right:15px;">Learn More <span>&gt; &gt;</span></a>
                        </p>
</div>
                        <div class="clear"></div>
    ...
    <div class="footer-intro"><!-- footer-intro start -->
        <div class="footer-intro-left">
            <div class="footer-intro-left-logo">
			      <?php 
					...
					{
					   $footerlogo2show = "images/footer-intro-left-logo02.png.png";	
					}
					?>
        ...
        <div class="footer-intro-right"><!-- footer-intro-right start -->
            ...
            <div class="footer-intro-right-col">
                ...
                <ul>
                    <li><a href="why_ARABYOS.php">Premium Membership</a></li>
                    <li><a href="manage-purchased-buyleads.php">Trade Leads For Me</a></li>
                    <li><a href="why_ARABYOS.php">Advertise with us </a></li>
                </ul>
            </div>
            <div class="footer-intro-right-col">
