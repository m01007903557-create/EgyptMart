...
<button type="button" class="btn btn-default border-radius-0  txt-bold bold-xs btn-white text-capitalize <?php echo $pc_id; ?>" style="border-top:2px solid #ff7519 !important;border:0px;font-weight:700; z-index: 9999;">Suppliers</button>
<button type="button" class="btn btn-default border-radius-0  txt-bold bold-xs btn-white text-capitalize " style="background-color: #F5F7FA"><a href="products.php?c=<?php echo md5($category_p_id); ?>" style="color:#000;font-weight: 700; z-index: 99999;" target="_new">Products</a></button>
</div>
<?php 
