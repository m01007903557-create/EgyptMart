...
<div style="left: 473px; top: 330px;" class="ddshadow toplevelshadow"><div style="left: 170px; top: 125px;" class="ddshadow"></div></div>
...
<div class="clr"></div>
  ...
  <div id="middle_container">
      <div>
       <img src="images/banner-about_us.jpg" width="100%" />
        <!--navigation start-->
...
<div id="content_area">
    ...
    <div class="right-side2" style="width:80%;">
        ...
        <p align="justify">
        <?php echo get_page_content(1,'cms_content');?>
