...
$comment="<div style='width: 628px;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;'>";
      ...
      $comment.="</div><div style='height:100px;width:43%;float:left;'><h2 style='font-size: 20px; color:#466da0; text-align: center; margin-top:0px; margin-bottom:0px;'>Today's Latest<br> Tenders Approval</h2></div>";
        $comment.="<div style='min-height: 100px; width: 27%; float: right; padding-top: 3px;'><span style='font-size: 15px; float: right; padding-bottom: 0px; clear: both; font-weight: bold;color:#000000;'> Notification</span><span style='float: right; font-size: 13px; padding-top: 0px; clear: both;color:#000000;'>".date('M d, Y')."</span></div></div>";
		  $comment.="<div style='width:100%;float:left;color:#000000;'><p style='font-size:16px;color:#000000'><strong>Dear ".$suname."</strong>,<br><br><b>Your below Tender was approved to be active on <span style='color:blue'>ARABYOS.com</span></p></div>";
...
<div style="color: #000;">Use your current mail address + default password: 123456  <a href="https://arabyos.com/sign-in.php?email='.$suser->email.'" style="text-decoration:none;margin-left: 50px;font-size: 14px;">Sign in NOW</a></div>';
		$comment.='<div>
			  ...
			  <td style="padding: 5px;"><a href="https://arabyos.com/sign-in.php?email='.$row_mpc->email.'&redirect=https://arabyos.com/post-tender.php" style="padding: 5px;color: #0f00d0;font-size: 18px;font-weight: 600;text-decoration:none;">Tenders / Auctions</a></td>			  
			  </tr>
			 
			  </table>
			  </div>';
		$comment.=' <div style="clear:both">
                    <p style="line-height:1.5em;text-align:center;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em"><a href="https://arabyos.com/sign-in.php?email='.$suser->email.'&redirect=https://arabyos.com/why_ARABYOS
.php" style="font-size: 12px;font-weight: normal;">Click Here</a> to unsubscribe  or tell us your requirements  <a href="https://arabyos.com/sign-in.php?email='.$suser->email.'&redirect=https://arabyos.com/membership_plans.php"><strong style="color: #0f00d0;font-size: 10px;font-weight: 600;">NOW!</strong></a></p>
                </div>';
