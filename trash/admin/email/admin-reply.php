            ...
            <div style="width: 90%;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              ...
              <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
                <p style="font-size:1.4em;margin:0;padding:.5em 0 0.5em;line-height:1.4em;text-align:center">
                  <b>Enquiry Reply from <span style="color: blue">ARABYOS</span> Admin </b>
                </p>               
...
<p style="font-size: 14px; line-height:24px; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif;" align="left">
				...
				if($plans == 'Advertisements Requirements'){
					$message1 .= '<p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">You can Reply :<a style="float: right" href="https://arabyos.com/advertise-with-us.php">Reply NOW</a></p>';
				}
				else if($is_contact == 1){
					$message1 .= '<p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">You can Reply :<a style="float: right" href="https://arabyos.com/contact_us.php">Reply NOW</a></p>';
				}
				else { 
				
					$message1 .= '<p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">You can Reply :<a style="float: right" href="https://arabyos.com/membership_plans.php">Reply NOW</a></p>';
					}
  ...
  <span style="color:rgb(171,172,172);font-size:11px">You are receiving this mailer as a registered member of <span style="color:blue">ARABYOS</span>.</span>
              ...
              <div style="width:100%;padding-left: 0px;float:left;color:#808080;"><p style="margin:10px 0px 2px">You have received this mail virtue of your opt-in subscription for  Enquiry on <font style="color:blue;">ARABYOS</font>.</p>
              </div>
            </div>
          </span>
        </td>
