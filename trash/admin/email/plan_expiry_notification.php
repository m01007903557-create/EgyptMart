          ...
          <span style="width:750px;word-wrap:break-word;" id="wbr">
            <div style="width: 600px;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              ...
              <div style="clear:both">
			  			  ...
			  			  <div>
			  <a href="https://arabyos.com/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=https://arabyos.com
/product-sel-cat.php " ><img src="https://arabyos.com/admin/images/RENEWAL_mail_Notification.png" alt="" height="100%" width="100%"></a>
			  </div>
			   <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
              ...
              <div style="width: 100%; line-height:1.5em;font-size:12px;font-family:Arial,Helvetica,sans-serif;padding:0.5em 0 0.9em 1em">
			  	<p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left"><a href="https://arabyos.com/company/products.php?c='.$cid.'">https://arabyos.com/company/products.php?c='.$cid.'</a></p>
			  </div>
			  </div>
			  <div>
			  ...
			  <table>
  <tr>
    <th style="vertical-align: top;"> <img src="https://arabyos.com/admin/images/sponser.png" alt="" height="" width=""></th>
	<th></th>
...
<p style="text-align:right;"><a href="https://arabyos.com" style="text-decoration: none;color:blue;">Learn More ></a></p>
