...
$randNo = rand(10000,55555);
	...
	function __construct($f_heading,$f_content,$f_main_feature,$f_image,$randNo)
	{
	...
	global $con;
		...
		if($this->f_image == '1')
		{
			$sql2="update feature_images set
						fi_f_id = '".$lastId."'
				where 
						fi_f_id = '".$this->randNo."'";		
...
if(isset($_SESSION['f_main_feature'])){ $f_main_feature=$_SESSION['f_main_feature']; unset($_SESSION['f_main_feature']); } else { $f_main_feature=""; }
if(isset($_SESSION['f_heading'])){ $f_heading=$_SESSION['f_heading']; unset($_SESSION['f_heading']); } else { $f_heading=""; }
if(isset($_SESSION['f_content'])){ $f_content=$_SESSION['f_content']; unset($_SESSION['f_content']); } else { $f_content=""; }
if(isset($_SESSION['f_image'])){ $f_image=$_SESSION['f_image']; unset($_SESSION['f_image']); } else { $f_image=""; }

if(isset($_POST['btnAdd']))
{
	
	$adn=new addproduct(addslashes(trim($_POST['f_heading'])), addslashes(trim($_POST['f_content'])) ,addslashes(trim($_POST['f_main_feature'])),  addslashes(trim($_POST['f_image'])), $_POST['randNo']);
...
{
	$.get("list_temp_photo.php", {'pid' : <?php echo $randNo; ?>}, function(data){	$('#list_photo').html(data); });
}
...
<td  style="width:678px">
		<div class="formItem leftLabel" style="padding-bottom:10px; padding-top:10px;">
			...
			<div class="formInputBox" style="width:387px;height:auto;">
                <input type="radio" name="f_main_feature" value="1">&nbsp;Yes&nbsp;&nbsp;<input type="radio" value="0" name="f_main_feature" checked="checked">&nbsp;No
			</div>
		</div>
        <div class="formItem leftLabel" style="padding-bottom:10px; padding-top:10px;">
			<label style="width:120px;">Heading: <span>*</span></label>
			<div class="formInputBox" style="width:387px;height:auto;">
                      <textarea name="f_heading" id="f_heading"class="reg_txtfld" style="height: 300px" ><?php echo $f_heading;?></textarea> 
			</div>
		</div>
		 ...
		 <div class="formItem leftLabel" style="padding-bottom:10px; padding-top:10px;">
			...
			<div class="formInputBox" style="width:387px;height:auto;">
                       <textarea name="f_content" id="f_content" class="reg_txtfld"  style="height: 300px" ><?php echo $f_content;?></textarea> 
			</div>
		</div>
		 ...
		 <div class="formItem leftLabel" style="padding-bottom:10px; padding-top:10px;">
			...
			<div class="formInputBox" style="width:387px;height:auto;">
                     &nbsp;&nbsp; <input type="checkbox" name="f_image" id="f_image" onclick="showUploader();" value="1"/>
			</div>
		</div>
