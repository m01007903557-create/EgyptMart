...
if(isset($_POST['btnApprove']))
{
	...
	header("Location:selloffer-details.php?token=".rand(1000,9999).md5($so_id));
}
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->so_service; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	 <label style="padding-top:4px;"><?php echo $row->so_description; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
        <?php
		 	$sql_pc="select m.pc_name,c.pc_sort_name,s.pc_sort_name from product_category m,product_category c,product_category s where m.pc_id=c.pc_parent_id and c.pc_id=s.pc_parent_id and s.pc_id='".$row->so_pc_id."'";
			$res_pc=mysqli_query($con, $sql_pc);
			$row_pc=mysqli_fetch_array( $res_pc);
		 ?>
   		   	 <label style="padding-top:4px;"><?php echo $row_pc[0]." &raquo; ".$row_pc[1]." &raquo; ".$row_pc[2]; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
            ...
            <?php
				if($row->so_domestic_display=='1'){	echo "Domestic";	}
				if($row->so_domestic_display=='1' && $row->so_global_display=='1'){		echo ", ";	}
				if($row->so_global_display=='1'){	echo "Global";	}
			?>
            </label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
	        <label style="padding-top:4px;"><?php if($row->so_validity=='365'){	echo "1 Year";	}else if($row->so_validity=='90'){echo "3 Months";	}else{	echo "1 Month";	} ?></label>
