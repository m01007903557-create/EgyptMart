...
class productlist{
	...
	function deleterecord($adid){
		global $con;
		mysqli_query($con, "delete from faq_categories_arabyos where fc_id='".$adid."'");
		mysqli_query($con, "delete from custom_faq_arabyos where cf_fc_id='".$adid."'");
	}
...
$al->setsql("select * from faq_categories_arabyos order by fc_id asc");
