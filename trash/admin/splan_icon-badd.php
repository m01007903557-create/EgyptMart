...
$data = mysql_query("select * from business_profile where bnsprof_compname!=''") or die(mysql_error());
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="splan_icon-view.php">Assign Buisness Type Plan</a>
			</li>
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
    ...
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Buisness Plan<span style="color:#CC0000">*</span></label>
		<div class="col-sm-9">
		<select  data-width="fit" name="buisness_plan" id="buisness_plan" class="col-xs-10 col-sm-5">
         <?php
         $data = mysql_query("select * from smembership_icon_plan where mp_status = '1'");
        $count=mysql_num_rows($data);
        while($row=mysql_fetch_object($data)){
         ?>
         <option value="<?php echo $row->mp_id; ?>"><?php echo $row->mst_name; ?></option>
         <?php } ?>
        </select>
		</div>
	</div>
...
<div class="form-group">
		...
		<div class="col-sm-9">
		<input type="date" name="expiry_date" id="expiry_date" class="col-xs-10 col-sm-5" />
        </div>
</div>
