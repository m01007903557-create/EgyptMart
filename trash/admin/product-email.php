...
//Send Email To All Sellers according to location and product	 
	    ...
	    $subj="Latest Product Alerts On ".getWebSiteName();
	...
	if($flag!=0)
	{
	  ...
	  $row_pc=mysql_fetch_array($res_pc);
	    ...
	    $comment="<div style='width: 90%;height: auto;border: 9px solid #92AED2;float: left;padding: 10px;margin-top:10px;'>";
		...
		$comment.="<div style='width:100%;float:left;color:#000000;'><p style='font-size:16px;color:#000000'><strong>Dear ".$row_mpc['name_prefix']." ".$row_mpc['fname']." ".$row_mpc['lname']."</strong>,<br><br>Latest Products relevant to your subscribed categories on ARABYOS are listed below:</p></div>";
		$comment.="<div style='height:150px;width:100%;float:left;margin-top:10px;'>";
		$comment.="<div style='height:150px;width:50%;float:left;'><div style='width:34%;height:100%;float:left;padding-top:9px;'>";
		if($row_mpc['pd_image']=="")
		{
		...
		$comment.="</div><div style='width:64%;height:100%;float:right;'><div style='height:32%;width:100%;float:left;font-size:18px;font-weight:bold;color:#466da0;padding-left:0px;'>".$row_mpc['pd_title']."</div><div style='height:24%;width:100%;float:left;font-size:14px;line-height: 14px;text-align:left;padding-left: 0px;padding-top: 10px;color:#000000;'><div style='padding-left:0px;width:31%; float:left;'>MOQ<span style='text-align:right; float:right;'>:</span></div><div style='color:#e9582c; line-height:15px;font-size:15px;font-weight:bold;padding-left:5px;width:24%; float:left;'>".$row_mpc['pd_min_order_qty']."</div><div style='color:#000;padding-left:5px;width:40%; float:left;'>".measurement_unit($row_mpc['pd_unit'])."</div></div><div style='height:24%;width:100%;float:left;font-size:14px;line-height: 14px;text-align:left;padding-left:0px;padding-top: 10px;color:#000000;'><div style='padding-left:0px;width:31%; float:left;'>FOB Price<span style='text-align:right; float:right;'>:</span></div><div style='color:#e9582c;font-weight:bold;padding-left:5px;width:24%; float:left;font-size:15px;line-height:15px;'>".$row_mpc['pd_fob_price']."</div><div style='color:#000;padding-left:5px;width:40%; float:left;'>".$row_mpc['cn_currency']."</div></div><div style='height:16%;width:97%;float:left;font-size:12px;font-weight:bold;text-align:right;padding-top:15px;padding-right:0px;'><a href='http://arabyos.com/mail-login.php?page=product&u=".$row_mpc['usr_id']."&token=".rand(1000,9999).md5($row_mpc['pd_id'])."&c=".rand(1000,9999).md5($row_mpc->bnsprof_id)."' style='text-decoration:none;color:#466da0;padding-right: 2px;'>Learn More >> </a></div></div></div>";
		$comment.="</div>";
