...
class productlist{
	...
	function deleterecord($adid){
		...
		mysqli_query($con, "delete from product_category_arabyos where pc_parent_id='".$adid."'");
	}
...
$al->setsql("select * from product_category_arabyos where pc_parent_id = '0' order by pc_id asc");
