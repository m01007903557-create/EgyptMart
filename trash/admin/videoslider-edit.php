...
class editAdvertisement{
	...
	function detailsObj(){
		global $con;
		$sql="select * from video_slider where adv_id=".$this->adv_id;
...
//				$pathS="../upload/logo/small/".$rowImg->ht_logo;	
				...
				$imgSImage->save("../upload/video_slider/".$this->adv_img);											
				
//				$ds = move_uploaded_file($_FILES["adv_img"]["tmp_name"], "../upload/video_slider/".$this->adv_img) or die('error');
				
				/*if($ds)
				{*/	
										
					$sql="update video_slider
							set
								...
								adv_redirect ='".$this->adv_redirect."'
...
if(isset($_POST['btnUpdate'])){
	...
	$ob->adv_redirect=addslashes(trim($_POST['adv_redirect']));
	...
	header("location:videoslider-edit.php?aid=".$ob->adv_id);
}
?>
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onSubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="adv_redirect" id="adv_redirect" class="col-xs-10 col-sm-5" type="text" style="width:440px;" value="<?php echo $row->adv_redirect; ?>" />
		</div>
	</div>
        <div class="form-group">
