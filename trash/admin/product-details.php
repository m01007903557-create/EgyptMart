...
$sql="select * from products,product_category_arabyos where pd_subcat_id=pc_id and md5(pd_id) = '".$id."'";
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
            ...
            <font color="#FF9900" weight='800'>Pending</font>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   <?php 
			  $pymnt = explode(',',$row->pd_payment);
			  foreach($pymnt as $val)
			  {
				 echo get_gateway_name($val)."<br/>" ;
			  }
		  ?>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   <a href="user-details.php?token=<?php echo rand(1000,9999).md5($row->pd_uid);?>"><?php echo getCompanyName($row->pd_uid); //ucfirst(user_info($row->pd_uid,'fname')." ".user_info($row->pd_uid,'lname')); ?></a>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_code; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pc_name; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_title; ?></label>
		</div>
	</div>
   ...
   <div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo get_product_detail($row->pd_id,'pd_currency')." ".$row->pd_fob_price; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
            ...
            <?php
				...
				else if($row->pd_preferred_buyer_location=='any'){		echo "Anywhere";	}
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_min_order_qty." ".get_measurement_unit($row->pd_unit); ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_pod; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_pn_capct; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_dlv_time; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->pd_pck_dets; ?></label>
		</div>
	</div>
	 <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Product Type:</label>
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php if($row->pd_hot==1){ echo "Hot Product";}else{ echo 'Default Product'; }; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<img src="../upload/myproduct/<?php echo $row->pd_image; ?>" width="200px" height="232px"/>
		</div>
	</div>
	<?php } ?>
