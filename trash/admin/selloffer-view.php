...
/********************approve record*********************/
	if(isset($_GET['action']) && $_GET['action']=="appr"){
		...
		if($sproduct->so_pic!=''){
			$product_img='<img src="http://arabyos.com/upload/sale_offer/'. $sproduct->so_pic.'" width="100" />';
		}
		else{
			$product_img='<img src="http://arabyos.com/upload/sale_offer/no-image.png"  width="100" />';
		}
		...
		/*Put Your Email Adress Here*/
			$subject = "Sell Offer Promotion Approval From ".get_page_settings(4);
