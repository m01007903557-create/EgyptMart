...
class editProduct{
	...
	function detailsObj(){
		global $con;
		$sql="select * from products,product_category_arabyos where pd_subcat_id=pc_id and pd_id='".$this->pd_id."'";
...
if(isset($_POST['btnUpdate']))
{
	...
	$ob->pd_fob_price2=addslashes(trim($_POST['pd_fob_price2']));
	...
	$ob->pd_hot=addslashes(trim($_POST['pd_hot']));
	...
	$pid = $_GET['fid'];
		...
		/*Put Your Email Adress Here*/
			$subject = "Your Product Has Been Updated From ".get_page_settings(4);
			$from_name = get_page_settings(4);
			$from_email = get_adminemail();
			$message = $suname."<br /><br />"."Your Product "<b>".$spname."</b>" Has Been Updated By ARABYOS.com Admin";
...
function myvalid()
{
	...
	else if(pd_fob_price2.value=='' || pd_fob_price2.value=='0.00')
	{
		message="Please enter Product Price.";
		pd_fob_price2.focus();
		valid=false;
	}
	else if(pd_fob_price2.value!='' && isNaN(pd_fob_price2.value))
	{
		message="Product price must be numberic.";
		pd_fob_price2.focus();
		valid=false;
	}
	else if(pd_fob_price2.value!='' && pd_currency.value=='')
	{
		message="Please select Currency.";
		pd_currency.focus();
		valid=false;
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onSubmit="return myvalid();">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
        <?php
		$sql_cat="select * from product_category_arabyos where pc_parent_id!='0' and pc_parent_id='".$mcat_row->pc_id."'";
		?>
    ...
    <div class="form-group">
        ...
        <?php
			$sql_scat="select * from product_category_arabyos where pc_parent_id!='0' and pc_parent_id='".$row->pc_parent_id."'";
   ...
   <div class="form-group">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Price From:</label>
		<div class="col-sm-9">
   		   	<input name="pd_fob_price" id="pd_fob_price" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->pd_fob_price; ?>" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Price To:</label>
		<div class="col-sm-9">
   		   	<input name="pd_fob_price2" id="pd_fob_price2" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->pd_fob_price2; ?>" />
		</div>
	</div>
    <div class="form-group">
...
<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Product Status:</label>
        <div class="radio col-sm-8">
			<label><input type="radio" id="" name="pd_hot" class="ace" value="1" <?php if($row->pd_hot=='1'){ ?> checked="checked"<?php } ?>/><span class="lbl"> Mark as HOT</span></label>
			&nbsp;&nbsp;
            <label><input type="radio" id="" name="pd_hot" class="ace" value="0" <?php if($row->pd_hot=='0'){ ?> checked="checked"<?php } ?>/><span class="lbl"> Default</span></label>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Current Product Image:</label>
		<div class="col-sm-9">
