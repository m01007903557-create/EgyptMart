...
$al->setsql("select s.pc_id, s.pc_name, s.pc_sort_name, c.pc_name, m.pc_name from product_category_arabyos s, product_category_arabyos c, product_category_arabyos m where s.pc_parent_id=c.pc_id and c.pc_parent_id=m.pc_id and m.pc_parent_id='0' and m.pc_status='1' and c.pc_status='1' and s.pc_status='1' order by s.pc_id desc");
