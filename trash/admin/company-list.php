...
<p style="display: inline-block;float: right;">Go to Page No : <input type="number" name="page_no" id="page_no" class="page_no" min="1" /></p>
 ...
 <p style="display: inline-block;float: left;">
      <input type="text" id="mySearchText" placeholder="Search..." onkeypress="if (event.keyCode === 13) {  event.preventDefault();    return false;  }">
      <button class="btn btn-xs" id="mySearchButton">Search</button>
    </p>
</div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
		...
		<script type="text/javascript">
			jQuery(function($) {
				var oTable1 = $('#sample-table-2').on( 'search.dt', function () { event.preventDefault(); console.log( 'Search' ); return false;} ).dataTable( {
				"ajax":{
