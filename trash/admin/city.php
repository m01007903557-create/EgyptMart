...
var conf = confirm("Are your sure you want to delete this City?");
if(conf == true)
{		
...
function addCity(){
var city_add=$('input#city_add').val();
var state_inp=$('#city_state').val();
var cun=$('select#cun').val();

if($.trim($('input#city_add').val())=="")
{
	alert("Please enter City");	
}
else if($.trim($('#city_state').val())=="")
{
...
{
$.get("city_add.php", {
city_add:city_add,cun:cun,state_inp:state_inp},
...
var city_inp = $('input#city_'+hid).val();
var state_inp = $('#state_'+hid).val();
var metro_inp = $('#metro_'+hid).val();

if($.trim($('input#city_'+hid).val())=="")
{
alert("Please enter City");		
}
else if($.trim($('#state_'+hid).val())=="")
{
alert("Please select state");	
}
else
{
$.get("city_edit.php", {
hid:hid,city_inp:city_inp,state_inp:state_inp,metro_inp:metro_inp},
 function(data){
//alert(data);
...
$res_cn=mysqli_query($con, $sql_cn);	
?>
<select name="cun" id="cun" class="chosen-select" onchange="ShowCity(this.value)">
<option value="0">Select Country</option>
<?php  while($rec_cn=mysqli_fetch_object($res_cn)) {  ?>
<option value="<?php echo $rec_cn->cn_id; ?>" <?php if($cun==$rec_cn->cn_id) { ?> selected="selected" <?php } ?>><?php echo $rec_cn->cn_name; ?></option>
<?php  }  ?>
</select>
</TD></TR></table>
