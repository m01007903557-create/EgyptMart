...
class addAdvertisement{
	...
	function __construct($imgsize, $adv_img, $adv_link,$adv_position)
	{		
...
{ 	
	...
	$adn=new addAdvertisement(addslashes(trim($_POST['imgsize'])), trim($_FILES['adv_img']['name']), addslashes(trim($_POST['adv_link'])),$_POST['adv_position']);
	if($adn->valid())
	{	
		$adn->add();		
	}
