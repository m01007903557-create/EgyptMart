...
if(isset($_POST['btnUpdate'])){
	...
	$ob->mp_credits=addslashes(trim($_POST['mp_credits']));
	$ob->mp_amount=addslashes(trim($_POST['mp_amount']));	
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onSubmit="return myvalid();">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_name" id="mp_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->mp_name; ?>" />
            <input type="hidden" name="mp_id" id="mp_id" value="<?php echo $row->mp_id; ?>" />
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_credits" id="mp_credits" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->mp_credits; ?>" />
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mp_amount" id="mp_amount" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->mp_amount; ?>" />
		</div>
	</div>
