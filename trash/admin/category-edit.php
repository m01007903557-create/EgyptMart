...
class editproduct{	
	...
	function detailsObj(){
		global $con;
		$sql="select * from product_category_arabyos where md5(pc_id)='".$this->scat_id."'";
	...
	function valid()
	{
		...
		{
			$this->msg= '<div class="alert alert-danger"><i class="icon-remove"></i> Please enter Category sort name within 24 character.</div>';
			$valid=false;
		}
		return $valid;
	}
...
if(isset($_POST['btnUpdate'])){
	...
	$ob->scat_cat_id=trim(addslashes($_POST['scat_cat_id']));
...
//alert(scat_sort_name.value.length);
	...
	{
		message='Please enter Category Sort name with in 24 character';
		scat_sort_name.focus();
		valid=false;
	}
	if(!valid)
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select name="scat_cat_id" id="scat_cat_id" class="chosen-select">
                ...
                ?>
               <option value="<?php echo $catrow->pc_id;?>" <?php if($catrow->pc_id == $row->pc_parent_id){?> selected="selected"<?php }?>><?php echo $catrow->pc_name;?></option>
               <?php }?>
           </select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="scat_name" id="scat_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->pc_name; ?>" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="scat_sort_name" id="scat_sort_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->pc_sort_name; ?>" />
		</div>
	</div>
