...
check_user_login();
	...
	function __construct($scat_cat_id,$scat_name,$scat_sort_name)
	{
          $this->scat_cat_id=$scat_cat_id;
...
if(isset($_SESSION['scat_cat_id'])){ $scat_cat_id=$_SESSION['scat_cat_id']; unset($_SESSION['scat_cat_id']); } else { $scat_cat_id=""; }
...
if(isset($_POST['btnAdd']))
{
	...
	$adn=new addproduct(addslashes(trim($_POST['scat_cat_id'])), addslashes(trim($_POST['scat_name'])), addslashes(trim($_POST['scat_sort_name'])));
	
	$_SESSION['scat_cat_id']=addslashes(trim($_POST['scat_cat_id']));
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<select name="scat_cat_id" id="scat_cat_id" class="chosen-select">
                <option value="">Select</option>
                <?php 
                $catsql = mysqli_query($con, "select * from product_category_arabyos where pc_parent_id = '0' and pc_status = '1'");
