...
class addSubCategory{
	...
	{		
	  global $con;
		$sql="insert into product_category_arabyos
			set
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<select name="cat_id" id="cat_id" >
                ...
                <?php 
                $catsql = mysqli_query($con, "select * from product_category_arabyos where pc_parent_id != '0' and pc_parent_id='".$mcat_id."' and pc_status = '1'");
