...
if(isset($_SESSION['ga_content'])){	$ga_content=$_SESSION['ga_content'];	unset($_SESSION['ga_content']);	}else{	$ga_content="";	}
...
class addPlan{
	...
	function __construct($ga_content)
	{
...
if(isset($_POST['btnAdd']))
{
	...
	$adn=new addPlan( addslashes(trim($_POST['ga_content'])));
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
    ...
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Adsense Content <span style="color:#CC0000">*</span></label>
		<div class="col-sm-8">
			<textarea name="ga_content" id="ga_content" class="autosize-transition form-control"><?php echo $ga_content; ?></textarea>
		</div>
	</div>
