...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		...
		<li <?php if($file=="measurements" || $file=="business_type" || $file == "ownership_type" || $file == "revenue_turnover" || $tile == "employee_range" || $file == "profile_heading"){ ?> class="active open" <?php } ?>>
			<a href="#" class="dropdown-toggle">
				<i class="icon-book"></i>
