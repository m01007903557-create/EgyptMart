...
//Send Email To All Sellers according to location and product	 
	    ...
	    $subj=" آخر إشعار - عرض بيع - طبقا لإهتمامك  ".getWebSiteName();
	...
	if($flag!=0)
	{
	   ...
	   $sql_pc="select m.pc_name,c.pc_name,s.pc_name,m.pc_id,c.pc_id,s.pc_id from product_category_arabyos m,product_category_arabyos c,product_category_arabyos s where m.pc_id=c.pc_parent_id and c.pc_id=s.pc_parent_id and s.pc_id='".$row_mpc['sac_pc_id']."'";
	  ...
	  $row_pc=mysql_fetch_array($res_pc);
        ...
        $comment.="</div><div style='height:100px;width:43%;float:left;'><h2 style='font-size: 20px; color:#466da0; text-align:center; margin-top:0px; margin-bottom:0px;'>Today's Latest<br> Products & Suppliers</h2></div>";
       $comment.="<div style='min-height: 100px; width: 27%; float: right; padding-top: 3px;'><span style='font-size: 15px; float: right; padding-bottom: 0px; clear: both; font-weight: bold;color:#000000;'> Notification</span><span style='float: right; font-size: 13px; padding-top: 0px; clear: both;color:#000000;'>".date('M d, Y')."</span></div></div>";
		$comment.="<div style='width:100%;float:left;color:#000000;'><p style='font-size:16px;color:#000000'><strong>Dear ".$row_mpc['name_prefix']." ".$row_mpc['fname']." ".$row_mpc['lname']."</strong>,<br><br>Latest Products relevant to your products of interest on ARABYOS are listed below:</p></div>";
		...
		{
		$comment.="<img src='http://arabyos.com/upload/myproduct/thumb/".$row_mpc['pd_image']."' style='height:116px;width:100%;'>";
		}
		$comment.="</div>";
		$comment.="<div style='width:66%'>
		<div style='width:100%'><h3 style='font-size:18px;'>".$row_mpc['pd_title']."</h3></div>
		...
		$comment.="<div style='width:100%;font-size:12px;font-weight:bold;text-align:center;padding-top:15px;'>
					<a href='http://arabyos.com/company/product-details.php?token=".rand(1000,9999).md5($row_mpc['pd_id'])."&c=".rand(1000,9999).md5($_GET['buss_id'])."' style='text-decoration:none;color:#466da0;padding-right: 2px;'>Learn More >> </a>
				 </div>";
	...
	/* inbox */
       ...
       $inbox.="<div style='min-height: 100px; width: 27%; float: right; padding-top: 3px;'><span style='font-size: 15px; float: right; padding-bottom: 0px; clear: both; font-weight: bold;color:#000000;'> Notification</span><span style='float: right; font-size: 13px; padding-top: 0px; clear: both;color:#000000;'>".date('M d, Y')."</span></div></div>";
		$inbox.="<div style='width:100%;float:left;color:#000000;'><p style='font-size:16px;color:#000000'><strong>Dear ".$row_mpc['name_prefix']." ".$row_mpc['fname']." ".$row_mpc['lname']."</strong>,<br><br>Latest Products relevant to your products of interest on ARABYOS are listed below:</p></div>";
		...
		{
		$inbox.="<img src='http://arabyos.com/upload/myproduct/thumb/".$row_mpc['pd_image']."' style='height:116px;width:100%;'>";
		}
		$inbox.="</div>";
		$inbox.="<div style='width:66%'><div style='width:100%'><h3 style='font-size:18px;'>".$row_mpc['pd_title']."</h3></div><div style='width:100%;margin-top:10px'> <div style='display:inline-block;padding-left:0px;'>MOQ<span style='padding-left:20px;'>:</span></div><div style='color:#e9582c;display:inline-block'>".$row_mpc['pd_min_order_qty']."</div><div style='color:#000;display:inline-block'>".measurement_unit($row_mpc['pd_unit'])."</div></div><div style='width:100%;margin-top:10px'><div style='padding-left:0px;display:inline-block;'>FOB Price<span style='padding-left:20px;'>:</span></div><div style='color:#e9582c;font-weight:bold;font-size:15px;line-height:15px;display:inline-block;'>".$row_mpc['pd_fob_price']."</div><div style='color:#000;padding-left:5px;display:inline-block;'>".$row_mpc['cn_currency']."</div></div></div></div>";
		$inbox.="<div style='width:100%;font-size:12px;font-weight:bold;text-align:center;padding-top:15px;'><a href='http://arabyos.com/company/product-details.php?token=".rand(1000,9999).md5($row_mpc['pd_id'])."&c=".rand(1000,9999).md5($_GET['buss_id'])."' style='text-decoration:none;color:#466da0;padding-right: 2px;'>Learn More >> </a></div>";
