                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 box-3">
                                <div class="ar-box-1 ar-box padding-5 margin-bottom-5 bg-gray" style="overflow-x: hidden;">
                                    <header class="sub-box"> <?php if ($fevrow_icon) { ?> <a href="https://www.arabyos.com/membership_plans.php"><img src="https://www.arabyos.com/admin/images/<?php echo $fevrow_icon['producticon']; ?>" title="<?php echo $fevrow_icon['pplan']; ?>" width="25px" height="25px"/></a> <?php } ?><b class="txt-dark-gray"> 
                            ...
                            <div class="row">
                                <div class="col-lg-3 big-img-box box-1" id="div-<?php echo $row['pd_id']; ?>">
                                    <header>
                                        ...
                                        <?php } ?>
                                        <a href="javascript:void(0)" class="ar-star product_compare" data-prod_img="<?php echo 'https://www.arabyos.com/upload/myproduct/' . $row['pd_image']; ?>" onClick="return addcompare(<?php echo $row['pd_id']; ?>)" data-prod_id="<?php echo $row['pd_id']; ?>" title="<?php echo $row['pd_title']; ?>" ><i class="fa fa-plus star" ></i> Add Compare</a> </header>
                                    <figure class="box" >
                                        <?php if ($fevrow_icon) { ?>
                                            <div class="ribbon">  <img src="./admin/images/<?php echo $fevrow_icon['sponsericon']; ?>"/> </div>
                                        <?php } ?>
                            <!--<img src="images/3.png"  class="zoomthis" alt="Rice"/>-->
                                ...
                                <div class="col-lg-5 box-2">
                                    <ul>
                                        ...
                                        <?php if (($_SESSION['uid_indm'] ) == '') { ?>
                                            <a data-price="" href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/arabyos.com/sign-in.php">(Get Letest Price)</a> 
                                            <?php
                                        } else {
                                ...
                                <div class="col-lg-4 box-3">
                                    <div class="ar-box-1 ar-box padding-5 margin-bottom-5 bg-gray" style="overflow-x: hidden;">
                                        <header class="sub-box"><?php if ($fevrow_icon) { ?><a href="https://www.arabyos.com/membership_plans.php"><img src="./admin/images/<?php echo $fevrow_icon['producticon']; ?>" width="25px" height="25px" title="<?php echo $fevrow_icon['pplan']; ?>"/></a> <?php } ?><b class="txt-dark-gray"> 
