...
$query = "SELECT * FROM tender_alert_category WHERE tac_pc_id=".$_POST['sub_cat_id']." AND tac_usr_id=".$_SESSION['uid_indm'];	
			$r=mysql_query($query);	
			if(mysql_num_rows($r) == 0){
$SQL_BUY_ALERT="insert into tender_alert_category SET 
                                          tac_usr_id=".$uid.",
										  tac_pc_id=".$_POST['sub_cat_id'].",
										  tac_updated_date=now()";
										  $r=mysql_query($SQL_BUY_ALERT);
			}
}
else if(isset($_GET['sub_cat_id']) && $_GET['sub_cat_id']!=''){
	$query = "SELECT * FROM tender_alert_category WHERE tac_pc_id=".$_GET['sub_cat_id']." AND tac_usr_id=".$_SESSION['uid_indm'];	
			$r=mysql_query($query);	
			if(mysql_num_rows($r) == 0){
$SQL_BUY_ALERT="insert into tender_alert_category SET 
                                          tac_usr_id=".$uid.",
										  tac_pc_id=".$_GET['sub_cat_id'].",
										  tac_updated_date=now()";
										  $r=mysql_query($SQL_BUY_ALERT);
			}
}
	...
	if(isset($_GET['keywords']) && $_GET['rctyp'] == 'tender'){
...
?>
                    ...
                    <?php include "includes/header_menu.php"; ?>
                        ...
                        <div class="f1 w61n tb lh ml br" id="lnav">
                            <ul id="ulid" class="nln1" style="margin: 0px; padding: 0px;">
                                <li>
                                    <h3 style="font-size: 16px;font-weight: bold; color:#000; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;">Tenders </h3></li>
                                <li style="border-bottom:none">
                                    <h3>Tender Purchases</h3></li>
                                <li class="np npnew"><a href="manage-purchased-tenders.php">»&nbsp;Purchased Tenders</a></li>
                                <li class="np npnew"><a class="leftindi txtcol" href="manage-purchased-tenders.php">»&nbsp;Tender Alerts</a></li>
                                <li class="np npnew"><a href="my-tender-locationpref.php">»&nbsp;Location Preference</a></li>
                                <li class="np npnew"><a href="transaction_history.php">»&nbsp;Transaction History</a></li>
                                <li style="border-bottom: medium none;">
                                    <h3>Help / FAQs?</h3></li>
                                <li class="np npnew"><a href="help.php">»&nbsp;Tenders Help / FAQs?</a></li>
                                <?php if(isset($_REQUEST['sub_cat_id']) && $_REQUEST['sub_cat_id']!=''){ ?>
                                    <li class="np npnew"><a href="manage-auction-alert.php?sub_cat_id=<?php echo $_REQUEST['sub_cat_id']; ?>">»&nbsp;Manage Auction Alerts</a></li>
                                    <?php } else { ?>
	...
	if(mysql_num_rows($res_adv)>0)
	{
		...
		?><a href="//<?php echo $row_adv->adv_link; ?>" target="_blank"><img src="upload/advertisement/<?php echo $row_adv->adv_img; ?>" width="200" height="154"/></a>
                                                    <?php
	}
	else
	{
                                                            ...
                                                            <td align="CENTER">
                                                                ...
                                                                <div class="bg_border_new" style="height:675px" id="dvh1">
                                                                    <div style="background-color:#FFFFFF; height:670px" id="dvh2">
                                                                        ...
                                                                        </table><img src="images/zero.gif" height="10" width="1">
                                                                        <br> </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="border-right:0px; padding-right:10px" valign="top" width="100%">
                                                                <table style="table-layout:fixed;width:100%" align="CENTER" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="LEFT" height="38" valign="TOP" width="325"><img src="images/zero.gif" height="4" width="1">
                                                                                <br>
                                                                                <nobr>
                                                                                    <div class="mf18 mc5 mta2 mpr8 mpt10">
                                                                                        <!-- <DIV class="mf11 bc mbn">Alerts &amp; Newsletters &#187</DIV> -->Manage Tender Preference </div>
                                                                                </nobr>
                                                                            </td>
                                                                            <td valign="bottom">
                                                                            </td>
                                                                            ...
                                                                            <td valign="bottom">
                                                                                <div class="manage_country mb" style="text-align:left;"><a href="browse-cat-for-tender-alert.php" class="ajax">Add More Categories</a></div>
                                                                            </td>
                                                                            <td valign="bottom">
                                                                                <div class="manage_country mb"><a href="my-tender-locationpref.php">Manage Your Location Preferences</a></div>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                ...
                                                                <?php
				$sql="select * from product_category_arabyos,tender_alert_category where pc_id=tac_pc_id and tac_usr_id='".$_SESSION['uid_indm']."'";
				$res=mysql_query($sql);
				$count=mysql_num_rows($res);
				?>
                                                                    <div style="font-family:arial;font-size:12px;margin-top: 9px;color:#000000;padding-left: 5px;">
                                                                        <div style="width: 218px;float: left;">No. of Categories Subscribed</div> :
                                                                        <?php echo $count; ?>
                                                                            <br>
                                                                    ...
                                                                    <table style="table-layout:fixed;width:100%" class="mgoffer" align="CENTER" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="2" align="LEFT"><b style="font-size:14px;">Your Existing Tender Subscription:</b></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <table class="select_sp" style="border-top:1px solid #C8DDEC" align="CENTER" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td class="tdoffer" align="CENTER" bgcolor="#F1F9FE"><img src="images/zero.gif" height="1" width="85">
                                                                                    <br>Remove</td>
                                                                            </tr>
                                                                            <?php
		...
		?>
                                                                                <tr id="map1">
                                                                                    ...
                                                                                    <td style="cursor:pointer;" align="CENTER">
                                                                                        <a onclick="delAlertCat(<?php echo $row->tac_id; ?>)" style="cursor:pointer;"><img src="images/del_img.gif" hspace="6"></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <?php 	}
			}else{	?>
                                                                                    <tr>
                                                                                        <td colspan="5" height="60">
                                                                                            <div style="font-family:arial; font-size:16px; color:#FF0000;" align="center"><b>You do not have any Tender Alerts</b></div>
                                                                                            <div style="font-family:arial; font-size:16px; color:#FF0000;" align="center"><a href="browse-cat-for-tender-alert.php" class="ajax">Click here to Add Tender Alerts </a></div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <?php } ?>

                                                                        </tbody>
                                                                    </table> <span id="subs_cats"></span> <span id="procssing"></span> </td>
                                                            <td><img src="images/zero.gif" height="2" width="2"></td>
                                                        </tr>
                                                        <input name="catid" id="catid" value="" type="hidden"> </tbody>
                                                </table>
                                            </form>
                                            <div>
                                                <br>
                ...
                <script type="text/javascript">
                    $(document).ready(function($113) {
                        lostFocus();
                        $113('#txt_cat_mcat').unbind().live('keyup', function() {
                            var type11 = 'Products';
                            $113("#txt_cat_mcat").autocomplete("autocomplete.php", {
                                    selectFirst: true,
                                    extraParams: {
                                        type: type11
                                    },
