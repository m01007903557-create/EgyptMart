                                ...
                                <link href="css/jf-1.css" type="text/css" rel="stylesheet">
                                    ...
                                    <script type="text/javascript">
                                        function additem2()
                                        {
                                            ...
                                            } else
                                            {
                                                ...
                                                $.post("ajax-file/productAdd.php", {pd_subcat_id: pd_subcat_id.value, pd_title: pd_title.value, pd_status: pd_status, pd_code: pd_code.value, pd_desc: pd_desc.value, uid: uid.value, pd_min_order_qty: pd_min_order_qty.value, pd_unit: pd_unit.value, pd_fob_price: pd_fob_price.value, pd_fob_price2: pd_fob_price2.value, pd_currency: pd_currency.value, pd_preferred_buyer_location: pd_preferred_buyer_location}, function (data) {
                                    ...
                                    <body class="add-product">
                                        ...
                                        <div class="hm1 bbc" id="res-mob1">
                                            ...
                                            <div class="w56b f1 p2b p14 blr"><div class="mt5"><h1 style="margin-top:-5px !important;padding-bottom:5px;">Post New Products</h1>
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            $("#click").click(function () {
                                                ...
                                                return false;
                                                                    ...
                                                                    <a class="ajax add_color_page_a" href="popup-imagegallery.php" style="text-decoration:none;" title="ADD Product Image from your products Gallery Images ">Select from <br/> Image Gallery</a>
                                                                </div>
                                        ...
                                        $(document).ready(function () {
                                            ...
                                            $("#click").click(function () {
                                                ...
                                                return false;
                                                                        ...
                                                                        <a class="ajaxa add_color_page_a" href="popup-imagegallery-logo.php" style="text-decoration:none;" title="ADD small image for .. Logo,Brand,Discount,Sign etc ">Select from <br/> Image Gallery</a>
...
<!--                                                                            <p><span style="line-height: 12px;">*</span> FOB Price</p>
                     <div class="from-f1-fs1"><span>From :</span> <input name="pd_fob_price" id="pd_fob_price" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price; ?>"></div>-->
                                                                            ...
                                                                            <div class="fs2 f1"  style="width: 33.3% !important;">
                                                                                <p>&nbsp;</p>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <input class="rad" name="pd_hot" value="1"  type="radio" >
                                                                                    ...
                                                                                    <input name="pd_hot" value="0" id="pd_hot"  type="radio" checked="checked">
                                                                                        ...
                                                                                        <div id="div_save">
                                                                                            <input name="btnSubmit" id="btnSubmit" class="c3 f2 saps mt12 mtt" style="margin-top:-35px;margin-right:-1px; -webkit-margin-before:-33px;*margin-top:-35px;margin-top:-33px\9;color:#fff;" value="Add Product" type="button" onclick="additem2();" />
                                                                                        </div>
