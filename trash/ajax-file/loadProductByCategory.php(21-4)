...
?>
<!--1px solid #484891;-->
<div class="col-md-9 col-sm-9 col-xs-12" id="final_result">
...
<div class="als-container" id="product_slider" style="border-radius:5px;">
  ...
  <div class="als-viewport" align="center">
   ...
   if(mysql_num_rows($recObj)>0)
    ...
    ?>
      <li class="als-item" style="border:1px solid #ccc;margin-top:1%;margin-left:1%;margin-bottom:1%;border-radius:4px; float:left; height:175px; background-color:rgba(251, 251, 251, 0.96);">
      <?php
   ...
   if(isset($_COOKIE['loc_id']))
	...
	?>
      ...
      <div style="height:0%;margin-top:3%;padding-top:5%;"><span style="color:blue;"><b><?php echo 
	  ucwords($newtext); ?>....</span></b><br />
      <span style="color:red;"><?php echo $cn_name; ?></span></div>
      <hr />
      <hr />
<div style="height:10%;margin-top:18%; font-size:11px;">MOQ : <span style="color:red; font-weight: 600; font-size:15px;"><?php echo $row_prd->pd_min_order_qty; ?>&nbsp;</span><?php echo $row_prd->mu_name; ?></div>
...
<div><?php echo $row_prd->mst_name; ?> </div>
	  </a>
      </li>
...
<div style="border:1px solid #F5ECFF;border-radius:5px;padding-left:10px;padding-right:10px;">
	<div style="border-bottom:1px solid #999;margin-bottom:2px;"><h3>Sub Category</h3></div>
    <?php
