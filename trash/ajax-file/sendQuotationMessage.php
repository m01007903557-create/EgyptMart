...
$product.='<div style="width:35%; overflow: hidden; float:left; margin-bottom: 20px;">
                <div style="width: 50%; float: left; overflow: hidden;">
                    <img height="100" width="150"src="https://'.$_SERVER['HTTP_HOST'].'/upload/myproduct/'.rawurlencode($msg_img).'">
                </div>
						...
						<div style="width: 90%;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
							<div style="height: 100px; width: 100%; float: left; ">
							    <div style="height: 100px; width: 30%; float: left;">
							        <img src="https://www.arabyos.com/images/Mlogo.png" style="width: 100%;color: #00F;font-size: 22px;font-weight: bold;" alt="EgyptMART">
							    </div>
							...
							<br>
							<div style="clear:both">
                                                            <p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">Kindly Reply Your Buyer Enquiry:<a href="https://arabyos.com/my-enquiries.php" style="margin-left: 50px;">Reply NOW</a></p>
                                                        </div>
                                                        <br>
...
if(mysql_query($sql))
{
	...
	mysql_query($sql_ma);
	    ...
	    $headers  = "MIME-Version: 1.0\n";
			...
			//mail("chandola.neeraj@gmail.com",$subj,$comment,$headers);
