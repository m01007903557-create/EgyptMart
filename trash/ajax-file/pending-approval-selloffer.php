...
$sql_pending="select * from sale_offer where so_usr_id='".$_SESSION['uid_indm']."' and so_approval_status='0' and so_status='1' order by so_updated_date desc LIMIT ".$start.", ".$per_page;

$recObj=mysqli_query($con, $sql_pending) or die('MySql Error' . mysql_error());

/* -----Total count--- */
$query_pag_num = "SELECT count(*) AS count from sale_offer where so_usr_id='".$_SESSION['uid_indm']."' and so_approval_status='0' and so_status='1'"; // Total records
...
<div id="pending_approval">
			...
			// FOR ENABLING THE FIRST BUTTON
				if ($first_btn && $cur_page > 1) {	?>
					<a href="javascript:showPending('1')"><img id="firstmail" src="images/firsten.gif"></a>
			...
			?>&nbsp;<?php
             ...
             // FOR ENABLING THE PREVIOUS BUTTON
	            if ($previous_btn && $cur_page > 1){
                 $pre = $cur_page - 1;
            ?><a href="javascript:showPending('<?php echo $pre; ?>')"><img id="prevmail" src="images/prven.gif"></a><?php	
			...
			// TO ENABLE THE NEXT BUTTON
                if($next_btn && $cur_page < $no_of_paginations){
  	                $nex = $cur_page + 1;
   	        ?><a href="javascript:showPending('<?php echo $nex; ?>')"><img id="nextmail" src="images/nxten.gif"></a><?php
                }else if ($next_btn){
			...
			?><a href="javascript:showPending('<?php echo $no_of_paginations; ?>')"><img id="lastmail" src="images/lastenv.gif"></a>
            ...
            <tr><td align="CENTER" valign="top" width="122">
                ...
                <img src="upload/sale_offer/<?php echo $row_so->so_pic; ?>" style="margin-right:5px;cursor:pointer;" border="0" height="auto" hspace="0" vspace="0" width="100">
				...
				<img src="images/sell1-img.gif" alt="Your Sell Requirement" align="ABSMIDDLE" height="17" hspace="5" vspace="2" width="38"><br><?php echo $row_so->so_description; ?><br>
                <a onclick="viewSODetails(<?php echo $row_so->so_id; ?>)" style="cursor:pointer;">View complete details</a><br></div></td>
			...
			{
			?>
            <tr><td colspan="4" align="center" style="vertical-align:middle;color:#F00;padding-top:10px; padding-bottom:10px;">No pending Sale Offer</td></tr>
            <?php	}	?>
			</tbody></table>
