...
//unset($_COOKIE['loc_id']);
    ...
    */
    ...
    $sql_pcat="select m.pc_id,m.pc_name,c.pc_id,c.pc_sort_name from product_category m,product_category c where m.pc_id=c.pc_parent_id and c.pc_status='1' and m.pc_status='1' and md5(c.pc_id)='".$pc_id."'";
    ...
    $sql_check1="select pc_id from product_category where product_category.pc_status='1' and md5(pc_{$parent}id)='".$pc_id."'";
...
if (count($pc_id_arr) == 0) {
    ...
    $sql_dd_cmnuParent = "select	DISTINCT pc_parent_id	from product_category where product_category.pc_status='1' and pc_id in ('$SubCategoryArray') ";
    ...
    $sql_dd_cmnuMaster = "select	DISTINCT pc_parent_id	from product_category where product_category.pc_status='1' and pc_id in ('$ParentCategoryArray') ";
    ...
    $MasterCategoryArray = join("','", $pc_id_arrNewNew);
     ...
     $sql_dd_cmnuAgainMaster_total = "select	DISTINCT pc_id	from product_category where product_category.pc_status='1' and pc_id in ('$MasterCategoryArray') ";

    $sql_dd_cmnuAgainMaster = "select	DISTINCT pc_id	, pc_image ,	pc_name 	from product_category where product_category.pc_status='1' and pc_id in ('$MasterCategoryArray') order by pc_name asc /*limit $first ,14*/";
...

{
    ...
    <div class="col-md-3 col-sm-3 col-xs-12 col-lg-2 prc-left-side" >
        ...
        <h3 class="togle_style" style="font-size:19px;cursor: pointer;font-weight:700;
     margin-left: 10px;" onclick="toggle_menu();"><span class="fa fa-list"></span>&nbsp; MY MARKETS&nbsp;<i id="uparrow" class="fa fa-angle-up" style="font-size:18px;display:none;"></i><i id="downarrow" class="fa fa-angle-down" style="font-size:18px;"></i></h3>
...
//echo file_get_contents( 'https://arabyos.com/ajax_get_leftmenu_again.php');
 ...
 <div class="col-md-5" style="margin-top:8px">
			  ...
			  <form name="getcitydata" id="getcitydata" method="post" action="search.php?<?php if($_GET['rctyp']!=''){ echo "&rctyp=".$_GET['rctyp']; } ?><?php if($_GET['keywords']!=''){ echo "&keywords=".$_GET['keywords']; } ?>">
						  ...
						  <input type="search" class="" name="scity" style="padding-top: 9px;"  id="scity" value="<?php echo $_POST['scity']?$_POST['scity']:'';?>" placeholder="Search City" />
