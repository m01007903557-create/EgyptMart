...
//echo file_get_contents( 'https://arabyos.com/ajax_get_leftmenu_again.php');
 ...
 <div class="col-md-5" style="margin-top:8px">
                    ...
                    <label class="checkbox-inline" style="padding-left: 0px;padding-right: 15px;">Supplier Location:</label>
                    ...
                    <ul class="als-wrapper" style="width: 101.1%">
                        ...
                        if (mysql_num_rows($recObj) > 0) {
                            ...
                            while ($row_prd = mysql_fetch_object($recObj)) {
                                ...
                                <li class="als-item"
                                    style="border:1px solid #ccc;margin-top:1%;margin-left:0%;margin-right:1%;padding:4px !important;margin-bottom:1%;border-radius:4px; float:left; height:auto; background-color:rgba(251, 251, 251, 0.96);height: 350px;">
                                    ...
                                    <a href="company/products.php?c=<?php echo rand(1000, 9999) . md5($row_prd->bnsprof_id); ?>&sc=<?php echo rand(10000, 99999) . $row_prd->pd_subcat_id; ?>#<?php echo $row_prd->pd_id; ?>"
                                       style="text-decoration:none;color:#000" target="_blank">
                                        ...
                                        <div style="">
                     <div class="utext" style="color:#0600ff;font-size: 14px !important;padding: 0px 0px 0px 0px;text-align: center;height: auto;margin-bottom: 6px;"><b><?php echo substr($newtext,0,36); ?></div></b>
