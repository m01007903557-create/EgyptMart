...
<div id="imgrow<?php echo $cnt;?>" style="float:left;height:100px;width:107px;padding:1px;">
 <span  >
...
<img src="images/zero.gif" height="8" width="1"> </td></tr></tbody></table></div>
   ...
   <a class="ajax" href="popup-imagegallery-logo_edit.php" style="text-decoration:none;">Select from Image Gallery</a>
 ...
 function delproimg(imgname,id,cnt)
   {
	...
	/*if(jQuery.inArray(imgname,imgarray) != -1){
        ...
        return value != imgname;
          ...
          $.post("ajax-file/updateproductlogo.php", {id:id,imgname:imgname},
