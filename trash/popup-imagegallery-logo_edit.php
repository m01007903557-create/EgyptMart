...
<form style="margin:0px;" name="test" action="" onsubmit="return false"><div>
 ...
 <table align="left" border="0" cellpadding="0" cellspacing="0" style="100%"> 
 <tbody><tr> 
...
<a onclick="usePhotoToUploadlogo('<?php echo $row_ph->ph_id; ?>');" style="cursor:pointer;"><img src="upload/image_gallery/<?php echo $row_ph->ph_fileName; ?>" height="100" width="105px;" /><span class="tickmark">&#10004;</span></a>
</span>
<?php } ?>
</div>
 </span>
...
<img src="images/zero.gif" height="8" width="1"> </td></tr></tbody></table></div>
 ...
 <button class=" saps  mtt" onclick="usePhotoForLogo();">OK</button>
