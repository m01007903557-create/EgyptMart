...
//	$(".sent").removeClass("txtcol");
	$.post("ajax-file/showBlockList.php",{page:page},    function(data){	$('#res_list').html(data); });
}
...
<!-- Header End Here::-->
	...
	<?php include "includes/header_menu.php"; ?>
		...
		<ul id="ulid" class="nln1" style="margin: 0px; padding: 0px;">
			...
			<li class="np npnew"><a class="leftindi txtcol" href="my-blocklist.php">»&nbsp;Blocked User List</a></li>
