...
$sql_pg="select * from payment_gateway where md5(id)='".$pg."'";
...
<input type="hidden" name="return" value="http://www.arabyos.com/paymentgateway/paypal.php">
<input type="hidden" name="cancel_return" value="http://www.arabyos.com/">
<!--<input type="hidden" name="notify_url" value="http://www.www.arabyos.com/paymentgateway/paypal.php">-->
