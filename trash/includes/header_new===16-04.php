...
<link href="css/main-style.css?v3.17" rel="stylesheet" type="text/css"/>
...
//echo $ctype;
            ...
            $(document).ready(function() {
                                ...
                                if (lang == 'Arabic') {
                                $('i                                                    nput').css('direction', 'rtl');
                                $('text                                                    area').css('direction', 'rtl');
                                $('.page-header i                                                    nput').css('direction', 'ltr');
                                $('.page-header text                                area').css('di                                rection', 'ltr');
            }
            },5000);
            });
</script>
