...
<div class="n-nmz1_exm1 n-nmz2 bx pns14 ml2" id="chromemenu" style="width:100%">
	...
	<ul class="n-hdrn">
        ...
        <!--business offers for you--><div style="height: auto; overflow: hidden; display: none; visibility: visible; right: 0px; <?php if($file == 'post-buy-req'){?>top: 146px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu6" class="ddm" onMouseOver="downMenu(6);" onMouseOut="upMenu(6);">
        ...
        <!--company profile-->
        <div style=" position:absolute; height: auto; overflow: hidden; display: none; visibility: visible; left: 150px; <?php if($file == 'post-buy-req'){?>top: 253px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu1" class="ddm" onMouseOver="downMenu(1);" onMouseOut="upMenu(1);">
                <a href="my-contactdetails.php">Contact Details</a>
        ...
        <!--Enquiries & Contacts--><div style=" position:absolute; width: 190px; height: auto; overflow: hidden; display: none; visibility: visible; left: 300px; <?php if($file == 'post-buy-req'){?>top: 146px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu2" class="ddm" onMouseOver="downMenu(2);" onMouseOut="upMenu(2);">
        ...
        <!--buy leads-->
		<div style=" position:absolute; height: auto; overflow: hidden; display: none; visibility: visible; left: 480px; <?php if($file == 'post-buy-req'){?>top: 146px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu3" class="ddm" onMouseOver="downMenu(3);" onMouseOut="upMenu(3);">
        ...
        <!-- Seller Tools --><div style=" position:absolute; height: auto; overflow: hidden; display: none; visibility: visible; left: 590px; <?php if($file == 'post-buy-req'){?>top: 146px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu4" class="ddm" onMouseOver="downMenu(4);" onMouseOut="upMenu(4);">
        ...
        <!--Buyer Tools--><div style=" position:absolute; height: auto; overflow: hidden;  display: none; visibility: visible; left: 710px; <?php if($file == 'post-buy-req'){?>top: 146px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu5" class="ddm" onMouseOver="downMenu(5);" onMouseOut="upMenu(5);">
        ...
        <!--Tender--><div style=" position:absolute; height: auto; overflow: hidden;  display: none; visibility: visible; left: 825px; <?php if($file == 'post-buy-req'){?>top: 146px;<?php }else{?>top: 253px;<?php }?>" id="dropmenu7" class="ddm" onMouseOver="downMenu(7);" onMouseOut="upMenu(7);">
