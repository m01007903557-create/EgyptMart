...
<link href="css/main-style.css?v2.15" rel="stylesheet" type="text/css"/>
...
<div class="wrapper" id="buy_leads_page">
                ...
                <div class="page2-header2-col1-row2">
                    ...
                    <div class="page2-header2-col1-row2-col2">
                        <div class="toplinksbar">
                            <ul >
                                <li><a href="dir.php">Products & Suppliers</a></li>
                        ...
                        <script>
						   ...
						   $(".page-header-col1-row2-col2-form-select1 option[value='Products']").attr('selected','selected');
						    <!-- Gajendra Code start from here -->
							
						         var TabVal=$("#rctyp").val();								     
								   PlaceholdVAl='';
								   if( TabVal == 'Products' ){									   							
									PlaceholdVAl = "Source Product / Services to find suppliers";
                           ...
                           $("#suggesstion-box").hide();
                            ...
                            <div class="top_search">
                                        ...
                                        <div class="to                                            psearch_bar">
                                            <select id="rctyp" name="rctyp" class="page-header-col1-row2-col2-form-select1">
                                                    <option value="Suppliers" <?php if ($ctype == 'Suppliers') { ?> selected="selected" <?php } ?>>Suppliers</option>
                                                    <option  value="Products" <?php if ($ctype == 'Products') { ?> selected="selected" <?php } ?>>Products</option>
                                                    <option value="buy_lead" <?php if ($ctype == 'buy_lead') { ?> selected="selected" <?php } ?>>Buy Leads</option>
                                                    <option value="tender" <?php if ($ctype == 'tender') { ?> selected="selected" <?php } ?>>Tenders</option>
                                                    <!--<option value="auction">Auction</option>-->
                                                </select>
                                                </div>
                                                <div class="topsearch_placeholder">
                                                    <input type="text" id="search-box11" name="keywords" placeholder="Source Products to find suppliers" onfocus="gotFocus();" onblur="lostFocus()" value="<?php echo $_GET['keywords']; ?>"   class="topsearch_placeholder_cont "/>
                                                </div>
