...
<div class="row top-bar" id="topbar">
  ...
  <ul>
    ...
    <li>
      <span class="pp1">
        <span class="tlc">Welcome: </span><?php echo getUserInfo($uid, 'name_prefix') . "&nbsp;" . getUserInfo($uid, 'fname');?>
    ...
    <?php } ?>  
    <li class="dropdown dropdown1"  style="z-index: 100;"> <a data-target="myArabyos"  class="dropbtn1" href="" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" > <b class="txt-yellow" style="font-weight:900;">M<span class="s-small">Y</span> <?php echo getWebSiteName(); ?></b> <i class="fa fa-chevron-down"></i> </a><span class="linebr" style="color: black"> |</span> <a href="my-enquiries.php"> <img width="25" src="images/envolap.png"/>
    <?php
...
<div id="menu">
<ul>
   <li><a href="#">Sign in  |  Join Free</a></li>
   <li class="active">
   ...
   <li><a href="#">Credit:<span><b>0</b></span>  | &nbsp; Buy Credit</a></li>
   <li class="has-sub"><a href="#">Buy</a>
      <ul>
          <li><a href="#">Latest Auctions</a></li>
          <li><a href="#">Manage Sell Offer Alerts</a></li>
          <li><a href="#">Post Your Buy Requirement</a></li>
          <li><a href="#">Search Product &amp; Suppliers</a></li>
      </ul>
       <div class="clear"></div>
   </li>
   <li class="has-sub"><a href="#">Sell </a>
      <ul>
         <li><a href="#">Latest Buy Leads</a></li>
         <li><a href="#">Latest Tendors</a></li>
         <li><a href="#">Create Free Website</a></li>
         <li><a href="#">Display Free Products</a></li>
         <li><a href="#">Post a Temporary Sale Offer</a></li>
         <li><a href="#">Managed Buy Lead Alerts</a></li>
      </ul>
      <div class="clear"></div>
   </li>
    ...
    <div class="headertop-custom-box"> 
      <div class="headertop-custom-box-left">
        ...
        <!-- <a href="product-sel-cat.php"> <img src="images/Postproducts.png" /></a> -->
         ...
         Post Your Products<small>Get <strong>Domestic</strong> or <strong>Global</strong> Enquiries</small> 
         </a>         
        </div>
      </div>
...
$("#suggesstionBoxs").hide();
      ...
      <!-- Nav tabs -->
        ...
        <div class="page-header-col1-row2-col4 "> 
         ...
         Post Buy Requirements<small>Get <strong>Quotes</strong> from <strong>Verified Suppliers</strong></small>          
         </a> 
