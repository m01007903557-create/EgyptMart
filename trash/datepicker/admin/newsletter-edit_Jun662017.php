...
$sql = 'SELECT * FROM newsletter_content_arabyos WHERE nc_id = '.$_GET['fid'];
$res_nc = mysql_query($sql) or die(mysql_error());
$row_nc = mysql_fetch_object($res_nc);
//echo "<pre>"; print_r($row_nc); echo "</pre>";
?>
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="newsletter-view.php">Manage Newsletter</a>
			</li>
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onSubmit="return myvalid();">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<input name="nc_subject" id="nc_subject" class="col-xs-10 col-sm-8" type="text" value="<?php echo ((trim($nc_subject) =='')?$row_nc->nc_subject:$nc_subject);?>" />
		</div>
	</div>
     ...
     <div class="form-group">
		...
		<div class="col-sm-9">
            ...
            for ($ik = 0; $ik < count($cat_array); $ik++) {
              ?>
              <option value="<?php echo $cat_array[$ik]['id'];?>" <?php echo (($row_nc->nc_category == $cat_array[$ik]['id'])?'selected="selected"':''); ?> ><?php echo $cat_array[$ik]['name'];?></option>
                <?php
              }
              ?>
            </select>
     ...
     <div class="form-group">
		...
		<div class="col-sm-9">
            ...
            for ($ik = 0; $ik < count($country_array); $ik++) {
              ?>
              <option value="<?php echo $country_array[$ik]['id'];?>"  <?php echo (($row_nc->nc_country == $country_array[$ik]['id'])?'selected="selected"':''); ?> ><?php echo $country_array[$ik]['name'];?></option>
                <?php
              }
              ?>
            </select>
	 ...
	 <div class="form-group">
		...
		<div class="col-sm-9">
            ...
            for ($ik = 0; $ik < count($company_array); $ik++) {
              ?>
              <option value="<?php echo $company_array[$ik]['id'];?>"  <?php echo (($row_nc->nc_companies == $company_array[$ik]['id'])?'selected="selected"':''); ?> ><?php echo $company_array[$ik]['name'];?></option>
                <?php
              }
              ?>
            </select>
...
<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<?php echo ((trim($nc_content) =='')?stripslashes($row_nc->nc_content):stripslashes($nc_content));?>
			</textarea>
