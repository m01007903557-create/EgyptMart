...
class addAdvertisement{
	...
	function __construct($imgsize, $adv_img, $adv_link,$adv_country,$adv_position)
	{		
...
{ 	
	...
	$adn=new addAdvertisement(addslashes(trim($_POST['imgsize'])), trim($_FILES['adv_img']['name']), addslashes(trim($_POST['adv_link'])),$_POST['adv_country'],$_POST['adv_position']);
	if($adn->valid())
	{	
		$adn->add();		
	}
	...
	header("location:advhome-add.php");
}
?>
