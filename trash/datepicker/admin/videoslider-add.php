...
class addAdvertisement{
	...
	function __construct($adv_link,$adv_title,$adv_description,$adv_country,$adv_global,$adv_redirect)
	{		
...
{ 	
	...
	$adn=new addAdvertisement(addslashes(trim($_POST['adv_link'])),addslashes(trim($_POST['adv_title'])),addslashes(trim($_POST['adv_description'])),$_POST['adv_country'],$_POST['adv_global'],$_POST['adv_redirect']);
	if($adn->valid())
	{	
		$adn->add();		
	}
...
<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="adv_redirect" id="adv_redirect" class="col-xs-10 col-sm-5" type="url" style="width:440px;" value="<?php echo $adv_redirect; ?>" />
		</div>
</div>
	<div class="form-group">
