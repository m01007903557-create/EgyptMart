...
$sql="select * from tender where md5(tnd_id)='".$id."'";
$res=mysqli_query($con, $sql);
$row=mysqli_fetch_object($res);

$bsql="select bu.* from tender t JOIN business_profile bu ON t.tnd_usr_id = bu.bnsprof_uid where md5(t.tnd_id) ='".$id."'";
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->tnd_heading; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php if($row->tnd_value!='' && $row->tnd_value!='0.00'){	echo $row->tnd_value."&nbsp;".getCurrency($row->tnd_currency);	} ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->tnd_notice_type; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php if($row->tnd_qty!='' && $row->tnd_qty!='0.00'){	echo $row->tnd_qty." ".measurement_unit($row->tnd_qty_mu_id);	} ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">EMD:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->tnd_emd; ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Document Fees:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php if($row->tnd_document_fees!='' && $row->tnd_document_fees!='0.00'){	echo $row->tnd_document_fees."&nbsp;".getCurrency($row->tnd_document_fees_currency);	} ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Project Period:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->tnd_project_period; ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Products:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->tnd_products; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->tnd_publish_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->tnd_docSaleStart_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->tnd_docSaleEnd_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->tnd_docSubmitBefore_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->tnd_due_date)); ?></label>
		</div>
	</div>
    <div class="form-group">
		...
		<div class="col-sm-8">
            ...
            <?php
				if($row->tnd_preferred_location=='abroad'){	echo "Abroad Only";	}
				else if($row->tnd_preferred_location=='any'){		echo "Anywhere";	}
				else if($row->tnd_preferred_location=='domestic'){		echo "Domestic Only";	}
				else if($row->tnd_preferred_location=='my_city'){		echo "My City Only";	}
			?>
            </label>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo stripslashes($row->tnd_prequalification_criteria); ?></label>
		</div>
	</div>
     ...
     <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo stripslashes($row->tnd_details); ?></label>
		</div>
	</div>
