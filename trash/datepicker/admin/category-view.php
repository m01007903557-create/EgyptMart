...
$al->setsql("select * from product_category where pc_parent_id IN ($varcat5) and pc_parent_id!=0 and pc_status='1' order by pc_id desc");
...
<?php $j=0;
   ...
   {			
		while($row=mysqli_fetch_object($recObj)){ 
           ...
           $maincatsql="select * from product_category where pc_id='".$row->pc_parent_id."' and pc_status='1' order by pc_id";	
