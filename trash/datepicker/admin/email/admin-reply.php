...
<p style="font-size: 14px; line-height:24px; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif;" align="left">
				...
				if($plans == 'Advertisements Requirements'){
					$message1 .= '<p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">You can Reply :<a style="float: right" href="http://arabyos.com/advertise-with-us.php">Reply NOW</a></p>';
				}
				else if($is_contact == 1){
					$message1 .= '<p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">You can Reply :<a style="float: right" href="http://arabyos.com/contact_us.php">Reply NOW</a></p>';
				}
				else { 
				
					$message1 .= '<p style="line-height:1.5em;text-align:left;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em">You can Reply :<a style="float: right" href="http://arabyos.com/membership_plans.php">Reply NOW</a></p>';
					}
