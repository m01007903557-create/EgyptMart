...
<div style="width:100%;text-align:center;">
              ...
              <div style="clear:both">
			  			  ...
			  			  <div>
			  <a href="http://www.arabyos.com/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=http://www.arabyos.com/product-list.php" ><img src="http://arabyos.com/images/plan.png" alt="" height="100%" width="100%"></a>
			  </div>
			  <div>
			  ...
			  <table align="center">
			  <tr>
			  <td style="padding: 5px;"><a href="http://www.arabyos.com/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=http://www.arabyos.com/product-sel-cat.php" style="padding: 5px;color: #0f00d0;font-size: 18px;font-weight: 600;text-decoration:none;">Products/Services</a></td>
			  <td style="padding: 5px;"><a href="http://www.arabyos.com/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=http://www.arabyos.com/post-buy-req.php" style="padding: 5px;color: #0f00d0;font-size: 18px;font-weight: 600;text-decoration:none;">Buy Requirments</a></td>			  
			  </tr>
			  <tr>
			  <td style="padding: 5px;"><a href="http://www.arabyos.com/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=http://www.arabyos.com/post-sell-offer.php" style="padding: 5px;color: #0f00d0;font-size: 18px;font-weight: 600;text-decoration:none;">Temporary Sale Offer</a></td>
			  <td style="padding: 5px;"><a href="http://www.arabyos.com/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=http://www.arabyos.com/post-tender.php" style="padding: 5px;color: #0f00d0;font-size: 18px;font-weight: 600;text-decoration:none;">Tenders / Auctions</a></td>			  
			  </tr>
