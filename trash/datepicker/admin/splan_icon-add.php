...
class addPlan{
	...
	function add()
	{		
		$sql="insert into smembership_icon_plan 
			set					
				mst_name ='".$this->mst_name."',
				mst_icon ='".$this->mst_icon."',
				mp_updated_date=now()";							
...
if(isset($_POST['btnAdd']))
{
	...
	$adn->mst_name=addslashes(trim($_POST['mst_name']));


    $fileName = time().$_FILES['mst_icon']['name'];
 if( move_uploaded_file($_FILES['mst_icon']['tmp_name'],"./images/".$fileName))
    {
   //  file_put_contents($fileName,$_FILES['mst_icon']['temp_name']) ;
    ;
	...
	header("location:splan_icon-add.php");
}
?>
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="splan_icon-view.php">Manage Membership Plan</a>
			</li>
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
			<input name="mst_name" id="mst_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $mp_name; ?>" />
		</div>
	</div>
    ...
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">MemberShip Icon <span style="color:#CC0000">*</span></label>
		<div class="col-sm-9">
			<input name="mst_icon" id="mst_icon" class="col-xs-10 col-sm-5" type="file" />
