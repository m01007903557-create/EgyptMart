...
$bsql="select bu.* from buy_requirement r JOIN business_profile bu ON r.br_u_id = bu.bnsprof_uid where md5(r.br_id) ='".$id."'";
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->br_pd_name; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
			...
			<div class="col-sm-9">
				<img src="../upload/buy_requirement/thumb/<?php if($row->br_pic !=''){	echo $row->br_pic;	}else{ echo "no-image.png";	} ?>" border="0" hspace="0" vspace="0">
			</div>
		</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_requirement; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_estimate_qty." ".$row->mu_name; ?> </label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_apprx_order_currency." ".$row->br_apprx_order_value; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_description; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_website; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_need_quote_for; ?></label>
		</div>
	</div>
    <div class="form-group">
		...
		<div class="col-sm-8">
            ...
            <?php
				if($row->br_preferred_supplier_location=='abroad'){	echo "Abroad Only";	}
				else if($row->br_preferred_supplier_location=='any'){		echo "Anywhere";	}
				else if($row->br_preferred_supplier_location=='domestic'){		echo "Domestic Only";	}
				else if($row->br_preferred_supplier_location=='my_city'){		echo "My City Only";	}
			?>
            </label>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_need_for; ?></label>
		</div>
	</div>
     ...
     <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row->br_requirement_frequency; ?></label>
		</div>
	</div>
	<div class="form-group">
