...
$res = mysqli_query($con, "select * from product_category where md5(pc_id) = '".$token."'");
	...
	{	
		...
		if($this->pc_image != '')
		{
    	    ...
    	    if(in_array($ext,$validEXT))
			{
				...
				$lstImg = mysqli_fetch_object(mysqli_query($con, "select pc_image from product_category where pc_id = '".$this->pc_id."'"));
