...
class listCat{
	...
	function deleterecord($adid){
		...
		mysqli_query($con, "update membership_plan set mp_status = '0' where mp_id='".$adid."'");
	}
...
{ 
	...
	{		
		mysqli_query($con, "update membership_plan set mp_status = 0 where mp_id='".$cb."'");		
	}
	header("Location:memplan-view.php");
}
?>
...
$count=mysqli_num_rows($recObj);
	if($count >0)
	{
        ...
        <tr <?php if($j % 2 == 1) { ?> class="row-clr" <?php } ?> >
            ...
            <td style="text-align:center"><?php echo $row->mp_credits; ?></td>
            <td style="text-align:center"><?php echo $row->mp_amount; ?></td>
            <td style="text-align:center">
            <a href="memplan-edit.php?fid=<?php echo $row->mp_id ?>" title="Edit"><img alt="edit" src="images/edit.jpg" border="0"></a>
