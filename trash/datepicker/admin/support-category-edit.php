...
include "../common.php";
	...
	function __construct($fc_id){
		$this->fc_id=$fc_id;
	}
	
	function detailsObj(){
		global $con;
		$sql="select * from faq_categories_arabyos where md5(fc_id)='".$this->fc_id."'";
	...
	{			
	   global $con;
		 	  $sql="update faq_categories_arabyos set 		
					fc_name ='".$this->fc_name."'
					where md5(fc_id)='".$this->fc_id."'";
...
$ob=new editsupport($token);
$row=$ob->detailsObj();

if(isset($_POST['btnUpdate'])){
	$ob->fc_name=addslashes(trim($_POST['fc_name']));
	...
	//echo $ecms->msg;
	$_SESSION['msg']=$ob->msg;
	header("location:support-category-edit.php?token=".$_GET['token']);
}
?>
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li>
				<a href="support-category-list.php">Manage Support Category</a>
			</li>
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onSubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="fc_name" id="fc_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $row->fc_name; ?>" />
		</div>
	</div>
