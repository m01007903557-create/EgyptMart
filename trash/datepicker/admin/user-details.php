...
$sql="select * from user,business_profile where bnsprof_uid=usr_id and md5(usr_id) = '".$token."'";
	...
	<div class="page-header">
		<h1>
			...
			<small>
				...
				Details of <strong><?php echo ucwords($row['name_prefix']." ".$row['fname']." ".$row['lname']);?></strong>
			</small>
		</h1>
	</div>
	<div class="row">
...
<h3><strong>Account Info</strong></h3>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Registration Date:</label>
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo date('F d, Y',strtotime($row['bnsprof_creation_date'])); ?></label>
		</div>
	</div>
    
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Last Update:</label>
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo date('F d, Y',strtotime($row['date'])); ?></label>
		</div>
	</div>
    <?php if(getEmailVerificationStatus()==1){	?>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Email Verification:</label>
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php  if($row['usr_emailVerify'] == '0'){echo '<font color=red>Email not verified</font>';}elseif($row['usr_emailVerify'] == '1'){echo '<font color=green>Email verified</font>';}?></label>
		</div>
	</div>
	<?php } ?>
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Account Credit:</label>
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php  echo $row['usr_credit']; ?></label>
		</div>
	</div>
              
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Business Page:</label>
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><a href="../company/index.php?c=<?php echo rand(1000,9999).md5($row['bnsprof_id']);?>" target="_blank"><?php echo $_SERVER['HTTP_HOST']; ?>/company/index.php?c=<?php echo rand(1000,9999).md5($row['bnsprof_id']);?></a></label>
		</div>
	</div>
...
<h3><strong>Personal Info</strong></h3>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php  echo $row['email']; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row['country_ph_code']." ".$row['mobile1']; ?></label>
		</div>
	</div>
   ...
   <div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo get_country_name($row['country']); ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row['website']; ?></label>
		</div>
	</div>
    
	<?php if($row['usr_mp_id'] != '0'){ ?>
	    <div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Membership Plan:</label>
			<div class="col-sm-9">
            <?php
				$mem = mysqli_fetch_array( mysqli_query($con, "select mp_name from membership_plan where mp_id = '".$row['usr_mp_id']."'"));
			?>
   		   		<label style="padding-top:4px;"><?php echo $mem['mp_name']; ?></label>
			</div>
		</div>
	<?php } ?>
...
<?php echo $row['bnsprof_zipcode']; ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php if($row['bnsprof_comemp']>0){ echo $row['bnsprof_comemp']; } ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Company Documents:</label>
		<div class="col-sm-9">
			<a href="../server/php/files/<?php echo $row['bnsprof_doc'];?>"><?php echo $row['bnsprof_doc'];?></a> 
		</div>
	</div>
	<?php } ?>
