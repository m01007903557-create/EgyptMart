...
{
	$.get("states_show.php", {cid:cid}, function(data){$('#states_list').html(data); });
}
...
function DelState(hid)
{
	...
	{
		$.get("del_states.php", {hid:hid}, function(data){	ShowState(data);	 });
	}
}

function addState(){
var states_add=$('input#states_add').val();
if($.trim($('input#states_add').val())!="")
{
var cun=$('select#cun').val();
$.get("states_add.php", {
states_add:states_add,cun:cun},
...
var states_inp = $('input#states_'+hid).val();
if($.trim($('input#states_'+hid).val())!="")
{
$.get("states_edit.php", {hid:hid,states_inp:states_inp}, function(data){
//alert(data);
...
<TR><TD>
										<?php
											...
											$res_cn=mysqli_query($con, $sql_cn);	
										?>
                                        	<select name="cun" id="cun" class="chosen-select" onchange="ShowState(this.value)">
