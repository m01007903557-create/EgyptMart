...
$bsql = "select * from products where pd_uid=$row->bnsprof_uid";
$bres = mysql_query($bsql);
while ($row_t = mysql_fetch_object($bres)) {
    $banner[] = $row_t->pd_image;
}
	...
	<nav class="cb company_nav_head" id="tml" style="height:44px !important;">
	   <ul class="company_menu pop-up-position-main" style="position: relative;">
        ...
        <div class="pop-up-position" style="position: absolute;top: 10px;right: -310px;">
          <ul class="user_profile_link" style="top:27%; margin-top: 0px; position: inherit;">
		<li>
	        ...
	        <div id="profile_sub_menu">
				...
				<div class="profile_list_value">
					<div onclick="checklogin()" class="contact_div" id="create-user" style="font-size:13px; color: darkblue;"><span style="padding-right: 5px; float:left;"><img src="<?php echo BASE_URL ?>/company/images/mail_box.png" width="25"></span><span style="padding-right: 0px; font-size: 14px;"><b>Send SMS Enquiry</b></span></div>
				...
				<div class="profile_list_value">
					<div class="chat"><span><img src="<?php echo BASE_URL ?>/company/images/chatnow.png" width="55"></span><span><?php echo $row->bnsprof_ceofname.' '.$row->bnsprof_ceolname; ?></span></div>
                        ...
                        <div class="abcdefgh">
                         ...
                         <div id="dialog-form" title="Send SMS Enquiry" style="background-color: beige; overflow: visible;" >
	  ...
	  <ul class="company_video_link"><li><span><a href="../<?php echo $row->bnsprof_comp_url;?>/video.php?c=<?php echo $c; ?>">Company Video</a></span><img src="<?php echo BASE_URL ?>/company/images/video.png"></li></ul>
						...
						if(count($banner) > 0 && isset($banner[1]) && $banner[1]!="")
						 ...
						 <?php
							foreach($banner as $aBan)
							 {
							?>
							    	<li><img width="100" height="100" alt="Fresh Plum" src="<?php echo BASE_URL ?>/upload/myproduct/thumb/<?php echo $aBan ?>"></li>    
							<?php
