...
<?php if($row->image != ''){ ?>
<img src="<?php echo 'data:image/jpg;base64,'.base64_encode( getUserInfo($uid,'profileImage'));?>" width="70" id="profilephoto1" height="70">
<?php }else{ ?>
                                              <img src="<?php echo BASE_URL ?>/server/php/files/thumbnail/upload.jpg" width="70" height="70">
<?php } ?>
                                       </div>
				...
				<div class="profile_list_value">
					<div onclick="checklogin()" class="contact_div" id="create-user" style="font-size:13px; color: darkblue;"><span style="padding-right: 5px; float:left;"><img src="<?php echo BASE_URL ?>/company/images/mail_box.png" width="25"></span><span style="padding-right: 0px; font-size: 14px;"><b>Send Inquiry</b></span></div>
				      <?php if($flag == "success"){?>
                                        <br>
                                        <br>
	  ...
	  <ul class="company_video_link"><li><span><a href="./video.php?c=<?php echo $c; ?>">Company Video</a></span><img src="<?php echo BASE_URL ?>/company/images/video.png"></li></ul>
				...
				<section id="header">		
					...
					?>
					<div>
					   <img width="100" height="100" class="img-current-border" src="<?php echo $aBan ?>">
					</div>    
				<?php } ?>
					</section>
			...
			<?php }else{?><?php echo $btp?><?php }?>  
				 ...
				 ?>
						...
						if(count($banner) > 0 && isset($banner[1]) && $banner[1]!="")
						 ...
						 <?php
							foreach($banner as $aBan)
							 {								
							?>
							    	<li><img width="100" height="100" alt="Fresh Plum" src="<?php echo $aBan ?>"></li>    
							<?php
							 }
						 ?>
						    </ul>
					    ...
					    <p style="padding-left:60px; padding-bottom:20px; font-size:18px; line-height: 1.5em; color: #595959; text-shadow: 1px 1px #ecf6fd;">
                                              <?php
                                              $size = sizeof($prod);
