...
<div class="company_profile_top_sec"> 	
	<div class="company_info">
		<div class="header_top_div" style="box-shadow: -4px 6px 7px #4C4646;">
			<div class="top-text1"><span><a href="http://www.arabyos.com/membership_plan.php"><img src="<?php echo BASE_URL ?>/company/images/membericon.png" /></a></span><span>SENIOR Member</span></div>
	...
	<li><span><a style="background:none; color:#fff; text-shadow:none;" href="./video.php?c=<?php echo $c; ?>">Company Video </a></span><img style="width: 35px; float: right; padding-top: 8px;" src="<?php echo BASE_URL ?>/company/images/video.png"></li>
	  </ul>
	 ...
	 <ul class="user_profile_link" style="margin-top: -100px; margin-left: -217px;">
		<li>
			<a href="javaScript:void(0)" style="padding: 4px 8px 4px 5px !important; color: #eeff1d !important;">Contact Supplier</a>
	        <div id="profile_sub_menu">
				<div class="profile_list_value">
                                       <div class="user_profile_image"> 
                                             <!-- <img src="<?php echo BASE_URL ?>/server/php/files/thumbnail/<?php echo $row->image ?>" width="70" height="80"> -->
                                               <img src="<?php echo 'data:image/jpg;base64,'.base64_encode( getUserInfo($uid,'profileImage'));?>" width="70" id="profilephoto1" height="80">
                                       </div>
    ...
    <section id="header123" style="padding-top:0px;">
		...
		?>
<div>
   <img width="100" height="100" alt="Fresh Plum" class="img-current-border" src="<?php echo BASE_URL ?>/upload/company_banner/<?php echo $aBan ?>">
</div>    
	<?php } ?>
