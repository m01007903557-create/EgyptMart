            ...
            <div> 
                ...
                <ul class="b fo ac-fl acac-db acac-p10px15px acac-btlr5px acac-btrr5px ac-mr5px large tabs" data-persist="true">
                    ...
                    <li style="float: right;    display: inline-block;">
                        <div class="view_list_design" style=""><span style="font-size: 13px;">View As</span>&nbsp;&nbsp;
                            ...
                            <li class="grids_list">
                                <div class="product_top_div_first">
                                    <div class="top_text_first" style="font-weight:100 !important;">
                                        click <span><i class="fa fa-plus"></i></span> to select products and contact the supplier or send wholesale inquiry. 	
                                    </div>
...
<div id="jssor_2" class="selected_list_div shopping-cart" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 550px; height: 150px; overflow: hidden; visibility: hidden;border-top: none;">
                                    ...
                                    <form>
                                        ...
                                        <div class="last_button_div" style="padding-right: 14px; float:right !important; margin-top: 64px; position:absolute; right:16px;">
                                            <a onclick="checklogin()" href="../<?php echo 'company'; ?>/enquiryRequest.php?c=<?php echo $c; ?>" style="font-size:16px;"><i class="fa fa-envelope" style="font-size: 16px;"></i>WholeSale Contact</a>
                                        </div>
                                        <!-- Bullet Navigator -->
                                        <!-- <div data-u="navigator" class="jssorb03" style="bottom:10px;right:10px; float:left; left:10px;">
    ...
    header.classList.remove("webcast-fixed");
                    ...
                    <div id="view1" style="position: relative;">
                        ...
                        <div class="top_page_list_first" style="position:absolute; top:-175px; right: 0px;font-weight: normal;">
                            ...
                            <a class="but right"  uri-id="<?php echo 'test.php?c=' . $c . '&view=' . $class . '&page=' . $next; ?>" uri-page="<?php echo $next;?>" href="javascript:void(0)" style="vertical-align: sub;" ><img src="images/right.png" style="width:10%" /></a><?php echo $page . " of " . $totalitem; ?> pages
                        </div>
                                                    ...
                                                    <div class="product_title product_title_2">
                                                     ...
                                                     <div class="product_title product_title_1">
                                                       <p> <?php echo substr($row_pd_h->pd_desc, 0, 65) ?>
                                                        <a href="product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd_h->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:15px;">more</a>		
                                                    </p></div>
                    ...
                    <div id="view2" style="position: relative;">
                        ...
                        <div class="top_page_list_first" style="position:absolute; top:-175px;right: 0px;font-weight: normal; margin-top: 160px;">
                            ...
                            <a class="buts right" uri-id="<?php echo 'tests.php?c=' . $c . '&view=' . $class . '&page=' . $next; ?>" uri-page="<?php echo $next;?>" href="javascript:void(0)" style="vertical-align: sub;"><img src="images/right.png" style="width:10%" /></a><?php echo $page . " of " . $totalitems; ?> pages
                        </div>
                                        ...
                                        <div class="zk"><img src="../upload/myproduct/<?php echo  $logoarr[0]?>"/></div> 
                                                    ...
                                                    <div class="product_title product_title_2">
                                                       <p> <?php echo substr($row_pd->pd_desc, 0, 65) ?>
                                                        <a href="product-details.php?token=<?php echo rand(1000, 9999) . md5($row_pd->pd_id); ?>&c=<?php echo $c; ?>" style="font-size:15px;"><small>More +</small></a>		
                                                    </p></div>
...
$Countryphone = mysql_fetch_array(mysql_query("SELECT * FROM `country` where cn_id = " . $row->country)); ?>
                                                    <div class="product_number">
