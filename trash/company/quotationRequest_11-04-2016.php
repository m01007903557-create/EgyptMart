...
//		$("#errmsg").css("display","block");
	...
	else
	{
		...
		msg_message = "Product Name: "+prd_name.value+'<br/><br/>'+msg_message.value;

		$.post("../ajax-file/sendMessage.php", {msg_from:msg_from.value,msg_to:msg_to.value,msg_subject:msg_subject.value,msg_message:msg_message}, function(data){
...
<div class="ov-base">
    ...
    <div class="enn1-nw nef4-nw">
		...
		<div id="yourcontactinfo">
            ...
            <input name="submit_member" id="button" value="Send Enquiry" class="snd-enq" style="box-shadow: 0pt 1px 5px rgb(170, 170, 170); font-family: Arial,Helvetica,sans-serif; font-size: 16px; font-weight: bold; text-align: center; color: rgb(255, 255, 255); border: 1px solid rgb(24, 143, 205);border-radius:6px; _border-radius: 0px; padding:5px 20px; cursor:pointer;" type="button" onclick="checklogin();"/>
