...
foreach($data as $key=>$rowdata){
    $rowdata->pd_min_order_qty = $quentity[$key];
}
...
//		mysql_query($sql_rr1);
//		
//		$sql_rr2="insert into review_ratings
//			set
//				rr_from_usr='".$msg_to."',
//				rr_to_usr='".$msg_from."'";
//		mysql_query($sql_rr2);
						...
						<div style="width: 90%;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
							<div style="height: 100px; width: 100%; float: left; ">
							    ...
							    <div style="height:100px;width:43%;float:left;">
							        <h2 style="font-size: 20px; color:#466da0; text-align: center; margin-top:0px; margin-bottom:0px;">Today\'s Latest<br> Wholesale Business Enquiry
							        </h2>
							    </div>
...
function clearSession(){
	...
	unset($_SESSION['image9']);
	unset($_SESSION['image10']);
	unset($_SESSION['image11']);
	unset($_SESSION['image12']);
	unset($_SESSION['image13']);
	unset($_SESSION['image14']);
	unset($_SESSION['image15']);
	unset($_SESSION['image16']);
	unset($_SESSION['image17']);
	unset($_SESSION['image18']);
	unset($_SESSION['image19']);
	unset($_SESSION['image20']);
