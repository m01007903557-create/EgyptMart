...
<body class="search-show-box-buyleads">
<div class="q_hm1">
<!-- Header start Here::-->
...
<div class="inner_wrapper" style="margin-top:40px;">
    <p class="q_c3"></p>
<p class="bg bp1 fl d1 a6 bo col-md-3 col-sm-3 col-xs-12">All Categories</p>
<div class="q_bt1 w1 fl w3 col-md-9 col-sm-9 col-xs-12">
<a class="cb2" href="manage-sell-offer.php" rel="nofollow">My Trade Offers</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="cb2" href="manage-tenders.php" rel="nofollow">My Tenders</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="cb2" href="manage-tender-alert.php" rel="nofollow">Manage Tender Alerts</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a class="q_r" href="post-tender.php" rel="nofollow"><img src="images/zero.gif" alt="">Post Tender</a></div>
<!--New Header3 End --><p class="c3"><img alt="" src="images/zero.gif" height="1" width="1"></p> <div class="lft1 lfl fl col-md-4 col-sm-4
 col-xs-12">
...
{
?>
	<li class='has-sub'><a href="dir.php#main_cat_<?php echo $row_dd_mnu->pc_id; ?>"><span><?php echo $row_dd_mnu->pc_name;?></span></a><!--category.php?token=-->
    <ul>
    <?php
	...
	?>
        ...
        <?php /* if($row_scnt->cnt>0){ ?>
            <ul>
		    <?php
				$sql_dd_smnu="select pc_id,pc_sort_name from product_category where pc_parent_id = '".$row_dd_cmnu->pc_id."' and pc_status = '1' ".$sql_order;
...
<a href="http://www.arabyos.com/post-tender.php" target="_blank"><img src="http://www.arabyos.com/images/tender_banner.jpg" style class="img-responsive; width:100%;" class="tender-img width:100%;"></a>
</div>
...
<div class="mid fl col-md-9 col-sm-9 col-xs-12"><center> 
<div id="m4t1"></div>
</center>
		<!--<div class="bnbg bpt">
...
function showLead(page,id)
{
	...
	$('#tabbb'+id).addClass('ho');
	 ...
	 $.post("ajax-file/tenders.php",{page:page,id:id},    function(data){    $('#res').html(data); });
	 showAuction(page,id);
}
...
<p class="c4 f4 g5 lbl"><span>Latest Tenders</span><a href="http://www.arabyos.com/auctions.php" class="Up_coming_Auction">Upcoming Auction</a></p>

<div class="tbl fl">
	<ul id="sidebarTabs">
    <?php
		$pc=0;	
		$sql_cat="select pc.*, t.* from product_category pc JOIN  product_category pc1 ON pc1.pc_parent_id =  pc.pc_id JOIN  product_category pc2 ON pc2.pc_parent_id = pc1.pc_id JOIN tender t ON t.tnd_pc_id = pc2.pc_id where tnd_approval_status='1' and TO_DAYS(tnd_due_date)>=TO_DAYS(now()) ".$sql_tnd_ck."  and tnd_status='1' GROUP BY pc.pc_id";
		//echo $sql_cat;
...
<script type="text/javascript">
$('document').ready( function(){
  showLead(1,<?php echo $pc; ?>);
});
</script>
<div id="res" style="float: left;width: 84%;"></div>
...
<?php
$tdate=date("Y-m-d");
$sql_t="select * from tender,product_category,user,business_profile where tnd_pc_id=pc_id and tnd_usr_id=usr_id and usr_id=bnsprof_uid and tnd_approval_status='1' and TO_DAYS(tnd_due_date)>=TO_DAYS(now()) ".$sql_tnd_ck." and tnd_status='1' order by rand() LIMIT 5";
//echo $sql_t;
