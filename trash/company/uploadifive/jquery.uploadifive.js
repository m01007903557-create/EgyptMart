        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'buttonClass'     : '',              // A class to add to the UploadiFive button
                    'buttonText'      : 'Attach File',     // The text that appears on the UploadiFive button
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    ...
                    if (settings.removeCompleted) {
                        setTimeout(function() { methods.cancel.call($this, file); }, 500);
                    }
                    file.complete = true;
