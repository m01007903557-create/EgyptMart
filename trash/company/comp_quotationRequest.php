...
<?php if($run_pre!=''){ 
if($_GET['keywords']!=""){?>
  <!--<a data-prev=""  href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/EgyptMART/company/quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($data1['bnsprof_id']); ?>&pid=<?php echo $run_pre->pd_id; ?>&keywords=<?php echo $_GET['keywords'];?>&geo=<?php echo $geo_id;?>&conty=<?php echo $con_id;?>"><img src="http://arabyos.com/company/images/2.png" style="height: 61px; float: left; margin-top: 44px; cursor: pointer;"  /></a>-->
  <?php }
  else{ ?>
  
   <!--<a data-prev=""  href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/EgyptMART/company/quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($data1['bnsprof_id']); ?>&pid=<?php echo $run_pre->pd_id; ?>&geo=<?php echo $geo_id;?>&conty=<?php echo $con_id;?>"><img src="http://arabyos.com/company/images/2.png" style="height: 61px; float: left; margin-top: 44px; cursor: pointer;"  /></a>-->
  
  <?php }} ?>
     <!--****************** end left arrow *********************-->

        <img height="163" width="250"src="http://arabyos.com/upload/myproduct/<?php echo $p_row->pd_image ?>" >
        
     <!--******************  right arrow *********************-->
    <?php if($run_nxt!=''){ 
	if($_GET['keywords']!=""){?>

 <!--<a data-next="" id=""   href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/company/quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($data['bnsprof_id']);?>&pid=<?php echo $run_nxt->pd_id; ?>&keywords=<?php echo $_GET['keywords'];?>&geo=<?php echo $geo_id;?>&conty=<?php echo $con_id;?>"><img src="http://arabyos.com/company/images/play.png" style="height: 61px; float: right; margin-top: 44px; cursor: pointer;"  /></a>-->
 <?php }
  else{ ?>
  <!--<a data-next="" id=""   href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/company/quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($data['bnsprof_id']);?>&pid=<?php echo $run_nxt->pd_id; ?>&geo=<?php echo $geo_id;?>&conty=<?php echo $con_id;?>"><img src="http://arabyos.com/company/images/play.png" style="height: 61px; float: right; margin-top: 44px; cursor: pointer;"  /></a>-->
  <?php }} ?>
     <!--****************** end right arrow *********************-->
