        ...
        <li id="wideColumn">		
            ...
            <div> 
                ...
                <ul class="b fo ac-fl acac-db acac-p10px15px acac-btlr5px acac-btrr5px ac-mr5px large tabs" data-persist="true">
                    ...
                    <li><a href="#view1" id="hide" class="lightbg2 gbiwb cd bdr bdrb0 mt1px" style="outline:none; cursor: pointer;">Hot Products</a></li>

                    <li><a href="#view2" id="show" class="lightbg2 gbiwt bdrr bdr bdrb0 gray" style="outline:none;">Other Products</a></li>
                    <li>
                                ...
                                <div id="jssor_1" class="selected_list_div shopping-cart" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 809px; height: 150px; overflow: hidden; visibility: hidden;">
                                    ...
                                    <form>
                                        ...
                                        <div class="last_button_div" style="padding-right: 14px; float:right !important; margin-top: 103px; position:absolute; right:0px;">
                                            <a onclick="checklogin()" href="../<?php echo $row->bnsprof_comp_url; ?>/enquiryRequest.php?c=<?php echo $c; ?>" style="font-size: 23px;"><i class="fa fa-envelope"></i>Wholesale Contact</a>
                                        </div>
                                        <!-- Bullet Navigator -->
...
window.location.href="http://www.arabyos.com/sign-in.php";
                                          ...
                                          $("#btn_ajax" +<?php echo $row_pd_h->pd_id; ?>).colorbox({width: "62%", height: "89%"}); } });
                                                        ...
                                                        <span>
                                                            <a href="quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($row->bnsprof_id); ?>&pid=<?php echo $row_pd_h->pd_id; ?>&c=<?php echo $c; ?>" id="btn_ajax<?php echo $row_pd_h->pd_id; ?>" rel="product-send-inquiry" class="inquiry_but">Send Inquiry</a></span>
...
window.location.href="http://www.arabyos.com/sign-in.php";
                                                        ...
                                                        <span>
                                                            <a href="quotationRequest.php?id=<?php echo rand(1000, 9999) . md5($row->bnsprof_id); ?>&pid=<?php echo $row_pd->pd_id; ?>&c=<?php echo $c; ?>" id="btn_ajax<?php echo $row_pd->pd_id; ?>" rel="product-send-inquiry" class="inquiry_but">Send Inquiry</a></span>
                                                        <span><img src="<?php echo BASE_URL ?>/company/images/chat_icon.png" width="20"></span>
                                                    </div>
