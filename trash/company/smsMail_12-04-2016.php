...
//             $imgList.='<><img src="https://'.$_SERVER['HTTP_HOST'].'/arabyos/upload/myproduct/'.$value.'"></img>';  
//        }
//        $product = "";
//        foreach ($sel_product as $selpro) {
//            $product.='<div style="width:50%; overflow: hidden; float:left; margin-bottom: 20px;">
//	
//		<div style="width: 50%; float: left; overflow: hidden;">
//			<img height="140" src="https://'.$_SERVER['HTTP_HOST'].'/arabyos/upload/myproduct/'.$selpro->pd_image.'">
//		</div>
...
//                                <br>
//				<div>
//					MOQ &nbsp &nbsp: &nbsp &nbsp '.$selpro->pd_min_order_qty.'&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp'.get_measurement_unit($selpro->pd_unit).'
//				</div>
//			</div>
//		</div>
//	
