...
if($rowk->pd_large_image!=""){ ?>
       ...
       <a onclick="DelTempImage(<?php echo $rowk->pd_id; ?>)">
	   <img src="images/remove.gif" border="0" width="44" height="10">
        ...
        <img src="upload/myproduct_large/<?php echo $rowk->pd_large_image;?>" style="width:100%; height:auto;">
        </div>
