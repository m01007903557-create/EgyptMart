...
{
	global $con;
	$sql="select st_value from site_settings where st_field='website-title' and st_status=1";
...
{
	global $con;
	$sql="select * from site_settings where st_id='2'";
	$res=mysqli_query($con, $sql);
...
{
	global $con;
	$sql="select * from site_settings where st_id='3'";
	$res=mysqli_query($con, $sql);
	$row=mysqli_fetch_object($res);
	return $row->st_value;
}
...
{
	global $con;
	$sql = "select * from site_settings where st_field='currency-code'";
	$qry = mysqli_query($con, $sql);
	$arr = mysqli_fetch_array( $qry);	
	return stripslashes($arr['st_value']);
}
...
{
	global $con;
	$sql = "select * from site_settings where st_field='currency-symbol'";
	$qry = mysqli_query($con, $sql);
	$arr = mysqli_fetch_array( $qry);	
	return stripslashes($arr['st_value']);
}
...
{
	global $con;
	$sql = "select * from site_settings where st_field='email-verification'";
	$qry = mysqli_query($con, $sql);
	$arr = mysqli_fetch_array( $qry);	
	return $arr['st_value'];
}}
...
{
	$sql = "select * from site_settings where st_field='service-tax-rate'";
	$qry = mysqli_query($con, $sql);
	$arr = mysqli_fetch_array( $qry);	
	return $arr['st_value'];
}
