...
$(function () {
    ...
    var url ='https://arabyos.com/server/php/';
...
<div id="middle">
  ...
  <div class="col-sm-4">
  <div class="first-btn"><span>3</span>Create Your Business Account on ARABYOS </div>
  </div>
  <div class="clr"></div>
  </div>
 ...
 <div class="arobeb">
 <h3>The ARABYOS Advantage </h3>
 <ul>
 <li>Create Your EXPORT / BUSINESS Catalog</li>
  <li>Get listing in relevant products categories </li>
 ...
 <div class="col-sm-6 s1"><span>1</span> All Over the World</div>
  ...
  <div>ARABYOS hereby requests the members authentic information
towards their business statutory details.</div>
 <script>
	 function thisisnowcode()
        ...
        <input name="country" value="<?php print $default_country_id; ?>" id="country" type="hidden">	
  </div>
  
  <div class="account-from">
  <h2><strong>Create Your Business Account on ARABYOS </strong></h2>
  <div class="warning">I certify that Iam authorized to post my company business details on behalf of the company!
</div>
...
<input type="hidden" name="profile_photo" id="profile_photo">
    <img  style="float:left; margin-right:10px;" src="<?php echo BASE_URL ?>/images/uploadd.png" id="profilephoto"/>
