...
<html>
<head>
<title><?php echo getSiteTitle(); ?> :: Suppliers  <?php if(isset($_GET['token'])){ echo $row_scat->pc_name;} ?></title>
...
.cat_image{ width:100% !important; height:100% !important;}
...
<div class="q_hm1">
  ...
  <div class="a1 wd cl" align="left"> <!-- google_ad_section_start -->
    <p class="m2"></p>
    ...
    <div class="brdcrm">
      <ul>
        ...
        <!-- Groups end-->
        <li style="border:none;font-size:13px;color:#444; display:inline;"><?php if(isset($_GET['token'])){ echo $row_scat->pc_name; }?></li>
      </ul>
...
// letest $sql_comp="SELECT * FROM business_profile bf JOIN products p ON bf.bnsprof_uid = p.pd_uid JOIN product_category_arabyos pc ON p.pd_subcat_id =pc.pc_id JOIN plan_member_id pm ON pm.b_id = bf.bnsprof_id where pc_parent_id='".$row_scat->pc_id."'  and pm.expiry_date > ". time() ." and pc_status='1' ".$sql_pd_ck." and pd_status='1' GROUP BY pd_uid";
...
<?php 
            ...
            <img src="/upload/myproduct/thumb/<?php echo $row_comp->pd_image; ?>"    title="<?php echo $row_comp->pd_title; ?>" class="cat_image"></div></a>
			<br>
			...
			?>
             <div style="width:100px;">
            <a href="company/products.php?c=<?php echo rand(1000,9999).md5($row_comp->bnsprof_id);?>" target="_blank"><div class="cat_image_div"><img src="/images/noimage.jpg"  class="cat_image" title="<?php echo $row_comp->pd_title; ?>"></div></a>
			<br>
...
<div class="cat_image_div">
<img src="/upload/company_banner/<?php echo $row_result_banner_details->cb_image; ?>"  class="cat_image" title="<?php echo $row_comp->bnsprof_compname; ?>">
</div></a>
			<br>
  ...
  <?php } 
			...
			?>
             <div style="width:100px;">
          <a href="company/profile.php?c=<?php echo rand(1000,9999).md5($row_comp->bnsprof_id); ?>" target="_blank"><div class="cat_image_div"><img src="/images/noimage.jpg"  title="<?php echo $row_comp->bnsprof_compname; ?>" class="cat_image"></div></a>
			<br>
...
<?php
            ...
            <div class="cat_image_div"><img src="<?php echo $imageprofilepath; ?>" class="cat_image" title="<?php echo $abtrow->abtus_desc; ?>"></div> </a>
			<br>
			...
			?>
           <div style="width:100px;">
            <a <?php if(user_info($row_comp->bnsprof_uid,'bnsprof_compname')!=''){ ?>href="company/profile.php?c=<?php echo rand(1000,9999).md5($row_comp->bnsprof_id); ?>" <?php } ?> target="_blank"><div class="cat_image_div"><img src="/images/noimage.jpg"   title="<?php echo $abtrow->abtus_desc; ?>" class="cat_image"></div></a>
			<br>
			<span style="font-size:11px;color:#37366d ;font-weight:0px;"><?php echo substr($abtrow->abtus_desc, 0,35); ?></span>
            </div>
            <?php	
...
if(isset($_GET['keywords'])){
	...
	$sql_comp="SELECT * FROM business_profile bf JOIN products p ON bf.bnsprof_uid = p.pd_uid JOIN product_category_arabyos pc ON p.pd_subcat_id =pc.pc_id JOIN plan_member_id pm ON pm.b_id = bf.bnsprof_id where bnsprof_compname LIKE '%" . $newkw . "%' and pm.expiry_date > ". time() ." and pc_status='1' and pd_status='1' GROUP BY pd_uid ";
  ...
  <div class="wd6 z1 cr hide" id="hdiv"> <br>
