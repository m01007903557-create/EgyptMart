...
function list_photo()
{
	$.get("product-largeimg-list.php", {'pid' : <?php echo $pid; ?>}, 
	function(data){ 
...
function DelTempImage(pid)
{
   ...
   if(cnf==true)
   {
	$.get("product-largeimg-del.php", {pid:pid},
 	function(data){
	list_photo();
 	});	 
   }
...
<div id="buttons" onMouseOver="showImgButt();" onMouseOut="hideImgButt();">
 <img src="images/add-image-new.gif" style="cursor:pointer" width="125" height="125">
