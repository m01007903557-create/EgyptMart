    ...
    <div class="loader_img">
        ...
        <div class="popup-box">
            <div class="backg">
                ...
                <h2>New User? <a href="http://EgyptMART.online//create_account.php">Join Now!</a></h2>-->
                <?php if (isset($_SESSION['uid_indm']) && $_SESSION['uid_indm'] != '') {
                    ...
                    <p class="bp13 m12 j1">Welcome: <span
                                class="cr6"><?php echo user_info($uid, 'name_prefix') . "&nbsp;" . user_info($uid, 'fname'); ?></span><br><span><b
                                    class="bo1">Go to</b><a href="my-dashboard.php" style="text-decoration:none"> My Dashboard</a></span>
                    </p>
                <?php } else { ?>
                    <p class="bp13 m12 j1">Welcome to <?php echo getWebSiteName(); ?><br><span><b class="bo1">New User? &nbsp; </b><a
                                    href="create_account.php">Join Now!</a></span></p>
                <?php } ?>
                <img class="girl" src="leady.png"/>
                <div class="tab-main">
                    <div class="wrapper">
                        <ul class="top_btn_list">
                            <li>
                                <input id="radio1" class="radio_btn" name="tab" type="radio">
                                <label for="radio1" class="label_btn">For Buyers</label>
                                <div id="cont1" class="content_tab">
                                    ...
                                    <div class="text-box">
                                        ...
                                        <div class="text-box-right">
                                            <h2><a href="post-buy-req.php">Send Us Your Requirements</a></h2>
                                            <p>Receive responses and quotes from pre-verified
                                                and qualified suppliers.</p>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        <div class="text-box-left">
                                        ...
                                        <div class="text-box-right">
                                            <h2><a href="#" style="cursor:text">Find Anything For Your Business
                                                    Instantly.</a></h2>
                                            <p>Send enquires directly-to suppliers
                                                of your choice.</p>
                                            <form method="GET" name="searchForm2" action="search.php"
                                                ...
                                                <input size="24" class="m1 bl6" id="keywords_r" name="keywords"
                                                       type="text">
                                                <input value="Search" class="m1 fz1 ff1 m5" type="submit">
                                            </form>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        ...
                                        <div class="text-box-right">
                                            <h2><a href="manage-selloffer-alert.php">Manage Sell Offer Alerts</a></h2>
                            ...
                            <li>
                                ...
                                <label for="radio2" class="label_btn">For Suppliers</label>
                                <div id="cont2" class="content_tab">
                                    ...
                                    <div class="text-box">
                                        ...
                                        <div class="text-box-right">
                                            <h2><a href="create-free-website.php">Create your EgyptMART business
                                                    e-catalog!</a></h2>
                                            <p>Get business listing
                                                and promote your products / services to thousands of
                                                buyers worldwide.</p>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        ...
                                        <div class="text-box-right">
                                            <h2><a href="post-sell-offer.php">Start Locations Business!</a></h2>
                                            <p>Promote your business offers to your domestic city, country or abroad.</p>
                                        </div>
                                    </div>
                                    <div class="text-box">
                                        <div class="text-box-left">
                                        ...
                                        <div class="text-box-right">
                                            ...
                                            <p>Get relevent alerts on buyers
                                                requirements directly in your e-mail.</p>
                                        </div>
                                    </div>
                                    <div>
                                    </div>
        ...
        <div class="maincontainer">
            <div class="demobox">
                <div id="leftsection">
                    ...
                    <div class="video_slider mobile-slider " style="width:100%;padding-left:5px;margin:10px 0 0 0px;">
                        <div class="slider">
                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-12 list-top mobile-slider">
                        <h1>
                            <a href=#>
                ...
                <div class="col-xs-12" id="midcenter">
                    <div class="slider">
                        <div class="yahoo_slider" style="width:100%;">
                            ...
                            <div class="countrubox_top">
                                <div class="countrubox_heading global-page">
                                    <div class="global-icon-search">
                                        ...
                                        <h2><span> ARABIAN SUPPLIERS </span></h2>
                                    </div>
                                    <div class="search">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="country">
                                                        ...
                                                        <li><a href="#" onclick="setCountryLocation(116)"><img alt=""
                                                ...
                                                <li class="main-slick-wrapper-item">
                                                    ...
                                                    <div class="inner-main-wrapper">
                                                        <a class="slick-product-wrapper"
                                                           href="company/products.php?c=<?php echo rand(10, 9999) . md5($row_bprof->bnsprof_id); ?>&sc=<?php echo rand(10, 99999) . $row_prd->pd_subcat_id; ?>#<?php echo $row_prd->pd_id; ?>"
                                                           target="_blank" style="text-decoration:none;color:#000">
                                                            <div class="slick-product-image"><img
                                                                        alt="<?php echo ucwords(substr($row_prd->pd_title, 0, 28)); ?>"
                                                                        src="upload/myproduct/thumb/<?php echo $row_prd->pd_image; ?>"
                                                                ...
                                                                <div class="icon-pic-with-heading">
                                                                    <div class="icon_pic"><?php if (mysql_num_rows($get_icon) > 0) {
                                                                            ...
                                                                            ?><img alt=""
                                                                                   ...
                                                                                   style="width:18px;height:15px"><?php } else { ?>
                                                                            <img alt="" src="images/slider-icon01.jpg"
                                                                                 class="img-responsive"
                                                                                 title="JUNIOR"><?php } ?></div>
                                                            ...
                                                            <div class="icon-pic-with-heading">
                                                                <div class="icon_pic"><?php if (mysql_num_rows($get_icon) > 0) {
                                                                        ...
                                                                        <img alt="" src="images/slider-icon01.jpg"
                                                                             ...
                                                                             title="JUNIOR"><?php } ?></div>
                                                                <div class="ihover-wrapper">
                                                                    <h3 class="ihoves"><?php echo ucwords(substr($row_so->so_service, 0, 20)); ?><?php if (strlen($row_so->so_service) > 21) { ?>...<?php } ?></h3>
                                                                    <div class="auction_hover">
                    ...
                    <div class="booking"><a href="advertise-with-us.php"> Advertise Here Now for <span>FREE</span>
                            Kindly Contact Advertisements Team </a></div>
                    ...
                    <div class="demobox">
                        <div class="booking mobile-hide"><a href="advertise-with-us.php"> Advertise Here Now for <span>FREE</span>
                                Kindly Contact Advertisements Team </a></div>
                        <div class="clear"></div>
                        <div class="countrubox_top2">
                            <div class="countrubox_heading">
                                <div class="mainflagbox">
                                    <div class="membershipicon"><a href="membership_plans.php"><img alt=""
                                                                                                    src="images/membership-icon01.png"></a>
                                    </div>
                                    <div class="membershipicon"><a href="membership_plans.php"><img alt=""
                                                                                                    src="images/membership_icon02.png"></a>
                                    </div>
                                </div>
                            ...
                            <div class="list-rights">
                                <h2><a href="advertise-with-us.php" target="_blank"><span>Post</span> Premium Ads</a>
                                </h2>
                            </div>
                            <div class="clear"></div>
                        </div>
                                        ...
                                        if ($totalbaneer > 0) {
                                            ...
                                            <ul id="egyptmart-leading">
                                                ...
                                                while ($rowleading = mysqli_fetch_object($rsleading)) {
                                                    ...
                                                    <a class="slick-product-wrapper" href="<?php echo $adv_link; ?>"
                                                       target="_blank">
                                                        <div class="demobox">
                                                            <div class="slick-product-image">
                                                                <img alt=""
                                                                     src="upload/product_slider/<?php if ($pd_image != '') {
                                                                         echo $pd_image;
                                                                     } else {
                                                                         echo 'noimage.jpg';
                                                                     } ?>" class="black">
                                                            ...
                                                            <div class="matterbox">
                                                                ...
                                                                <div class="rightmatter">
                                                                    <p>
                                                                        <span class="nam"><?php echo $cn_name; ?></span><br>
                                                                    <p>MOQ: <span class="nam"><?php echo $adv_piece; ?>
                                                                            Pyeces</span><br>
                                                                    <p><?php //echo $cn_name;
                                                                        ?><span><ins><?php echo $adv_currency; ?></ins><?php echo $pd_fob_price; ?></span>/
                                                                        PIECES
                                                                    <div class="clear"></div>
                                                                </div>
                                                                <div class="clear"></div>
                    ...
                    <div class="demobox">
                        <div class="countrubox_top3">
                            <div class="countrubox_heading">
                                <div class="mainflagbox">
                                    <div class="membershipicon2"><a href="#"><img alt=""
                                                                                  src="images/membership_icon03.png"></a>
                                    </div>
                                </div>
                                <div class="countryheadingboxleft">
                                    <h3><a href="advertise-with-us.php"><span class="black-color">Loyal</span> Business
                                            Services</a></h3>
                                </div>
                            </div>
                            <div class="list-rights">
                                <h2><a href="product-sel-cat.php" target="_blank"><span>Post</span> Business
                                        Services</a></h2>
                            </div>
                            <div class="clear"></div>
                        </div>
                                                    ...
                                                    <a class="slick-product-wrapper" href="<?php echo $adv_link; ?>"
                                                       target=_blank>
                                                        <div class="demobox">
                                                            <div class="slick-product-image">
                                                                <img alt=""
                                                                     src="upload/service_slider/<?php if ($pd_image != '') {
                                                                         echo $pd_image;
                                                                     } else {
                                                                         echo 'noimage.jpg';
                                                                     } ?>" class="black" style="max-width:115px">
                                                            </div>
                                                            <div class="matterbox">
                                                                <div class="icon-pic-with-heading">
                                                                    <div class="icon_pic"><img alt=""
                    ...
                    <div class="demobox">
                        <div class="countrubox_top4">
                            ...
                            <div class="list-rights">
                                <h2><a href="contact_us.php"><span>Add</span> Your Logo</a></h2>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="white_bg">
                                    ...
                                    <div id="sponsors">
                                        ...
                                        if (mysqli_num_rows($rslogo) > 0) {
                                            while ($rowlogo = mysqli_fetch_object($rslogo)) {
                                                ...
                                                $adv_link = $rowlogo->adv_link;
                                                ?>
                                                <div><a href="<?php echo $adv_link; ?>" target=_blank><img alt=""
                    ...
                    <div class="bcg-sap_tabs">
                        ...
                        if ($cnt_br > 0) {
                            ...
                            <div class="bgc1 brd bx2">
                                ...
                                //echo $str;
                                ?>
                                <div class="rightnumber"><span
                                            class="number-count"><?php echo $str . $cnt_br1; ?></span><span
                                            class="off tic1"><?php echo $cnt_br1; ?></span></div>
                                <script>
                                    $(function () {
                                ...
                                <div class="buybox">
                                    ...
                                    while ($row_br = mysqli_fetch_object($res_br)) {
                                        ...
                                        <div class="popular-post-grid">
                                            <h3>
                                                <a href="buyleads-details.php?id=<?php echo rand(10, 9999) . md5($row_br->br_id); ?>"
                                                   target="_blank"><?php echo ucwords(stripslashes($row_br->br_pd_name)); ?></a>
                                            </h3>
                                            <div class="tendersbox">
                                                <div class="verifiedbox">
                                                    <div class="cover"><img alt="" src="images/tick.png"> Verified &
                                                        Updated
                                                    </div>
                                                    <div class="date"><?php if ($row_br->br_estimate_qty != '0' && $row_br->br_estimate_qty != '') { ?>
                                                            <b>Quantity
                                                                :</b><?php echo $row_br->br_estimate_qty; ?><?php echo measurement_unit($row_br->br_estimate_qty_unit); ?>(s).<?php } ?>
                                                    </div>
                                                </div>
                                                <div class="flagbox">
                                                    <?php
                                                    ...
                                                    <ul>
                                                        <li style="height:auto"><a
                                                                    href="#"><?php echo $contyname . " " . $flag2show; ?></a>
                                                    </ul>
                                    ...
                                    <?php } ?>
                                    <div class="learnmore">
                                        <p><a href="buyleads.php" target="_blank">All Live Buy
                            ...
                            <div id="horizontalTab" style="display:block;width:100%;margin:0;">
                                <ul class="resp-tabs-list">
                                    <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><a
                                                href="tenders.php"><span><b>Tenders</b></span></a>
                                    <li class=resp-tab-item aria-controls=tab_item-1 role=tab><a
                                                href=auctions.php><span><b>Auctions</b></span></a></li>
                                    <div class="clear"></div>
                                </ul>
                                <div class="resp-tabs-container">
                                    <div class="resp-tab-content tab-1" aria-labelledby="tab_item-0">
                                        ...
                                        if (mysqli_num_rows($rstender)) {
                                            ...
                                            while ($rowtender = mysqli_fetch_object($rstender)) {
                                                ...
                                                <li>
                                                    <div class="popular-post-grids">
                                                        <div class="popular-post-grid">
                                                            <h3>
                                                                <a href="tender-details.php?id=<?php echo rand(10, 9999) . md5($rowtender->tnd_id); ?>"
                                                                   target="_blank"><?php echo $tnd_heading; ?></a></h3>
                                                            <div class="tendersbox">
                                                                <div class="verifiedbox">
                                                                    <div class="cover"><img alt=""
                                                                                            src="images/tick.png">
                                                                        Verified & Updated
                                                                    </div>
                                                                    <div class="date"><b>Due
                                                                            Date: </b><?php echo $tnd_due_date; ?></div>
                                                                </div>
                                                                <div class="flagbox">
                                                                    <?php
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <a href="#"><?php echo $contyname . " " . $flag2show; ?></a>
                                                                    </ul>
                                                                    <div class="date"><span><?php
                                            ...
                                            <div class="clear"></div>
                                            <div class="learnmore">
                                                <p><a href="#">View all <a href="tenders.php">Tenders</a> / <a
                                                                href="auctions.php">Auctions</a></a>
                                            </div>
                                            <div class="tabbotton"><a href="#"><span>Publish</span> <a
                                                            href="post-tender.php">Tender</a>/</a> <a
                                                        href="post-auction.php">Auction</a> <span>FREE</span></div>
                                        <?php } ?>
                                    </div>
                                            ...
                                            while ($rowaution = mysqli_fetch_object($rstender)) {
                                                ...
                                                <li>
                                                    <div class="popular-post-grids">
                                                        <div class="popular-post-grid">
                                                            <h3>
                                                                <a href="auction-details.php?id=<?php echo rand(1000, 9999) . md5($rowaution->auc_id); ?>"
                                                                   target="_blank"><?php echo $tnd_heading; ?></a></h3>
                                                            <div class="tendersbox">
                                                                <div class="verifiedbox">
                                                                    <div class="cover"><img alt=""
                                                                    ...
                                                                    <div class="date"><b>Due
                                                                            Date: </b><?php echo $auc_due_date; ?></div>
                                                                </div>
                                                                <div class="flagbox">
                                                                    <?php
