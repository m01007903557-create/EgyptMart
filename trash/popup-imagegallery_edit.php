...
<a onclick="usePhotoToUpload('<?php echo $row_ph->ph_id; ?>');" style="cursor:pointer;"><img  src="upload/image_gallery/<?php echo $row_ph->ph_fileName; ?>" height="100" width="105px;" /><span class="tickmark">&#10004;</span></a>
</span>
<?php } ?>
</div>
 </span>
