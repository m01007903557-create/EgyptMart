...
function produtcustomcategory()
{
   ...
   $.post("ajax-file/produtcustomcategory.php",{'keywordsFilter':keywordsFilter,'type':'addTempAuctionAlertCat'},function(data){ $('#div1').append(data);})
}
...
function scatAddDel(id)
{
	if($('#scat_'+id).attr('checked')) {
		$.post("ajax-file/addTempAuctionAlertCat.php",{id:id},    function(data){	showList()	});
	} else {
		$.post("ajax-file/delTempAuctionAlertCat.php",{id:id},    function(data){	showList()	});
	}
}
function showList()
{
	$.post("ajax-file/showTempAuctionAlertCat.php",{},    function(data){	$("#div1").html(data);	});
}
function remove(id)
{
	$.post("ajax-file/delTempAuctionAlertCat.php",{id:id},    function(data){	showList()	});
...
<div style="background-color:#FFFFFF; height:670px" id="dvh2">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" >
    	<tbody>
        	<tr>
            <td bgcolor="#FAF4FF"><div class="myta">Manage Your Auction Preference</div></td>
            </tr>
		</tbody>
	</table>
...
<img src="images/zero.gif" height="8" width="1"><br> </div> </td></tr></tbody></table></div>
 ...
 <div id="search_cat" style="display: none; text-align: left;"> <table align="CENTER" border="0" cellpadding="0" cellspacing="0" width="99%"> <tbody><tr>
 <td valign="TOP"><img src="images/zero.gif" height="1" width="19"></td> <td bgcolor="#F8FCFF" valign="TOP" width="100%">
 <div class="border_bottom"><img src="images/zero.gif" height="5" width="1"><br>
 <div class="blwnew" style="padding-top:0px; margin-top:0px;"><b style="font-size:13px;"><font color="#E95801">
 Enter product keywords to find a category</font></b></div> <table border="0" cellpadding="0" cellspacing="0" width="525"> <tbody> <tr> <td>
 <input class="myims" class="txt ui-placeholder-input ui-autocomplete-input" name="keywordsFilter" id="keywordsFilter" maxlength="60" size="33" onsubmit="return ListOnChange1(this.form);"></td>
 <td style="cursor:pointer;"><input name="button5" value="Add Category" onclick="return produtcustomcategory();" type="button"></td> <td valign="BOTTOM"> <div class="blw1">For example: "arm chair" or "furniture"</div> <img src="images/zero.gif" height="1" width="240"></td> </tr></tbody> </table> <img src="images/zero.gif" height="5" width="1"><br> <div style="height:326px;"> <div id="s_result" style="display:none;"> <div class="s_text"> <div style="height:298px; overflow:auto;">
 <span id="head"></span><span id="ajax"></span></div> <img src="images/zero.gif" height="8" width="1">
 ...
 <input name="confirm1" id="addSOCatBtn" value="Submit Categories" onclick="addAlertCategory();" type="button">
