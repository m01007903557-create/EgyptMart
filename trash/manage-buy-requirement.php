...
.tabTextColor{color:#fff;}
	...
	<form style="margin:0px;" action="" name="form1">
		...
		?>
        	<a class="f1 ap2 tabTextColor" onclick="showOpenReq(1);" style="cursor:pointer;" id="opnReq_tab">Open Requirements  (<?php echo $row_opn->cnt; ?>)</a>
            <a class="f1 npo m5" onclick="showClosedReq(1);" style="cursor:pointer;" id="clsReq_tab">Closed Requirements (<?php echo $row_cls->cnt; ?>)</a>
