...
<html xmlns="http://www.w3.org/1999/xhtml" class="product-add-html">
    <head>
        ...
        var url = 'http://egyptmat.online/server/php/';
        ...
        pd_unit.focus();
        valid = false;
        }else if (default_image == ' upload/myproduct/add-image-eng.gif' || default_image == 'upload/myproduct/add-image-eng.gif'){
        ...
        {
        message = "من فضلك أدخل سعر بيع المنتج جملة أو تصدير";
        pd_fob_price.value = '';
        pd_fob_price.focus();
        valid = false;
        } else if (isNaN(pd_fob_price.value))
        {
        message = "من فضلك أدخل سعر صالح لبيع المنتج جملة أو تصدير";
        pd_fob_price.value = '';
        pd_fob_price.focus();
        valid = false;
        ...
        $.post("ajax-file/save-sellofer.php",{
            cat_id: pd_subcat_id.value
        },function(data){
            console.log(data);
        });
        $.post("ajax-file/productAdd.php", {pd_subcat_id: pd_subcat_id.value, pd_title: pd_title.value, pd_status: pd_status, pd_code: pd_code.value, pd_desc: pd_desc.value, uid: uid.value, pd_min_order_qty: pd_min_order_qty.value, pd_unit: pd_unit.value, pd_fob_price: pd_fob_price.value, pd_fob_price2: pd_fob_price2.value, pd_currency: pd_currency.value, pd_preferred_buyer_location: pd_preferred_buyer_location,pd_brand:pd_brand_name,pd_payment:pd_payment,pd_pod:pd_pod,pd_pn_capct:pd_pn_capct,pd_dlv_time:pd_dlv_time,pd_pck_dets:pd_pck_dets}, function (data) {
        data = data.trim();
        dt = data.split("|")
        if (dt[0] == '0')
        {
        ...
        {
            //$("[id^=t1]").removeClass('tab-sel f1 fw');
        ...
        function showmedit() 
        {
            //$("[id^=t3]").removeClass('tab-sel f1 fw');
    ...
    <body class="add-product">
        ...
        <div class="hm1 bbc" id="res-mob1">
            ...
            <div class="w56b f1 p2b p14 blr"><div class="mt5"><h1 style="margin-top:-5px !important;padding-bottom:5px;"title="إعرض منتج جديد "> Post New Product  </h1>
                ...
                <div class="tab_2">
                    <span id="t1" class="tab-sel f1 fw"><a onclick="showmedit();"title=" إعرض منتج جديد ">Post Product</a></span>
                    <span id="t3" class="tab_p1 f1"><a onclick="showadditional();"title=" تفاصيل إضافية للمنتج ">Additional Details </a></span>
                ...
                <div class="apfc" id="bafrm" style="border: 1px solid #ffffff;">
                    ...
                    <div class="pia f1">
                        ...
                        <div id="img_disp" class="cssie1 mover">
                            ...
                            <img src="upload/myproduct/add-image-eng.gif" title="حمل هنا - الصورة الرئيسية للمنتج - من جهاز الكمبيوتر - أو من جاليرى الموقع"style="width:125px;height:125px;margin-top:1px;margin-left:1px;" />
                        </div>
                        <div>
                        ...
                        <div class="add_color_page">
                            ...
                            <a class="ajax add_color_page_a" href="popup-imagegallery.php" style="text-decoration:none;" title="حمل من صور الجاليرى    "> Add Image <br/>From Gallery </a>
                        </div>
                        ...
                        <div id="imglogo_disps" class="cssie1 mover" style="position: relative;">
                            <img src="upload/myproduct/logo_upload_eng.jpg" title="يمكنك إضافة صورة صغيرة - إختيارى -  تظهر على أسفل يسار الصورة الأصلية - مثل لوجو أو علامة أو عرض خاص " style="width:125px;height:125px;margin-top:1px;margin-left:1px;">
                            <div id="imglogo_disp" class="cssie1 mover" style="width: 43px;    height: 46px;left: 4px;bottom: 30px;position: absolute;">
                        ...
                        <div class="add_color_page">
                            ...
                            <a class="ajaxa add_color_page_a" href="popup-imagegallery-logo.php" style="text-decoration:none;" title="حمل من صور الجاليرى  ">Add Image <br/>From Gallery  </a>
                        </div>
                        <div id="remove_image" class="dn mt5">
                            <a href="javascript:remove_small_image('add');"><img src="images/remove.gif" align="absmiddle" width="44" height="10"></a>
                        </div>
                        ...
                        <form action="" method="POST" id="add_new" name="add_new" enctype="multipart/form-data">
                            <div class="fside f1">
                                ...
                                <div class="fs1 f1" style="width: 50% !important;"title="أكتب عنوان المنتج  باللغة العربية أو الإنجليزية حسب مكان البيع ">
                                    <p><span style="line-height: 12px;">*</span> Product Title / Headline  </p>
                                    <input name="pd_title" id="pd_title" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_title; ?>">
                                    <span></span>
                                </div>
                                <div class="fs2 f1" style="width: 50% !important;"title="أكتب كود المنتج ">
                            ...
                            <div class="fs2 f1" style="width: 50% !important;"title="Minimum Quantity ">
                                    <p><span style="line-height: 12px;">*</span> Minimum Quantity</p>
                                ...
                                <div class="fs2 f1" style="width: 50% !important;">
                                    ...
                                    <select size="1" name="pd_unit" id="pd_unit" class="a_f s_u"title=" إختار وحدة قياس المنتج ">
                                        ...
                                        <?php
                                        $unitsql = mysql_query("select * from measurement_unit_arabyos where mu_status='1'");
                                ...
                                <div class="fs1 f1">
                                    <div class="form-fs1-f1"title="  FOB / WholeSale Price ">
                                        <p><span style="line-height: 12px;"></span> : WholeSale / Fob Price  </p>
                                        <div class="from-f1-fs1"title=" From "><span>From :</span> <input name="pd_fob_price" id="pd_fob_price" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price; ?>"></div>
                                        <!--      <div class="to-f1-fs2"title=" الى "> <span> To  </span> <input name="pd_fob_price2" id="pd_fob_price2" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price2; ?>"></div>
                                        <
                                        <span></span>-->
                                    </div>
                                    <div class="fs1 f1"  style="width: 33.3% !important;">
                                        <!--                                                                            <p><span style="line-height: 12px;">*</span> FOB / WholeSale Price</p>
                                        <div class="from-f1-fs1"><span>  From :</span> <input name="pd_fob_price" id="pd_fob_price" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price; ?>"></div>-->
                                        <div class="to-f1-fs2" title=" الى "> <span> To :</span> <input name="pd_fob_price2" id="pd_fob_price2" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price2; ?>"></div>
                                        <span></span>
                                    </div>
                                ...
                                <!--                                                                        <div class="fs1 f1"  style="width: 50% !important;">
                                    <p><span style="line-height: 12px;">*</span> FOB / WholeSale Price</p>
                                    <div class="from-f1-fs1"><span>From :</span> <input name="pd_fob_price" id="pd_fob_price" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price; ?>"></div>
                                    <div class="to-f1-fs2"> <span> To :</span> <input name="pd_fob_price2" id="pd_fob_price2" maxlength="60" class="a_f pf1" type="text" value="<?php echo $pd_fob_price2; ?>"></div>
                                    <span>Please enter the FOB / WholeSale Price here.</span>
                                </div>-->
                                <!--                                                                        <div class="fs2 f1"  style="width: 50% !important;">
                                    <p>&nbsp;</p>
                                    <select size="1" name="pd_currency" id="pd_currency" class="a_f s_u">
                                ...
                                <div class="fs1 f1" style="padding-top:4px; width: 50% !important;float: left;"title="Location Preferences">
                                    <p><span style="line-height: 12px;">*</span> Select Sell Location  </p>
                                    <div style="vertical-align:middle">
                                        <input type="radio" id="pd_preferred_buyer_location_1" name="pd_preferred_buyer_location" value="abroad" /><label style="top:0px;"title=" هذا المنتج للبيع خارج بلدك فقط ">Abroad Only</label>
                                    </div>
                                    <div>
                                        <input type="radio" id="pd_preferred_buyer_location_2" name="pd_preferred_buyer_location" value="any" checked="checked"/><label style="top:0px;"title=" هذا المنتج للتصدير أو للبيع الداخلى فى بلدك  ">Abroad + Domestic </label>
                                    </div>
                                    <div>
                                        <input type="radio" id="pd_preferred_buyer_location_3" name="pd_preferred_buyer_location" value="domestic"/><label style="top:0px;"title="هذا المنتج للبيع داخل بلدى فقط "> Domestic Only  </label>
                                    </div>
                                    <div>
                                        <input type="radio" id="pd_preferred_buyer_location_4" name="pd_preferred_buyer_location" value="my_city"/><label style="top:0px;"title="هذا المنتج للبيع داخل مدينتى فقط  "> My City Only  </label>
                                    </div>
                                </div>
                                ...
                                <div id="div_save">
                                    <input name="btnSubmit" id="btnSubmit" class="c3 f2 saps mt12 mtt" style="margin-top:-35px;margin-right:-1px; -webkit-margin-before:-33px;*margin-top:-35px;margin-top:-33px\9;color:#fff;"title="Add Product" value="Submit Product" type="button" onclick="additem2();" />
                                </div>
                ...
                <!-- webcast additional div start -->
<div id="addef" class="p-irt" style="overflow: hidden; display: none;border: 1px solid #ffffff;background-color: #FAF4FF;">
    <p class="bulb"title="تسجيل  تفاصيل إضافية  لمنتجك تساعد على كسب رؤية أكبر تجذب المشتريين ">Additional product details help your product listing gains more visibility to interested buyers</p>
    <p class="b-img arp1 pdb1 f1" href="JavaScript:;"title="تفاصيل المنتج الإضافية  ">Additional Details</p>
    <div class="c3"></div>
    <div id="abc"></div>
    ...
    <div style="display:none;" id="adfrm">
        <form method="post" name="additional_details">
            <div class="pad f1 mr">
                <ul>
                    <li class="f1 tc adtp"title="إسم ماركة المنتج المعروفة">Product Brand Name</li>
                    <li class="f1 pct pbi tc1">
                        <input name="pd_brand_name" id="pd_brand_name" maxlength="255" value="" class="a_f adt form-control" type="text">
                    </li>
                    <li class="f1 tc adtp"title=" طريقـة الدفـع ">Payment Terms</li>
                      <!-- <li class="f1 pct pbi tc1">
                      <?php
                    ...
                    <li class="f1 tc adtp"title="مكان أو ميناء التسليم ">Port of Dispatch</li>
                    <li class="f1 pct">
                        <input class="a_f adt form-control" name="pd_pod" id="pd_pod" maxlength="100" value="" type="text">
                    </li>
                    <li class="f1 tc adtp"title=" معدل الانتاج "> Production Capacity </li>
                    <li class="f1 pct">
                        <input name="pd_pn_capct" id="pd_pn_capct" maxlength="100" value="" class="a_f adt form-control" type="text">
                    </li>
                    <li class="f1 tc adtp"title="موعد  التسليم ">Delivery Time </li>
                    <li class="f1 pct">
                        <input class="a_f adt form-control" name="pd_dlv_time" id="pd_dlv_time" maxlength="100" value="" type="text">
                    </li>
                    <li class="f1 tc adtp"title=" طريقة التعبئة والتغليف  ">Packing Details </li>
                    <li class="f1 pct">
                        <textarea rows="5" class="a_f form-control" name="pd_pck_dets" id="pd_pck_dets" onkeyup="packdetcount();"></textarea>
                        <font id="Charcount1" color="#ff8000"><span id="pckdet">20</span> character (maximum of 2000)</font> character(s).
                    </li>
                    <!--<li class="f1 tc adtp"title=" إرفق بروشور للمنتج  ">Attach PDF Brochure</li>
                    <li class="f1 pct1 mt5">
                        <iframe src="upload-prd-doc.php" border="0" framespacing="0" allowtransparency="true" scrolling="no" width="269" frameborder="0" height="30">
                        </iframe>
                        ...
                        <li>
                            <input name="updateaddi" class="saps awt mt12 m5"title=" Save Details" value="Save Changes" type="button" onclick="additem2();">
                            <span style="display:none;" id="adsaving"> <img alt="" src="editproduct-step1_files/loading.gif" border="0" width="16" height="11"></span>
                            <input name="cancleaddi" class="saps mt12 ml8" value="Cancel" id="adcls" type="button" onclick="showmedit();">
                        </li>
                    </ul>
                </div>
            </form>
