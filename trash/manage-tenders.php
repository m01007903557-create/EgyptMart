...
function showTenders(page)
{
	...
	$.post("ajax-file/showTenders.php",{page:page},    function(data){ $('#res').html(data); });
}
...
<!-- Header End Here::-->
	...
	<ul id="ulid" class="nln1" style="margin: 0px; padding: 0px;">
		<li><h3 style="font-size: 16px;font-weight: bold; color:#000; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;">Tender Tools</h3></li>

		<li class="np npnew"><a href="post-tender.php">»&nbsp;Post a Tender</a></li>
        <li class="np npnew"><a class="leftindi txtcol" href="manage-tenders.php">»&nbsp;Manage Tenders</a></li>
		...
		<li class="np npnew"><a href="tenders.php">View Latest Tenders</a></li>
		<li class="np npnew"><a href="manage-purchased-tenders.php">View Purchased Tenders</a></li>
	</ul>
	</div>
		<!--left navigation:ends-->
        
        <div class="mctr_buyreq mfl" id="req_listing" style="width: 68% !important;"><!--style="width:98%;"-->
...
.tabTextColor{color:#fff;}
	...
	<form style="margin:0px;" action="" name="form1">
        ...
        <table align="CENTER" border="0" cellpadding="0" cellspacing="0" style="min-width:100%">
          <tbody><tr>
            <td valign="TOP" width="100%">
		<div class="wd1 mf18 mc5 mta2 mpb10"><div class="mf11 bc mbl mbn"></div>Manage Tenders</div>
