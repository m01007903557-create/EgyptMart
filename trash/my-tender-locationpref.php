...
class editPreference
{
	...
	{		
		$sql="update user
			set					
				usr_tnd_prefLocation ='".$this->usr_tnd_prefLocation."'
			where
				usr_id='".$this->usr_id."'";
...
if(isset($_POST['btnUpdate']))
{
	...
	$obj_pref->usr_tnd_prefLocation=addslashes(trim($_POST['usr_tnd_prefLocation']));
...
<!-- Header start Here::-->
		...
		<li><h3 style="font-size: 16px;font-weight: bold; color:#000; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;">Tenders </h3></li> 
 			<li style="border-bottom:none"><h3>Tender Purchases</h3></li>
			<li class="np npnew"><a href="manage-purchased-tenders.php">»&nbsp;Purchased Tenders</a></li>
   			<li class="np npnew"><a href="manage-tender-alert.php">»&nbsp;Tender Alerts</a></li>
            <li class="np npnew"><a class="leftindi txtcol" href="my-tender-locationpref.php">»&nbsp;Location Preference</a></li>
			...
			<li class="np npnew"><a href="help.php">»&nbsp;Tender Help / FAQs?</a></li>
            <li class="ug-banner">
...
<?php	}	?>
    ...
    <td valign="bottom"><div class="manage_country mb"><a href="manage-tender-alert.php">Manage Your Tender Preferences</a></div></td>
    </tr> </tbody></table>
...
<td id="prf_main" style="margin-right: 0px; *padding-top:0px" valign="top">
    ...
    <div style="font-size:24px; font-weight:bold;font-family:arial; width:98%;color:#fff; background:#024ca7; padding:10px 17px 5px 5px;margin-bottom:15px;text-transform:uppercase;border:solid 1px #024ca7; margin-right:0px;" class="boxbg bgi1">I want Tenders from </div>
    
    
	<div onmouseover="change_bg(1)" onmouseout="remove_bg(1)" style="margin-right:0px;" id="box_1" class="boxbg boxbg1 <?php if($row_usr_lpref->usr_tnd_prefLocation=='any'){ ?>bgi1<?php } ?>" onclick="location_prf(1)">
		<label for="locationid_1"  id="label_1"><!--class="r_on"-->
        	<input name="usr_tnd_prefLocation" value="any" id="usr_tnd_prefLocation_1" <?php if($row_usr_lpref->usr_tnd_prefLocation=='any'){ ?>checked="checked"<?php } ?> type="radio">
			...
			<div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:2px;">Selecting this option would mean you will receive tenders from all over the world including Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?> and Foreign. 
				<br>
    ...
    <div onmouseover="change_bg(2)" onmouseout="remove_bg(2)" onclick="location_prf(2)" id="box_2 " class="boxbg1 <?php if($row_usr_lpref->usr_tnd_prefLocation=='abroad'){ ?>bgi1<?php } ?>" style="float:left; width:32%; margin-right:12px;height:120px">
		<label for="locationid_2" id="label_2"><!--class="label_radio"-->
        	<input name="usr_tnd_prefLocation" value="abroad" id="usr_tnd_prefLocation_2" <?php if($row_usr_lpref->usr_tnd_prefLocation=='abroad'){ ?>checked="checked"<?php } ?> type="radio">
            ...
            <div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:4px;">
				...
				<div class="mpt3 mf12 mc2 mlh16" style="line-height:14px">
			   	&bull; No Tender from Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?> <br><img src="images/zero.gif" height="6" width="1"><br>
				&bull; No Tender from Your City
                </div>
			</div>
		</label>
	</div>

	<div onmouseover="change_bg(3)" onmouseout="remove_bg(3)" id="box_3" style="float:left; width:32%; margin-right:12px;height:120px" class="boxbg1 <?php if($row_usr_lpref->usr_tnd_prefLocation=='domestic'){ ?>bgi1<?php } ?>" onclick="location_prf(3)">
		<label for="locationid_3"  id="label_3"><!--class="label_radio"-->
        	<input name="usr_tnd_prefLocation" id="usr_tnd_prefLocation_3" value="domestic" <?php if($row_usr_lpref->usr_tnd_prefLocation=='domestic'){ ?>checked="checked"<?php } ?> type="radio">
			...
			<div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:4px;">
            	...
            	<br>
				<div class="mpt3 mf12 mc2 mlh16" style="line-height:14px">
                &bull; No Tender from Outside Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?><br><img src="images/zero.gif" height="6" width="1"><br>
    ...
    <div onmouseover="change_bg(4)" onmouseout="remove_bg(4)" id="box_4" style="float:left; width:32%; margin-right:0px;height:120px" class="boxbg1 <?php if($row_usr_lpref->usr_tnd_prefLocation=='my_city'){ ?>bgi1<?php } ?>" onclick="location_prf(4)">
		<label for="locationid_4" id="label_4"><!--class="label_radio"-->
        	<input name="usr_tnd_prefLocation" id="usr_tnd_prefLocation_4" value="my_city" <?php if($row_usr_lpref->usr_tnd_prefLocation=='my_city'){ ?>checked="checked"<?php } ?> type="radio">
			...
			<div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:4px;">
				...
				<div class="mpt3 mf12 mc2 mlh16" style="line-height:14px">
                &bull; No Tender Outside 250 KM of Your City<br>
                <img src="images/zero.gif" height="6" width="1"><br>
                &bull; No Tender from Outside Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?>
                </div>
			</div>
		</label>
	</div>
