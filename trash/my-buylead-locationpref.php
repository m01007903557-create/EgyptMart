...
class editPreference
{
	...
	{		
		$sql="update user
			set					
				usr_br_prefLocation ='".$this->usr_br_prefLocation."'
			where
				usr_id='".$this->usr_id."'";
...
if(isset($_POST['btnUpdate']))
{
	...
	$obj_pref->usr_br_prefLocation=addslashes(trim($_POST['usr_br_prefLocation']));
...
<!-- Header start Here::-->
		...
		<li><h3 style="font-size: 16px;font-weight: bold; color:#000; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;">Buy Leads </h3></li> 
			...
			<li class="np npnew"><a href="manage-purchased-buyleads.php">»&nbsp;Purchased Buy Leads</a></li>
   			<li class="np npnew"><a href="manage-buylead-alert.php">»&nbsp;Buy Lead Alerts</a></li>
            <li class="np npnew"><a class="leftindi txtcol" href="my-buylead-locationpref.php">»&nbsp;Location Preference</a></li>
...
<?php	}	?>
    ...
    <table style="table-layout:fixed;width:100%" align="CENTER" border="0" cellpadding="0" cellspacing="0"> <tbody> <tr> <td style="border-right:0px; padding-right:10px" valign="top" width="100%"> <table style="table-layout:fixed;width:100%" align="CENTER" border="0" cellpadding="0" cellspacing="0" width="100%"> <tbody><tr> <td align="LEFT" height="38" valign="TOP" width="325"><img src="images/zero.gif" height="4" width="1"> <br> <nobr><div class="mf18 mc5 mta2 mpr8 mpt10"title="حدد وتحكم - فى أماكن - إشعارات طلبات الشراء الجاهزة - التى تحتاجها"> <!-- <DIV class="mf11 bc mbn">Alerts &amp; Newsletters &#187</DIV> --> Location Preferences </div></nobr></td> <td valign="bottom">
    </td>
    <td valign="bottom"><div class="manage_country mb"title="حدد وتحكم - فى إشعارات طلبات البيع الجاهزة  - التى تحتاجها   "><a href="manage-buylead-alert.php">Manage Your Buylead Preferences</a></div></td>
    </tr> </tbody></table>
...
<td id="prf_main" style="margin-right: 0px; *padding-top:0px" valign="top">
    ...
    <div style="font-size:24px; font-weight:bold;font-family:arial; width:98%;color:#fff; background:#024ca7; padding:10px 17px 5px 5px;margin-bottom:15px;text-transform:uppercase;border:solid 1px #024ca7; margin-right:0px;" class="boxbg bgi1"title=" أريد - طلبات شراء جاهزة - من الأماكن التالية  " >I want Buyers from : 
         من الأماكن التالية - طلبات شراء جاهزة - أريد </div>
    
    
	<div onmouseover="change_bg(1)" onmouseout="remove_bg(1)" style="margin-right:0px;" id="box_1" class="boxbg boxbg1 <?php if($row_usr_lpref->usr_br_prefLocation=='any'){ ?>bgi1<?php } ?>" onclick="location_prf(1)">
		<label for="locationid_1"  id="label_1"><!--class="r_on"-->
        	<input name="usr_br_prefLocation" value="any" id="usr_br_prefLocation_1" <?php if($row_usr_lpref->usr_br_prefLocation=='any'){ ?>checked="checked"<?php } ?> type="radio">
			<span class="fs18 lc4 fwb"title="أريد - طلبات شراء جاهزة - لأصنافى التى حددتها - من جميع أنحاء العالم - من الداخل والخارج ">All Over the World (My City + My Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?> + Export)</span> 
			<div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:2px;">Selecting this option would mean you will receive buyers from all over the world including Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?> and Foreign. 
				<br>
    ...
    <div onmouseover="change_bg(2)" onmouseout="remove_bg(2)" onclick="location_prf(2)" id="box_2 " class="boxbg1 <?php if($row_usr_lpref->usr_br_prefLocation=='abroad'){ ?>bgi1<?php } ?>" style="float:left; width:32%; margin-right:12px;height:120px">
		<label for="locationid_2" id="label_2"><!--class="label_radio"-->
        	<input name="usr_br_prefLocation" value="abroad" id="usr_br_prefLocation_2" <?php if($row_usr_lpref->usr_br_prefLocation=='abroad'){ ?>checked="checked"<?php } ?> type="radio">
            <span class="fs18 lc4 fwb"title=" أريد - طلبات شراء جاهزة - لأصنافى التى حددتها - من الخارج فقط - للتصدير ">Foreign Only <br><span style="padding-left:30px">(Export Only)</span></span>
            <div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:4px;">
				...
				<div class="mpt3 mf12 mc2 mlh16" style="line-height:14px">
			   	&bull; No Buyer from Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?> <br><img src="images/zero.gif" height="6" width="1"><br>
				&bull; No Buyer from Your City
                </div>
			</div>
		</label>
	</div>

	<div onmouseover="change_bg(3)" onmouseout="remove_bg(3)" id="box_3" style="float:left; width:32%; margin-right:12px;height:120px" class="boxbg1 <?php if($row_usr_lpref->usr_br_prefLocation=='domestic'){ ?>bgi1<?php } ?>" onclick="location_prf(3)">
		<label for="locationid_3"  id="label_3"><!--class="label_radio"-->
        	<input name="usr_br_prefLocation" id="usr_br_prefLocation_3" value="domestic" <?php if($row_usr_lpref->usr_br_prefLocation=='domestic'){ ?>checked="checked"<?php } ?> type="radio">
            <span class="fs18 lc4 fwb"title=" أريد - طلبات شراء جاهزة - لأصنافى التى حددتها - من داخل بلدى فقط "><?php /*echo get_country_name($row_usr_lpref->country);*/ ?>My Country Only <br><span style="padding-left:30px">(Domestic Only)</span></span>
			<div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:4px;">
            	Selecting this option would mean:
            	<br>
				<div class="mpt3 mf12 mc2 mlh16" style="line-height:14px">
                &bull; No Buyer from Outside Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?><br><img src="images/zero.gif" height="6" width="1"><br>
    ...
    <div onmouseover="change_bg(4)" onmouseout="remove_bg(4)" id="box_4" style="float:left; width:32%; margin-right:0px;height:120px" class="boxbg1 <?php if($row_usr_lpref->usr_br_prefLocation=='my_city'){ ?>bgi1<?php } ?>" onclick="location_prf(4)">
		<label for="locationid_4" id="label_4"><!--class="label_radio"-->
        	<input name="usr_br_prefLocation" id="usr_br_prefLocation_4" value="my_city" <?php if($row_usr_lpref->usr_br_prefLocation=='my_city'){ ?>checked="checked"<?php } ?> type="radio">
            <span class="fs18 lc4 fwb"title=" أريد - طلبات شراء جاهزة - لأصنافى التى حددتها - من داخل مدينتى - والمدن القريبة المحيطه فقط ">Local Area Only<br><span style="padding-left:30px">(My City &amp; its 250 KM)</span></span>
			<div class="pdl20 mrgn lc5" style="line-height:17px;padding-top:4px;">
            	Selecting this option would mean:<br>
				<div class="mpt3 mf12 mc2 mlh16" style="line-height:14px">
                &bull; No Buyer Outside 250 KM of Your City<br>
                <img src="images/zero.gif" height="6" width="1"><br>
                &bull; No Buyer from Outside Your Country<?php /*echo get_country_name($row_usr_lpref->country);*/ ?>
                </div>
			</div>
		</label>
	</div>
  ...
  <table style="border-collapse: collapse; margin-top: 10px; clear:both" border="1" bordercolor="#007af4" cellpadding="5" cellspacing="0" align="center">
    <tbody>
      <tr>
        <td style="padding: 8px;" bgcolor="#9fcfff"title="إحفظ - تعديلات - أماكن طلب طلبات الشراء الجاهزة ">  <input name="btnUpdate" value="Save Changes" style="padding: 3px 8px; font-size: 18px;" type="SUBMIT">  </td>
        </tr>
      </tbody>
    </table>
