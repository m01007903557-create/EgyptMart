  ...
  <div class="a1 wp cl" align="left"> <!-- google_ad_section_start -->
   ...
   <!-- <p class="bo b2 p4 f1 lht"></p>-->
	...
	<div class="middle-part">
		...
		<button type="button" class="btn btn-default border-radius-0  txt-bold bold-xs btn-white text-capitalize <?php echo $pc_id; ?>" style="border-top:2px solid #ff7519 !important;border:0px;">Suppliers</button>

		<button type="button" class="btn btn-default border-radius-0  txt-bold bold-xs btn-white text-capitalize "><a href="products.php?c=<?php echo md5($category_p_id); ?>" style="color:#000;" target="_new">Products</a></button>
...
<div class="col-md-1" style="width:4%">
 <?php if($rowMem->mst_icon!='') { ?>
			...
			<span class="city-country"><?php echo $row_comp->bnsprof_compname; ?></a><br>
...
<?php 
			...
			?>
            <a href="company/products.php?c=<?php echo rand(1000,9999).md5($row_comp->bnsprof_id);?>" target="_blank"><img src="/upload/myproduct/thumb/<?php echo $row_comp->pd_image; ?>" height="100" width="100"   title="<?php echo $row_comp->pd_title; ?>" style="border: 1px solid lightgray;"></a>
			<br>
...
<a href="company/profile.php?c=<?php echo rand(1000,9999).md5($row_comp->bnsprof_id); ?>" target="_blank"><img src="/upload/company_banner/<?php echo $row_result_banner_details->cb_image; ?>" height="100" width="100" title="<?php echo $row_comp->bnsprof_compname; ?>"></a>
			<br>
...
<?php
			...
			?>
            <a <?php if(user_info($row_comp->bnsprof_uid,'bnsprof_compname')!=''){ ?>href="company/profile.php?c=<?php echo rand(1000,9999).md5($row_comp->bnsprof_id); ?>" <?php } ?> target="_blank"><img src="<?php echo $imageprofilepath; ?>" height="100" width="100" title="<?php echo $abtrow->abtus_desc; ?>" style="border: 1px solid lightgray;"> </a>
			<br>
