...
function produtcustomcategory(){
   ...
   $.post("ajax-file/produtcustomcategory.php",{'keywordsFilter':keywordsFilter},function(data){ $('#div1').append(data);})
}
...
<div style="background-color:#FFFFFF; height:670px" id="dvh2">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" >
    	<tbody>
        	<tr>
            <td bgcolor="#FAF4FF"><div class="myta">Manage your Sell Offer Alerts</div></td>
            </tr>
		</tbody>
	</table>
...
$sql = "SELECT p3.`pc_name` as `Grandparent name`, p2.`pc_name` as `Parent name`, p1.pd_title
FROM products  p1
LEFT JOIN product_category_arabyos p2 on p1.`pd_subcat_id` = p2.`pc_id`
LEFT JOIN product_category_arabyos p3 on p2.`pc_parent_id` = p3.`pc_id`";
 ?>



 <?php
$sql_mcat="select pc_id,pc_name from product_category_arabyos where pc_parent_id = '0' and pc_status = '1' ".$sql_order;
$res_mcat=mysql_query($sql_mcat);
 ...
 <?php while($row_mcat=mysql_fetch_object($res_mcat)){ ?>
 <option value="<?php echo $row_mcat->pc_id; ?>"><?php echo $row_mcat->pc_name; ?></option>
 <?php	}	?>
 </select>
 </span>
</td>
...
<img src="images/zero.gif" height="8" width="1"><br> </div> </td></tr></tbody></table></div>
 ...
 <div id="search_cat" style="display: none; text-align: left;">
  ...
  <font color="#E95801">Enter product keywords to find a category</font></b>
  </div>
  <table border="0" cellpadding="0" cellspacing="0" width="525">
  <tbody>
  <tr>
   <td>
   <input value="" role="textbox" class="txt ui-placeholder-input ui-autocomplete-input" name="keywordsFilter" id="keywordsFilter" placeholder="Enter product / service to search">

   </td>
   <td style="cursor:pointer;">
   <input type="button" value="Add To Sell Offer Alerts" onclick="produtcustomcategory();" class="pbr" style="cursor: pointer;">
   </td>
   <td valign="BOTTOM">
   <div class="blw1">For example: "arm chair" or "furniture"</div> <img src="images/zero.gif" height="1" width="240"></td> </tr></tbody> </table> <img src="images/zero.gif" height="5" width="1"><br> <div style="height:326px;"> <div id="s_result" style="display:none;"> <div class="s_text"> <div style="height:298px; overflow:auto;"> <span id="head"></span><span id="ajax"></span></div> <img src="images/zero.gif" height="8" width="1"> </div> </div> </div> </div>  </td> </tr> </tbody></table></div>
