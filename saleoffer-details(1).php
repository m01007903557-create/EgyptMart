<?php
/**
 * File: saleoffer-details.php
 * Description: عرض تفاصيل عرض البيع مع إمكانية التواصل مع المورد
                ...
                <div style="position:relative;" id="rtmain1">
                    <div class="rit_ar">
                        <div id="topref" style="_position:static !important">
                            ...
                            <?php if (isset($_SESSION['uid_indm']) && !empty($mobile1) && $mobile1 != '0'): ?>
                            <p class="mt2 ml27 cn_cl">
                                <span class="sbg ph a1"></span>
                                <span itemprop="telephone">
                                    +(<?php echo $country_ph_code; ?>)-<?php echo $mobile1; ?>
                                </span>
                            </p>
                            <?php endif; ?>
