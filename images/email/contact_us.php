        	...
        	<repeater>
                <layout label="Text only">
                    <table class="" border="0" cellpadding="0" cellspacing="0" width="580">
                        <tbody><tr>
                           <td class="" width="580">
                               <p style="font-size: 14px; line-height:24px; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif;" align="left"><singleline label="Title">Dear '.$this->cu_fname.' '.$this->cu_lname.',</singleline></p>
							   <p></p>
							   ...
							   <singleline label="Title">Thanks for visiting our website and filling up the Contact Us form. We will contact you shortly.</singleline>
							   </p>
								   <p></p>
                    ...
                    <table class="" border="0" cellpadding="0" cellspacing="0" width="580">
                        <tbody><tr>
                           <td class="" width="580">
							   ...
							   <p></p>
							   <p style="font-size: 14px; line-height:24px; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif;" align="left">
							   <singleline label="Title">A user has filled the Contact Us form as below.</singleline>
							   </p>
