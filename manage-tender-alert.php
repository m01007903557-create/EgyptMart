<?php
/**
 * File: manage-tender-alert.php
 * Version: PHP 8.3
 * Description: إدارة إشعارات المناقصات والمزايدات (إضافة وحذف الفئات)
 */

include "common.php";

$_SESSION['last_page'] = "manage-tender-alert.php";
...
// معالجة إضافة فئة جديدة عبر POST
if (isset($_POST['sub_cat_id']) && $_POST['sub_cat_id'] != '')
{
    ...
    if (mysqli_num_rows($r) == 0)
    {
        $SQL_BUY_ALERT = "INSERT INTO tender_alert_category SET 
                          tac_usr_id = " . $uid . ",
                          tac_pc_id = " . $sub_cat_id . ",
                          tac_updated_date = NOW()";
        mysqli_query($db, $SQL_BUY_ALERT);
    }
}
// معالجة إضافة فئة جديدة عبر GET
...
else
{
    ...
    if (isset($_GET['keywords']) && isset($_GET['rctyp']) && $_GET['rctyp'] == 'tender')
    {
        ...
        $sql_key = "SELECT product_category.pc_id 
                    FROM tender 
                    JOIN product_category ON product_category.pc_id = tender.tnd_pc_id 
                    WHERE tender.tnd_heading = '" . $keywords . "' 
...
<head>
    ...
    <script type="text/javascript">
        function addAlertCategory() {
            $.post("ajax-file/addTenderAlertCat.php", {}, function(data) {
        ...
        function delAlertCat(id) {
            if (confirm("Are you sure to delete this Category?")) {
                $.post("ajax-file/delTenderAlertCat.php", {
                    id: id
                }, function(data) {
                    window.location.reload();
                }).fail(function() {
...
<div class="hm1 bbc" id="res-mob1">
    ...
    <div class="f1 w61n tb lh ml br" id="lnav">
        <ul id="ulid" class="nln1" style="margin: 0px; padding: 0px;">
            <li>
                <h3 style="font-size: 16px;font-weight: bold; color:#000; text-align: center; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;" title="Tenders Tools">أدوات مناقصاتى</h3>
            </li>
            <li style="border-bottom:none" title="Tender Purchases">
                <h3>شراء بيانات المناقصات أو المزايدات</h3>
            </li>
            <li class="np npnew"><a href="manage-purchased-tenders.php" title="Purchased Tenders">»&nbsp;بيانات المناقصات المشتراه</a></li>
            <li class="np npnew"><a class="leftindi txtcol" href="manage-tender-alert.php" title="Tender Alerts">»&nbsp;إشعارات المناقصات الى بريدى</a></li>
            <li class="np npnew"><a href="my-tender-locationpref.php" title="Location Preferences">»&nbsp;تحديد أماكن ورود إشعارات مناقصاتى</a></li>
            <li class="np npnew"><a href="transaction_history.php" title="Transaction History">»&nbsp;Transaction History</a></li>
            <li style="border-bottom: medium none;" title="Help / FAQs?">
                <h3>المناقصات والمزايدات كيف تعمل ؟</h3>
            </li>
            <li class="np npnew"><a href="help.php" title="Tenders Help/ FAQs?">»&nbsp;المساعدة والأسئلة المتكررة</a></li>
            
            <?php if(isset($_REQUEST['sub_cat_id']) && $_REQUEST['sub_cat_id'] != ''): ?>
                <li class="np npnew"><a href="manage-auction-alert.php?sub_cat_id=<?php echo (int)$_REQUEST['sub_cat_id']; ?>">»&nbsp;Manage Auction Alerts</a></li>
            <?php else: ?>
                <li class="np npnew"><a href="manage-tender-alert.php" title="Mange Tender Alerts">»&nbsp;إدارة إشعارات مناقصاتى</a></li>
            <?php endif; ?>
            ...
            <li class="ug-banner">
                ...
                {
                ?>
                    <img src="upload/advertisement/emicosteel.jpg" alt="Advertisement" border="0" height="154" width="200">
                <?php } ?>
            </li>
        </ul>
    </div>
                                                ...
                                                <div style="background-color:#FFFFFF; height:670px" id="dvh2">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td bgcolor="#E6E6E6">
                                                                    <div class="myta">Manage Your Tender Preference</div>
                                                                </td>
                                                    ...
                                                    <img src="images/zero.gif" height="10" width="1" alt="">
                                                    <br> 
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td style="border-right:0px; padding-right:10px" valign="top" width="100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="LEFT" height="38" valign="TOP" width="325">
                                                            <img src="images/zero.gif" height="4" width="1" alt="">
                                                            <br>
                                                            <nobr>
                                                                <div class="mf18 mc5 mta2 mpr8 mpt10" title="Manage Tender Alerts Preferences">
                                                                    إشعارات المناقصات أو المزايدات الواردة الى بريدى
                                                                </div>
                                                            </nobr>
                                                        </td>
                                                        <td valign="bottom"></td>
                                                        <td valign="bottom">
                                                            <div class="manage_country mb" style="text-align:left;">
                                                                <a href="browse-cat-for-tender-alert.php" class="ajax" title="Add More Categories">أضف أصناف إشعارات مناقصات أو مزايدات</a>
                                                            </div>
                                                        </td>
                                                        <td valign="bottom">
                                                            <div class="manage_country mb">
                                                                <a href="my-tender-locationpref.php" title="Manage Your Location Preferences">حدد أماكن ورود الإشعارات الى بريدى</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT product_category.*, tender_alert_category.tac_id 
                                                    FROM product_category 
                                                    JOIN tender_alert_category ON product_category.pc_id = tender_alert_category.tac_pc_id 
                                                    WHERE tender_alert_category.tac_usr_id = " . $uid;
                                            $res = mysqli_query($db, $sql);
                                            $count = mysqli_num_rows($res);
                                            ?>
                                            
                                            <div style="font-family:arial;font-size:12px;margin-top: 9px;color:#000000;padding-left: 5px;">
                                                <div style="width: 218px;float: left;" title="No. of Categories Subscribed">عدد الأصناف المشترك بإشعاراتها</div> : <?php echo $count; ?>
                                                <br>
                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="2" align="LEFT">
                                                            <b style="font-size:14px;" title="Your Existing Tender Subscription">إشتراكات أصناف الإشعارات الى بريدى</b>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            
                                            <table class="select_sp" style="border-top:1px solid #C8DDEC" align="right" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="tdoffer" align="CENTER" bgcolor="#F1F9FE">
                                                            <img src="images/zero.gif" height="1" width="85" alt="">
                                                            <br>إزالـة
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <?php while($row = mysqli_fetch_object($res)): ?>
                                                            <tr id="map1">
                                                                ...
                                                                <td style="cursor:pointer;" align="CENTER">
                                                                    <a onclick="delAlertCat(<?php echo (int)$row->tac_id; ?>)" style="cursor:pointer;">
                                                                        <img src="images/del_img.gif" hspace="6" alt="حذف">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        <?php endwhile; ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="5" height="60">
                                                                <div style="font-family:arial; font-size:16px; color:#FF0000;" align="center">
                                                                    <b>You do not have any Tender Alerts</b>
                                                                </div>
                                                                <div style="font-family:arial; font-size:16px; color:#FF0000;" align="center">
                                                                    <a href="browse-cat-for-tender-alert.php" class="ajax">Click here to Add Tender Alerts</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endif; ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#txt_cat_mcat').on('keyup', function() {
            var type11 = 'Products';
            $("#txt_cat_mcat").autocomplete("autocomplete.php", {
                selectFirst: true,
                extraParams: {
                    type: type11
                },
