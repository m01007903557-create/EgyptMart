<?php
/**
 * File: product_temphoto.php
 * Description: عرض الصورة المؤقتة للمنتج مع خيار الحذف
...
// جلب الصورة المؤقتة للمستخدم
$sql = "SELECT tmpimg_id, tmpimg_image FROM temp_products_image WHERE tmpimg_uid = ? LIMIT 1";
...
// تنظيف اسم الصورة
$tmpimg_id = $row ? (int)$row->tmpimg_id : 0;
$tmpimg_image = $row ? htmlspecialchars($row->tmpimg_image ?? '', ENT_QUOTES, 'UTF-8') : '';
$image_path = "upload/myproduct/" . $tmpimg_image;
$full_path = __DIR__ . "/../" . $image_path;
$image_exists = !empty($tmpimg_image) && file_exists($full_path) && is_file($full_path);
?>
    ...
    <div class="mover file_button" style="box-shadow:none; border:1px solid rgb(220,221,222); margin-top:5px; margin-bottom:5px; height:125px; width:125px;" 
        ...
        <div id="cm-ed1" class="edit" style="display:none; margin-top:88px; margin-left:25px;" align="center">
            <div id="tanuj" style="width:100px; padding-left:20px; float:left; clear:both" align="left">
                <a onclick="DelTempImage(<?php echo $tmpimg_id; ?>)" style="cursor:pointer;">
        ...
        <div id="companyimages_1" style="width:125px; height:125px;">
            <img src="<?php echo $image_path; ?>" style="width:100%; height:auto;" alt="Temp Product Image">
        </div>
    </div>
</center>
<?php endif; ?>