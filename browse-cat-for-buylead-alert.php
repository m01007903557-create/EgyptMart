<?php
/**
 * File: browse-cat-for-buylead-alert.php
 * Description: إعدادات تنبيهات طلبات الشراء (اختيار التصنيفات)
...
<head>
    ...
    <title>إعدادات تنبيهات طلبات الشراء</title>
    ...
    <div style="background-color:#FFFFFF; height:670px" id="dvh2">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <tr>
                    <td bgcolor="#FAF4FF">
                        <div class="myta" title="Manage Your Buy Lead Product Preference">
                            سجل أصناف إشعارات طلبات عروض الأسعار التى تأتى الى بريدك
                        </div>
                    </td>
                </tr>
            </tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input role="textbox" class="txt ui-placeholder-input ui-autocomplete-input" 
                                                                   name="keywordsFilter" id="keywordsFilter" type="text" 
                                                                   maxlength="60" size="33">
                                                        </td>
                                                        <td style="cursor:pointer;">
                                                            <input name="button5" value="أضف التصنيف" onclick="return produtcustomcategory();" type="button">
                                                        </td>
                                                        <td valign="BOTTOM">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div align="CENTER">
                                            <img src="images/zero.gif" height="10" width="1"><br>
                                            <input name="confirm1" id="addLeadCatBtn" value="سجل الأصناف التى إخترتها" 
...
function scatAddDel(id) {
    if ($('#scat_' + id).attr('checked')) {
        $.post("ajax-file/addTempBuyleadAlertCat.php", {id: id}, function(data) {
            showList();
        });
    } else {
        $.post("ajax-file/delTempBuyleadAlertCat.php", {id: id}, function(data) {
            showList();
        });
    }
}
...
function showList() {
    $.post("ajax-file/showTempBuyleadAlertCat.php", {}, function(data) {
        $("#div1").html(data);
    });
}
