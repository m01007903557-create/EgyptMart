...
/********************approve record*********************/
 ...
 $pid = $_GET['id'];
		...
		$product_img='https://www.egyptmart.online/upload/buy_requirement/thumb/no-image.png';
		if($sproduct->br_pic!=''){
		$product_img='https://www.egyptmart.online/upload/buy_requirement/thumb/'.$sproduct->br_pic;
		}
