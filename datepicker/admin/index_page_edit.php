...
class editProduct{
	...
	function __construct($ic_id){
		$this->ic_id=$ic_id;
	}
	function detailsObj(){
		global $con;
		$sql="select * from index_content where ic_id='".$this->ic_id."'";
	...
	{		
	    global $con;
			...
			$sql="update index_content
				set	
					ic_heading ='".$this->ic_heading."',
					ic_content ='".$this->ic_content."',	
					ic_updated_date=now()
				where ic_id='".$this->ic_id."'";							
...
if(isset($_POST['btnUpdate'])){
		...
		$ob->ic_heading=addslashes(trim($_POST['ic_heading']));	
		$ob->ic_content=addslashes(trim($_POST['ic_content']));	
	...
	header("location:index_page_edit.php?sid=".$ob->ic_id);
}
?>
...
<!-- /TinyMCE -->
	...
	<?php include "includes/admin-left-con.php" ?>
		...
		<div id="content">
<h2>&nbsp;Manage Webpage&nbsp;&nbsp;&rsaquo;&nbsp;&nbsp;Index Page Edit</h2>
...
<div  class="row buttons"><input type="button" name="btnUpdate" id="btnUpdate"  onclick=location.href='index_page_view.php' value="Back" class="x2-button" style="margin-right:10px;margin-top:5px;"> </div>		
...
<td  style="width:678px">
			...
			<div class="formInputBox" style="width:387px;height:auto;">
                      <textarea name="ic_heading" id="ic_heading"class="reg_txtfld" style="height: 300px" ><?php echo $row->ic_heading;?></textarea> 
			</div>
		</div>
        
       <?php if($row->ic_id == '2' || $row->ic_id == '3' || $row->ic_id == '5'){?> 
        <div class="formItem leftLabel" style="padding-bottom:10px; padding-top:10px;">
			<label style="width:120px;"></label>
			<div class="formInputBox" style="width:387px;height:auto;">
              <?php if($row->ic_id == '2'){?> 
              		<a href="software_version_list.php">View & Upload Content List</a>
              <?php }elseif($row->ic_id == '3'){?>                             
              		<a href="software_feature_list.php">View & Upload Content List</a>
              <?php }elseif($row->ic_id == '5'){?>  
        ...
        <div class="formItem leftLabel" style="padding-bottom:10px; padding-top:10px;">
			...
			<div class="formInputBox" style="width:387px;height:auto;">
                       <textarea name="ic_content" id="ic_content" class="reg_txtfld"  style="height: 300px" ><?php echo $row->ic_content;?></textarea> 
			</div>
		</div>
           <?php }?>
