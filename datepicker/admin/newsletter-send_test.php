...
if(isset($_SESSION['nc_subject'])){	$nc_subject=$_SESSION['nc_subject'];	unset($_SESSION['nc_subject']);	}else{	$nc_subject="";	}
if(isset($_SESSION['nc_content'])){	$nc_content=$_SESSION['nc_content'];	unset($_SESSION['nc_content']);	}else{	$nc_content="";	}
...
class addPlan{
	...
	{		
		...
		while($row_usr=mysqli_fetch_object($res_usr))
		{
			...
			$to = $row_usr->email;  /*Put User's Email Adress Here*/
...
{
	$adn=new addPlan( addslashes(trim($_POST['nc_subject'])), addslashes(trim($_POST['nc_content'])));
...
<div class="form-group">
		...
		<div class="col-sm-9">
        	<textarea name="nc_content" id="nc_content" style="display:none;"></textarea>
