...
class listGig{
	...
	function deletelink($id){
		if($_SERVER['QUERY_STRING']==""){
			...
			$dellink="suspended_gig-view.php?".$_SERVER['QUERY_STRING']."&action=del&fid=".$id;
		}
		return $dellink;
	}
}
...
$al->setsql("select * from gig,subcategory,category where g_scat_id=scat_id and scat_cat_id=cat_id and g_status='4' order by g_id");
...
<h2>&rsaquo;&nbsp;&nbsp;Manage Gigs&nbsp;&nbsp;&rsaquo;&nbsp;&nbsp;Suspended-Gig List</h2>
...
<select name="limit" id="limit" onchange="javascript:window.location.href='suspended_gig-view.php?page=<?php echo $page ?>&amp;limit='+this.value;">
<?php 
