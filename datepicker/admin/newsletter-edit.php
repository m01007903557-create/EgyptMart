...
class addPlan {
  ...
  function add() {
	...
	foreach($imageTags as $tag) {
		...
		$this->nc_content = str_replace($tag->getAttribute('src'), 'http://egyptmart.online/images/reply/'.$filename, $this->nc_content);
		}
	}
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.9.4/js/bootstrap-select.min.js"></script>
 ...
 <!--<script type="text/javascript">
    function redirect()
    {
    var url = "http://www.egyptmart.online/admin/newsletter-view.php";
    window.location(url);
    }
    </script>-->
