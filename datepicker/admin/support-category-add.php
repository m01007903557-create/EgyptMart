...
$randNo = rand(10000,55555);
	...
	{				   	 		
      global $con;	
	  $sql="insert into faq_categories set		
...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Support Category Add</li>
		</ul><!-- .breadcrumb -->
		<!-- #nav-search -->
	</div>
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input name="fc_name" id="fc_name" class="col-xs-10 col-sm-5" type="text" value="<?php echo $fc_name; ?>" />
		</div>
	</div>	
