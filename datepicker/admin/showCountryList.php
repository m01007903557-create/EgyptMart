...
&nbsp;
<?php echo ucwords($rec_cn->cn_name); ?> - <?php echo $rec_cn->cn_code; ?> - <?php echo $rec_cn->cn_currency; ?> - <?php echo $rec_cn->cn_ph; ?>
</span>
	            ...
	            <div id="queue"></div>
					...
					<div class="col-xs-12 col-sm-7">
                        ...
                        <div class="form-group">
							...
							<div>
                                <input id="cn_code_<?php echo $rec_cn->cn_id; ?>" name="cn_code_<?php echo $rec_cn->cn_id; ?>" class="input-large" type="text" placeholder="Country Code" value="<?php echo $rec_cn->cn_code; ?>" />
                            </div>
                        </div>
