          ...
          <span style="width:750px;word-wrap:break-word;" id="wbr">
            <div style="width: 600px;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              ...
              <div style="clear:both">
			  			  ...
			  			  <div>
			  <a href="http://www.egyptmart.online
/sign-in.php?email='.stripslashes($user_detail->email).'&redirect=http://www.egyptmart.online
/product-sel-cat.php " ><img src="http://egyptmart.online/admin/images/RENEWAL_mail_Notification.png" alt="" height="100%" width="100%"></a>
			  </div>
			   <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
			  ...
			  <table>
  <tr>
    <th style="vertical-align: top;"> <img src="http://egyptmart.online/admin/images/sponser.png" alt="" height="" width=""></th>
	<th></th>
...
<p style="text-align:right;"><a href="http://www.egyptmart.online" style="text-decoration: none;color:blue;">Learn More ></a></p>
