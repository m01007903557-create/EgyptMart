...
<div style="color: #000;">Use your current mail address + default password: 123456  <a href="http://www.egyptmart.online/sign-in.php?email='.$suser->email.'" style="text-decoration:none;margin-left: 50px;font-size: 14px;">Sign in NOW</a></div>';
		$comment.='<div>
			  ...
			  <td style="padding: 5px;"><a href="http://www.egyptmart.online/sign-in.php?email='.$suser->email.'&redirect=http://www.egyptmart.online/post-tender.php" style="padding: 5px;color: #0f00d0;font-size: 18px;font-weight: 600;text-decoration:none;">Tenders / Auctions</a></td>			  
			  </tr>
			 
			  </table>
			  </div>';
		$comment.=' <div style="clear:both">
                    <p style="line-height:1.5em;text-align:center;font-size:1.2em;background-color:#eaeaea;margin:0;font-family:Arial,Helvetica,sans-serif;font-weight:bold;padding:.4em .4em .4em"><a href="http://www.egyptmart.online/sign-in.php?email='.$suser->email.'&redirect=http://www.egyptmart.online/why_egyptmart.php" style="font-size: 12px;font-weight: normal;">Click Here</a> to unsubscribe  or tell us your requirements  <a href="http://www.egyptmart.online/sign-in.php?email='.$suser->email.'&redirect=http://www.egyptmart.online/membership_plans.php"><strong style="color: #0f00d0;font-size: 10px;font-weight: 600;">NOW!</strong></a></p>
                </div>';
