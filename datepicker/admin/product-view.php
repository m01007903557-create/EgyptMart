...
/********************approve record*********************/
	if(isset($_GET['action']) && $_GET['action']=="appr"){
		...
		if($sproduct->pd_image!=''){
			$product_img='<img src="http://egyptmart.online/upload/myproduct/'. $sproduct->pd_image.'" width="100" />';
		}
		else{
			$product_img='<img src="http://egyptmart.online/upload/myproduct/noimage.jpg" width="100" />';
		}
