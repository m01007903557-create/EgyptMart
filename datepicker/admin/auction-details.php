...
$sql="select * from auction where md5(auc_id)='".$id."'";
$res=mysqli_query($con, $sql);
$row=mysqli_fetch_object($res);

$bsql="select bu.* from auction a JOIN business_profile bu ON a.auc_usr_id = bu.bnsprof_uid where md5(a.auc_id) ='".$id."'";
...
<form class="form-horizontal" action="" id="cmp_edit" name="cmp_edit" method="post" enctype="multipart/form-data" onsubmit="return myvalid();">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
   		   	<label style="padding-top:4px;"><?php echo $row->auc_heading; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php if($row->auc_value!='' && $row->auc_value!='0.00'){	echo $row->auc_value."&nbsp;".getCurrency($row->auc_currency);	} ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row_pc[0]; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row_pc[1]; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo $row_pc[2]; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->auc_notice_type; ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php if($row->auc_qty!='' && $row->auc_qty!='0.00'){	echo $row->auc_qty." ".measurement_unit($row->auc_qty_mu_id);	} ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">EMD:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->auc_emd; ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Document Fees:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php if($row->auc_document_fees!='' && $row->auc_document_fees!='0.00'){	echo $row->auc_document_fees."&nbsp;".getCurrency($row->auc_document_fees_currency);	} ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Project Period:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->auc_project_period; ?></label>
		</div>
	</div>
    <div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Products:</label>
		<div class="col-sm-9">
        	<label style="padding-top:4px;"><?php echo $row->auc_products; ?></label>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->auc_publish_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->auc_docSaleStart_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->auc_docSaleEnd_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->auc_docSubmitBefore_date)); ?></label>
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo date("d-M,Y",strtotime($row->auc_due_date)); ?></label>
		</div>
	</div>
    <div class="form-group">
		...
		<div class="col-sm-8">
            ...
            <?php
				if($row->auc_preferred_location=='abroad'){	echo "Abroad Only";	}
				else if($row->auc_preferred_location=='any'){		echo "Anywhere";	}
				else if($row->auc_preferred_location=='domestic'){		echo "Domestic Only";	}
				else if($row->auc_preferred_location=='my_city'){		echo "My City Only";	}
			?>
            </label>
    ...
    <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo stripslashes($row->auc_prequalification_criteria); ?></label>
		</div>
	</div>
     ...
     <div class="form-group">
		...
		<div class="col-sm-8">
   		   	<label style="padding-top:4px;"><?php echo stripslashes($row->auc_details); ?></label>
		</div>
	</div>
    ...
    <?php
		...
		?>
	   <div class="form-group">
       <label class="col-sm-3 control-label no-padding-right" for="form-field-2"><?php echo stripslashes($row_af->af_label); ?>: </label>
       <div class="col-sm-8">
       	<label style="padding-top:4px;">
		<?php
