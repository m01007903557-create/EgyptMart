...
include "../common.php";
	...
	function detailsObj(){
		global $con;
		$sql="select * from header_top_bottom_link where htbl_id = '1'";
	...
	if($this->htbl_image != '')
	{
        ...
        if (in_array($ext,$validEXT)) {
			...
			$lstImg = mysqli_fetch_object(mysqli_query($con, "select htbl_image from header_top_bottom_link where htbl_id = '1'"));
			unlink("../upload/slider/".$lstImg->htbl_image);
            $imgSImage->resize(378,117);
