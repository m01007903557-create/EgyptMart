...
class editSubcategory{	
	...
	function detailsObj(){
		global $con;
		$sql="select s.pc_id, s.pc_name, s.pc_sort_name, c.pc_id, c.pc_name, m.pc_id, m.pc_name from product_category s, product_category c, product_category m where s.pc_parent_id=c.pc_id and c.pc_parent_id=m.pc_id and m.pc_parent_id='0' and m.pc_status='1' and c.pc_status='1' and s.pc_status='1' and md5(s.pc_id)='".$this->scat_id."'";
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<select name="cat_id" id="cat_id">
                ...
                <?php 
                $catsql = mysqli_query($con, "select * from product_category where pc_parent_id != '0' and pc_status = '1' and pc_parent_id='".$row[5]."'");
