        ...
        <div class="header-fixed-container">
            <div class="col-sm-12 col-lg-4 top-lft">
                <ul>
                    ...
                    <?php } else { ?>
                        <li><a href="sign-in.php#loginform" target="_top" rel="nofollow" style="margin-left:8px;">Sign in</a></li>|
                        <li><a href="create_account.php#signupform" target="_top" rel="nofollow">Join Free &nbsp;|</a></li>
                    <?php } ?>
                    <li class="dropdown dropdown1"  style="z-index: 100;"> <a data-target="myEgyptmart"  class="dropbtn1" href="" data-toggle="dropdown" role="button"
            ...
            <div class="col-sm-6 col-lg-4 top-mid">
                <ul>
                    ...
                    <li class="contact_photooo">
                        ...
                        <?php } else { ?>
                            <a href="<?php echo BASE_URL ?>sign-in.php"><img src="http://egyptmart.online/images/uploadd.png"  width="30" id="profilephoto" height="30"><span class="user-name-topbar"><?php echo getUserInfo($uid, 'fname'); ?></span></a>
                        <?php } ?>
                    ...
                    <span style="margin-left:40px;">
                        ...
                        <li class="dropdown dropdown1" id="sell"> <a class="ar-lebel dropbtn1" data-target="#" href="#" data-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu ar-dropdown-menu dropdown-content1 dropdown-menur " aria-labelledby="sell">
                                ...
                                <li><a href="http://www.egyptmart.online/post-sell-offer.php">Post a Hot Sale Offer</a></li>
            ...
            <div class="col-sm-6 col-lg-4 top-rht">
                <ul class="text-right tstleft">
                    ...
                    <!--<li style="padding-right:3px;"><a href="http://egyptmart.online/company/products.php?c=3654fa3a3c407f82377f55c19c5d403335c7&amp;sc=179742556">Member</a></li>-->
                    ...
                    <li><a href="why_egyptmart.php" class=" txt-yellow"><b class="txt-yellow"  style="font-weight:900;">Why  EgyptMART</b></a> </li>
...
echo get_country_flag($_COOKIE['loc_id']).'-->';
                    ...
                    <div class="page-header-col1-row1-col2 col-xs-6">
                        ...
                        ?>
                        <a href="index.php"><img src="sitelogo/logo7847logo8766main-logo-copy11.png" alt=""  class="logoa" /></a> 
                    ...
                    <div class="page-header-col1-row1-col4 col-xs-12" style="padding:0;"> 
                        ...
                        <div class="page-header-col1-row1-col4-row2  col-xs-6 home-buyer-seller">
                            <div class="page-header-col1-row1-col4-row2-checkbox">
                                ...
                                <label class="radio supplier-radio" style="font-size: 16px">
                ...
                <div class=" header-mid header-mid-custom-box"> 
                    <div class="post-prod-left">
                        ...
                        <a href="product-sel-cat.php" class="post-product-btn">
                            Display Your Business<small>Get <strong>Domestic</strong> or <strong>Global</strong> Inquiries</small> 
                        </a>         
                    </div>
                    ...
                    <div class="page-header-col1-row2"> 
                        ...
                        <div class="col-lg-7 col-md-6 col-xs-12 margintop">
                         <!-- <div class="srchBx">
                                <h2 class="cd-headline clip is-full-width text-center"> <span style="width: 100%; overflow: hidden; color:gray; font-family: Arial narrow;" class="cd-words-wrapper" > <b class="is-hidden">Join Top 10,000 Suppliers In Arab Countries..<span class="blinking-cursor" style="color: gray">!</span></b> <b class="is-hidden">Source > Supply > Export > Grow Your Business ..<span class="blinking-cursor" style="color: gray">!</span> </b> <b class="is-visible">Create Your Domestic &amp; Global Business WEBSITE<span class="blinking-cursor" style="color: gray">!</span></b> </span> </h2>
                                ...
                                <div class="tab-content search_cont">
                                    <div role="tabpanel" class="tab-pane active" id="supplier">
                                        <form autocomplete="off" name="searchForm" action="search.php" onSubmit="return validsearch()" method="GET" id="hdr_frm">
                                            ...
                                            <input type="text" id="search-box1" name="keywords" style="text-align:left; border:1px solid;box-shadow: 1px 2px 4px #595959;" placeholder="Source Product / Services to find suppliers"
...
<!-- added by webcast -->
        <div class="srchBx">
            <h2 class="cd-headline clip is-full-width text-center"> <span style="width: 100%; overflow: hidden; color:gray; font-family: Arial narrow;" class="cd-words-wrapper" > <b class="is-hidden">Join Top 10,000 Suppliers In Arab Countries..<span class="blinking-cursor" style="color: gray">!</span></b> <b class="is-hidden">Source > Supply > Export > Grow Business .. <span class="blinking-cursor" style="color: gray">!</span> </b> <b class="is-visible">Create Your EgyptMART Business WEBSITE ..<span class="blinking-cursor" style="color: gray">!</span></b> </span> </h2>
