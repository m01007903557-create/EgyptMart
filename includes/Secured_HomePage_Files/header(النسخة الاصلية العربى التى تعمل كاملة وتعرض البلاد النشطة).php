                                ...
                                <div class="page-header-col1-row1-col1-row2-form">
                                    <div onmouseover="showLocMenu();" onmouseout="hideLocMenu()">
                                        <a class="un" style="border-left:none; font-size: 9px; color:#0f2399;">
                                           ...
                                           <span style="color: black;">غـير بلـد البحـث &nbsp;<span class="arw"> 
                                          <b>&or;</b></span></span></a>
    ...
    <table style="width:100%;padding:1px;">
        <tr>
            ...
            while ($row_cnLoc = mysqli_fetch_object($res_cnLoc)) {
                $cn_id = (int)$row_cnLoc->cn_id; // cast to int
                if ($cn % 3 == 0) {
                    $cn = 0;
                    ?>
                    </tr><tr>
                ...
                <td align="center">
                    <a title="<?php echo htmlspecialchars($row_cnLoc->cn_name); ?>" 
                       ...
                       onclick="setCountryLocation(<?php echo $cn_id; ?>);">
                        <img src="images/country_flag/<?php echo get_country_flag($cn_id); ?>"
