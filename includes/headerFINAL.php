...
<nav class="mobile-quick-strip" aria-label="Quick links">
    ...
    <div class="quick-left">
        <a href="https://www.arab-mart.com" class="english-site" target="_blank">
            <img src="images/country_flag/GB.png" alt="English" class="lang-flag">
            <span>Arab-Mart.com</span>
        </a>
    </div>
...
"><a><span class="arabic" dir="rtl" lang="ar"></span>AI mode</a></li>  </ul>
                <!-- Tab panes -->   
                <div class="tab-content search_cont" style="float:none!important;margin:0!important;max-width:none!important;width:100%!important;border-radius: 20px 0px !important;">
...
<link rel="stylesheet" href="css/yasir-home-final.css?v=20260726j23klmnpqrstu8">
<!--<script>
  $(window).scroll(function() {
