<?php
// includes/left_menu.php - نسخة PHP 8.3
...
<div class="f1 w61n tb lh ml br" id="lnav">
    <ul class="nln1" style="margin:0px; padding:0px">
        ...
        <li>
            <h3 style="font-size: 19px;font-weight: bold; color:#f50000;text-align:center; margin:0;padding: 18px 5px 18px 5px;" title="Company Profile">
                تفاصيـــل الشركــة
            </h3>
        </li>
    </ul>
    ...
    <ul id="ulid" class="nln1" style="margin:0px; padding:0px">
        ...
        <li>
            <center>
                <div>
                    <div class="file_button" style="margin:0px;height:10px;" id="addbut"></div>
                    <div id="queue">
        ...
        <li class="np npnew">
            <a <?php echo ($file === "my-contactdetails") ? 'class="leftindi txtcol"' : ''; ?> 
               href="my-contactdetails.php" title="Contact Details">
                &raquo;&nbsp; معلومات الإتصال بالشركة
            </a>
        </li>
        
        <li class="np npnew">
            <a <?php echo ($file === "business-details" || $file === "statutory-details" || $file === "myproduct-buy") ? 'class="leftindi txtcol"' : ''; ?> 
               href="business-details.php" title="Business Profile">
        ...
        <li class="np npnew">
            <a <?php echo ($file === "my-homepage") ? 'class="leftindi txtcol"' : ''; ?> 
               href="my-homepage.php" title="My Home Page">
                &raquo;&nbsp; ماذا عن الشركة
            </a>
        </li>
        
        <li class="np npnew">
            <a <?php echo ($file === "myprofile") ? 'class="leftindi txtcol"' : ''; ?> 
               href="myprofile.php" title="Profile & News">
                &raquo; بروفايل وأخبار الشركة
            </a>
        </li>

        <li class="np npnew">
            <a <?php echo ($file === "company-video") ? 'class="leftindi txtcol"' : ''; ?> 
               href="company-video.php" title="Company Video">
                &raquo;&nbsp;فيديوهات الشركة
            </a>
        </li>
        
        <li class="np npnew">
            <a <?php echo ($file === "company-banner") ? 'class="leftindi txtcol"' : ''; ?> 
               href="company-banner.php" title="Company Images">
        ...
        <li class="np npnew">
            <a <?php echo ($file === "change-password") ? 'class="leftindi txtcol"' : ''; ?> 
               href="change-password.php" title="Change Password">
