...
<div class="row top-bar" id="topbar">
   <div class="maincontainer">
      ...
      <ul class="text-left" id="top-center">
	   <?php if(getUserInfo($uid, 'usr_mp_id') < 4){ ?>
         <li style="color: orange" > Credit : <a href="#" class="txt-bold txt-yellow" style="font-weight:900 ; font-size:13px; color: orange">
            <b style="color: white"><?php echo (getUserInfo($uid, 'usr_credit') > 0)?getUserInfo($uid, 'usr_credit'):'0'; ?></b></a>
         </li>
      ...
      <ul class="text-right" id="top-right">
         ...
         <li><a href="why_ARABYOS.php" class=" txt-yellow" style="margin-right:22px;"><b class="txt-yellow"  style="font-weight:900;">Why  ARABYOS</b></a>
         </li>
         ...
         <div class="col-md-9 page-header-col1-row1">
            ...
            <div class="page-header-col1-row1-col1">
               ...
               <div class="page-header-col1-row1-col1_row">
                   <p class="text-center"><a href="my-contactdetails.php">Account Setting</a></p> 
               </div>
...
//echo get_country_flag($_COOKIE['loc_id']);
	...
	$("#search-box").keyup(function(){
		var getDrpDwnVal = $("#rctyp option:selected").text();
            ...
            <div class="page-header-col1-row2-col4 ">
               ...
               <div class="zoomin2" >
                  <!--<a id="light"  href="post-buy-req.php">    </a>
                    ...
                    <a id="dark" href="post-buy-req.php"><img  id="aks" src="images/light.png"/></a>
               </div>
            </div>
