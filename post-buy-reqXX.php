<?php
/**
 * File: post-buy-req.php
 * Description: نموذج نشر طلب شراء جديد مع إمكانية البحث عن التصنيفات
            ...
            <form name="postForm" method="post" action="" onsubmit="return validRequest();">
                ...
                <div class="frm fl" style="background:#fff; width: calc(100% - 355px); padding:10px;">
                                            ...
                                            <td>
                                                <div style="padding-left:5px; padding-top:0px;" id="img_disp">
                                                    <img src="upload/buy_requirement/no-image.png" id="6390059595_1" 
                                                         border="0" height="100" hspace="0" vspace="0" width="125" alt="Product Image">
                                                </div>
                                            </td>
                                            <td>
                    ...
                    <div id="submitdiv">
                        ...
                        <input name="submitBuyReqButt" id="login" value="نشر طلب الشراء" type="SUBMIT" style="height:63px !important;">
                    </div>
