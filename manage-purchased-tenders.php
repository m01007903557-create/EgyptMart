<?php
/**
 * File: manage-purchased-tenders.php
 * Version: PHP 8.3
 * Description: عرض وإدارة المناقصات المشتراه
 */
...
<script type="text/javascript">
    ...
    /**
     * عرض المناقصات المشتراه (التبويب النشط)
    ...
    function purchasedTenders(page)
    {
        ...
        $.post("ajax-file/purchased-tenders.php", {page: page}, function(data) { 
            $('#res').html(data); 
        }).fail(function() {
    ...
    {
        if (confirm("! لايمكنك الغاء بيانات المناقصات المشتراه من أجل استخداماتك المستقبلية"))
        {
...
<div class="hm1 bbc" id="res-mob1">
    ...
    <div class="f1 w61n tb lh ml br" id="lnav">
        <ul id="ulid" class="nln1" style="margin: 0px; padding: 0px;">
            <li><h3 style="font-size: 16px;font-weight: bold; text-align:center;color:#000; margin:0;padding: 18px 5px 18px 5px;background-color: #FFFFFF;" title="Buyer Tools">أدوات الشراء</h3></li>
            ...
            <li class="np npnew"><a href="manage-selloffer-alert.php" title="Manage Sell Offer Alerts">»&nbsp;إدارة إشعارات عروض البيع</a></li>
            <li style="border-bottom:none" title="مشتريات طلبات الشراء"><h3></h3></li>
            <li class="np npnew"><a href="subscription.php" title="Purchase Buy Leads">إشترى بيانات طلبات شراء</a></li>
            <li class="np npnew"><a href="buyleads.php" title="View Latest Buy Leads">شاهد طلبات الشراء</a></li>
            <li class="np npnew"><a href="manage-purchased-buyleads.php" title="شاهد طلبات شرائى المشتراه"></a></li>
            <li class="np npnew"><a class="leftindi txtcol" href="manage-purchased-tenders.php" title="View Purchased Tenders">معلومات المناقصات المشتراه</a></li>
            <li class="np npnew"><a href="manage-buylead-alert.php" title="Manage Buy Lead Alerts">إدارة إشعارات طلبات الشراء</a></li>
        </ul>
    </div>
                                        ...
                                        <td valign="TOP" width="100%">
                                            ...
                                            <?php if($row && $row->usr_mp_id > 3): ?>
                                                <div class="mfr mf14 md1 mc3"> 
                                                    <span class="mf12">[ 
                                                        <a href="membership_plans.php" title="Pay Annual Subscription">
                                                            إشترك بخطة برومو للحصول مجانا على معلومات المناقصات المشتراه
                                                        </a>
                                                    </span>
                                                </div>
                                            <?php else: ?>
                                                <div class="mfr mf14 md1 mc3">
                                                    ...
                                                    <div class="mta mpb8 mpt5 mf11">
                                                        <a href="transaction_history.php"></a>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            
                                            <div class="wd mf18 mc5 mta2 mpb10">بيانات المناقصات المشتراه</div>
                                            
                                            <div id="masterdiv">
                                                <div id="sub1" style="display:inline;">
                                                    <div class="ap1">
                                                        <?php
                                                        // حساب عدد المناقصات المشتراه
                                                        $sql_pur = "SELECT count(*) AS cnt 
                                                                   FROM tender, purchased_tender 
                                                                   WHERE ptnd_tnd_id = tnd_id 
                                                                   AND tnd_status = '1' 
                                                                   AND ptnd_usr_id = " . $uid;
                                                        ...
                                                        <a class="f1 ap2 tabTextColor" onclick="showPurTenders(1);" style="cursor:pointer;" id="opnReq_tab" title="Purchased Tenders">
                                                            بيانات المناقصات المشتراه (<?php echo (int)$pur_count; ?>)
                                                        </a>
                                                        <div class="c3"></div>
                                                    </div>
