<?php
/**
 * File: browse-cat-for-selloffer-alert.php

 * Description: إعدادات تنبيهات عروض البيع (اختيار التصنيفات)
...
$sql_mcat = "SELECT pc_id, pc_name FROM product_category 
             ...
             $sql_order";
$result_mcat = mysqli_query($con, $sql_mcat);
$main_categories = [];
while ($row_mcat = mysqli_fetch_assoc($result_mcat)) {
    $main_categories[] = $row_mcat;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>إعدادات تنبيهات عروض البيع</title>
    ...
    <div style="background-color:#FFFFFF; height:670px" id="dvh2">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <tr>
                    <td bgcolor="#FAF4FF">
                        <div class="myta" title="Manage your Sell Offer Alerts">
                            سجل أصناف إشعارات عروض البيع التى تأتى الى بريدك
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <div style="height: 450px;">
            <form style="margin:0px;" name="test" action="/cgi/eto-alert-subs-new.mp" onsubmit="return false">
                <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody>
                                            <tr>
                                                <td class="tabclose" onclick="searchcat()" id="sc" width="152" title="Search Categories">
                                                    إبحث اليا عن أصناف إشعارات
                                                </td>
                                                <td class="tabborder" width="10">
                                                    <img src="images/zero.gif" height="1" width="10">
                                                </td>
                                                <td class="tabopen" onclick="beowswcat()" id="bc" width="155" title="Browse Categories">
                                                    عين أصناف إشعارات
                                                </td>
                                                <td class="tabborder">
                                                    <img src="images/zero.gif" height="1" width="1">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="font-family:arial; font-size:12px; padding-left:3px;" width="100%">
                                                            <span id="grp1">
                                                                <select size="10" style="font-size:13px; font-family:arial; height:180px; width:100%;" 
                                                                        name="mcat" id="mcat" onchange="showCategory(this.value)">
                                                    ...
                                                    <tr id="cat_select_area" style="display:none;">
                                                        <td style="font-family:arial; font-size:12px; padding-left:3px;" width="100%">
                                                            <span id="grp1">
                                                                <select size="10" style="font-size:13px; font-family:arial; height:180px; width:100%;" 
                                                                        name="grp" id="grp" onclick="catajaxFunction(this.value);">
                                                                </select>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                            ...
                                                            <div style="height:170px">
                                                                <div class="displayon" id="display_mcat" style="display:none;">
                                                                    <div style="background-color:#ffffff; overflow: auto; height: 170px; padding-left: 1px; font-size: 13px; text-align:left">
                                                                        ...
                                                                        <div style="border: 1px solid rgb(51, 102, 153); background-color:#ffffff; overflow: auto; height: 165px; padding-left:1px; font-size: 13px; display:none" id="scat"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                        ...
                                        <div class="border_bottom">
                                            ...
                                            <div class="blwnew" style="padding-top:0px; margin-top:0px;">
                                                <b style="font-size:13px;">
                                                    <font color="#E95801" title="Enter product keywords to find a category">
                                                        أدخل كلمة المنتج ودعه يبحث تلقائيا
                                                    </font>
                                                </b>
                                            </div>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="525">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input value="" role="textbox" class="txt ui-placeholder-input ui-autocomplete-input" 
                                                                   name="keywordsFilter" id="keywordsFilter" 
                                                                   placeholder="Enter product / service to search">
                                                        </td>
                                                        <td style="cursor:pointer;">
                                                            <input type="button" value="أضف التصنيف" onclick="produtcustomcategory();" 
                                                                   class="pbr" style="cursor: pointer;">
                                                        </td>
                                                        <td valign="BOTTOM">
                                                            <div class="blw1">مثال: "ذراع كرسى" أو "أثاث"</div>
                    ...
                    <div id="sel_category" style="display:block;">
                        ...
                        <table align="CENTER" border="0" cellpadding="0" cellspacing="0" width="99%">
                            <tbody>
                                <tr>
                                    <td valign="TOP" width="19"><img src="images/22.gif" height="15" vspace="3" width="19"></td>
                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="margin-left:10px; padding-top:4px; padding-bottom:4px; text-align:left">
                                                            <div class="setcatnew">
                                                                <b class="kk" title="Selected Categories">الأصناف التى إخترتها</b>
                                                            </div>
                                        ...
                                        <div align="CENTER">
                                            <img src="images/zero.gif" height="10" width="1"><br>
                                            <input name="confirm1" id="addSOCatBtn" value="سجل الأصناف التى إخترتها" 
                                                   onclick="addAlertCategory();" type="button">
...
// جلب التصنيفات المختارة عند تحميل الصفحة
...
function produtcustomcategory() {
    keywordsFilter = $("#keywordsFilter").val();
    if (keywordsFilter == "") {
        alert("Please select any product first");
        return false;
    }
    $.post("ajax-file/produtcustomcategory.php", {
