...
<br>
<?php
// ✅ الاستعلام الرئيسي - باستخدام LEFT JOIN مع التحقق من null
...
<a href="category.php?token=<?php echo rand(1000,9999) . md5($row_pcat['main_id']); ?>" class="c12"><?php echo htmlspecialchars($row_pcat['main_name']); ?></a>
 > <a href="catcompany.php?token=<?php echo rand(1000,9999) . md5($row_pcat['cat_id']); ?>" class="c12"><?php echo htmlspecialchars($row_pcat['cat_name']); ?></a>
 > <?php echo htmlspecialchars($row_pcat['sub_name']); ?><br>
</div>
</div>
...
<?php 
// ✅ استخدام المسار الثابت مباشرة (للتأكد من ظهور الصورة)
$image_name = 'ph-6634-1783270291-aeb6d817b59b4562.jpg';
