<?php
/**
 * File: email/annual_subscription_failure.php

 * Version: PHP 8.3
 * Description: قالب البريد الإلكتروني لتأكيد نجاح عملية الاشتراك
 * 
 * هذا الملف يحتوي على قالب البريد الإلكتروني الذي يتم إرساله عند نجاح عملية اشتراك
 */
...
<?php
// ==============================================
// قالب البريد الإلكتروني لتأكيد نجاح الاشتراك
// ==============================================
