<?php
/**
 * File: email/auction_notification.php

 * Version: PHP 8.3
 * Description: قالب البريد الإلكتروني لتأكيد شراء معلومات المزاد
 * 
 * هذا الملف يحتوي على قالب البريد الإلكتروني الذي يتم إرساله عند شراء معلومات مزاد
 */
...
<?php
// ==============================================
// قالب البريد الإلكتروني لتأكيد شراء المزاد
// ==============================================
            ...
            <div style="width: 90%;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              ...
              <div style="height: 100px; width: 100%; float: left; ">
                  ...
                  <div style="height:100px;width:43%;float:left;">
                      <h2 style="font-size: 20px; color:#466da0; text-align: center; margin-top:0px; margin-bottom:0px;">
                          Today\'s Latest<br> Auction Purchase
                      </h2>
                  </div>
              ...
              <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
                <p style="font-size:12px;margin:0;padding:.5em 0 0.5em;line-height:1.4em;">
                    ...
                    This Auction is saved in your "<a href="//' . htmlspecialchars($host) . '/manage-purchased-auctions.php">Purchased Auctions</a>" section.<br>
                    You can submit your response from "<a href="//' . htmlspecialchars($host) . '/manage-purchased-auctions.php">Purchased Auctions</a>".<br>
