<?php
/**
 * File: email/annual_subscription.php

 * Version: PHP 8.3
 * Description: قوالب البريد الإلكتروني لمدفوعات الاشتراكات
 * 
 * يحتوي هذا الملف على قالبين للبريد الإلكتروني:
 * 1. $message1 - قالب تأكيد نجاح عملية الاشتراك (للمستخدم)
 * 2. $message2 - قالب إشعار الإدارة باشتراك جديد
 */
...
if (isset($row_u)) {
    $user_name = ($row_u->fname ?? '') . ' ' . ($row_u->lname ?? '');
    $user_email = $row_u->email ?? '';
    $company_name = $row_u->bnsprof_compname ?? '';
}

// بيانات المعاملة
$order_id_display = isset($order_id) ? htmlspecialchars($order_id) : 'غير متوفر';
$annual_amount = isset($row) && isset($row->mp_amount) ? htmlspecialchars($row->mp_amount) : 'غير متوفر';
$paid_amount = isset($amount) ? htmlspecialchars($amount) : 'غير متوفر';
$membership_plan = isset($row) && isset($row->mst_name) ? htmlspecialchars($row->mst_name) : 'غير متوفر';
?>
<?php
// ==============================================
// القالب الأول: تأكيد نجاح عملية الاشتراك (للمستخدم)
// ==============================================
            ...
            <div style="width: 90%;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              ...
              <div style="height: 100px; width: 100%; float: left; ">
                  ...
                  <div style="height:100px;width:43%;float:left;">
                      <h2 style="font-size: 20px; color:#466da0; text-align: center; margin-top:0px; margin-bottom:0px;">
                          Today\'s Latest<br> Subscription Payment Success
                      </h2>
                  </div>
              ...
              <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
                <p style="font-size:12px;margin:0;padding:.5em 0 0.5em;line-height:1.4em;text-align:left">
                    ...
                    Your online payment has been processed successfully. Site Administration will assign your SPONSOR membership type shortly, and contact you.
                </p>
                ...
                <div style="width: 1000px; line-height:1.5em;font-size:12px;font-family:Arial,Helvetica,sans-serif;padding:0.5em 0 0.9em 1em">
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        <label style="font-weight:bold;">Transaction Status:</label> SUCCESS
                    </p>
                    ...
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        <label style="font-weight:bold;">Annual Amount:</label> ' . $annual_amount . '
                    </p>
                    
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        <label style="font-weight:bold;">Paid Amount:</label> ' . $paid_amount . '
                    </p>
                    
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        <label style="font-weight:bold;">Membership Plan:</label> ' . $membership_plan . '
                    </p>
                </div>
              ...
              <div style="width:100%;float:left;text-align:center;padding-top: 10px;padding-bottom: 10px;">
                  ...
                  <a href="http://egyptmart.shop/auctions.php" 
                     style="color:#466da0;text-decoration:none;font-size:18px;font-weight:bold;">
                      Auction
                  </a>
              </div>
...
// ==============================================
// القالب الثاني: إشعار الإدارة باشتراك جديد
// ==============================================
        ...
        <td class="sh_m2">
          <span style="width:750px;word-wrap:break-word;" id="wbr">
            <div style="width: 90%;height: auto;border: 10px solid #92AED2;float: left;padding: 10px;margin-top:10px;">
              ...
              <div style="max-width:575px;line-height:18px;font-size:12px;font-family:Arial,Helvetica,sans-serif">
                <p style="font-size:1.4em;margin:0;padding:.5em 0 0.5em;line-height:1.4em;text-align:center">
                  <b>Annual Subscription Payment from <span style="color: blue">EgyptMART</span> user</b>
                </p>
                ...
                <div style="width: 1000px; line-height:1.5em;font-size:12px;font-family:Arial,Helvetica,sans-serif;padding:0.5em 0 0.9em 1em">
                    ...
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Email address: ' . htmlspecialchars($user_email) . '
                    </p>
                    
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Business/Company Name: ' . htmlspecialchars($company_name) . '
                    </p>
                    
                    <p style="color:#000;font-size: 14px; line-height:22px; margin-top:0px; margin-bottom:0px; font-family: HelveticaNeue, sans-serif;" align="left">
                        Upgrade Membership Plan: ' . $membership_plan . '
                    </p>
